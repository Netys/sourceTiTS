package classes.GameData.Pregnancy.Handlers 
{
	...
	public class CoCHellhoundPregnancy extends BasePregnancyHandler
	{
		public function CoCHellhoundPregnancy() 
		{
			_handlesType = "CoCHellhoundPregnancy";
			_basePregnancyIncubationTime = 352 * 60; // 14 days
			...
			this.addStageProgression(290 * 60, function(pregSlot:int):void {
			...
			this.addStageProgression(72 * 60, function(pregSlot:int):void {
				...
				kGAMECLASS.eventBuffer += "\n\nThe heat within doesn't drain you as much as it used to, instead giving you an odd strength.";
				
				kGAMECLASS.pc.slowStatGain("p", 1);
				// tou +1
			...
			this.addStageProgression(48 * 60, function(pregSlot:int):void {
				...
				kGAMECLASS.eventBuffer += "\n\nYou can feel two large lumps pushing against your womb together ";
		...
		public static function OverrideOnDurationEnd(mother:Creature, pregSlot:int, thisPtr:BasePregnancyHandler):void
		{
			...
			var tEventCall:Function = (function(c_mother:Creature, c_pregSlot:int, c_thisPtr:BasePregnancyHandler):Function
			{
				...
				{
					kGAMECLASS.giveBirthToHellHound(c_pregSlot);
		...
		public static function cleanupPregnancy(mother:Creature, pregSlot:int, thisPtr:BasePregnancyHandler):void
		{
			...
			StatTracking.track("coc/pregnancy/hellhounds", 1);
