package classes.Items.Transformatives
{
    ...
    public class CoCReptilum extends ItemSlotClass
    {
		...
		override public function useFunction(pc:Creature, usingCreature:Creature = null):Boolean
		{
			...
			if (((target.ballSizeRaw <= 2 && target.balls > 0 && target.ballsUnlocked(0)) || (target.ballSizeRaw > 2 && target.balls > 0 && target.ballSizeUnlocked(target.ballSizeRaw - 2))) && changes < changeLimit && rand(5) == 0)
			{
