		...
		override public function useFunction(target:Creature, usingCreature:Creature = null):Boolean
		{
			...
			if(target is PlayerCharacter) {
				...
				if(!pc.hasVagina())
				{
					...
					else if (InCollection(pcRace, "vulpine-morph", "vulpine-taur", "vulpogryph", "vulpogryph-taur") || InCollection(pcRace, "kitsune", "kitsune-morph", "kitsune-taur") && (pc.hasFur() || pc.hasPartFur("leg"))) // dogina is not exactly appropriate for kemonomimi type kitsune
					{
						pc.shiftVagina(0, GLOBAL.TYPE_VULPINE);
						kGAMECLASS.output("You’ve got " + indefiniteArticle(pc.vaginaColor(0)) + " vulpine pussy.");
					}
					else if (InCollection(pcRace, "feline-morph", "feline-taur", "nekomata", "nekomata-taur", "chakat", "griffin", "griffin-taur"))
					{
