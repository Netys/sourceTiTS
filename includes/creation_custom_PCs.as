...
public function customPCCheck(TF:Boolean = false):Boolean
{
	...
	switch (short)
	{
		...
		case "etis":
			...
			if (!pc.hasPerk("Implant: Iron Body")) pc.createPerk("Implant: Iron Body", 0, 1.2, 0, 0, "System of implants in your musculoskeletal system, which can greatly improve your physique.");
			if (!pc.hasPerk("Implant: Wired Reflexes")) pc.createPerk("Implant: Wired Reflexes", 0, 1.2, 0, 0, "Partial electrical replacement for your nervous system, which can greatly improve your reflexes.");
			if (!pc.hasPerk("Implant: Tactical Analyzer")) pc.createPerk("Implant: Tactical Analyzer", 0, 1.2, 0, 0, "Complex of retinal and neural implants, which can greatly improve your aim.");
			if (!pc.hasPerk("Implant: Cognitive Coprocessor")) pc.createPerk("Implant: Cognitive Coprocessor", 0, 1.2, 0, 0, "Complex of neural implants, which can greatly improve your intellegence.");
			if (!pc.hasPerk("Implant: Mental Shield")) pc.createPerk("Implant: Mental Shield", 0, 1.2, 0, 0, "Complex of neural implants, which can greatly improve your willpower.");
