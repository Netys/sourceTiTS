...
private function genderlessShouldraMasturbation():void {
	...
	else if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0 && flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] == 0) output("The moment the light reveals what lies within, your [butthole] instinctively clenches shut.  \"<i>You didn't think I'd leave my most treasured possessions behind for some goblin to run into, did you?</i>\" It's the ghost girl's chest of dildos, as well-kept as the last time you laid worried eyes on it.");
	...
	output("\n\nBut Shouldra is far from satisfied; without letting up on your current predicament, she directs your [foot] back inside her chest.  It begins indiscriminately shoving dildos of every variety up your besieged bum with undue haste.  Ectoplasmic slobber pours down your [pc.legs] as each fun stick is switched on and added to the collection.  You think she makes it to five before her hold over your [pc.legs] dissolves; lacking the ghost girl's willpower and gumption for ignoring simple laws of nature, you tumble to the ground, a small blessing in disguise as now you at least have things to grapple onto now.  Holding on with all your might is exactly what you do; the rear onslaught is rocking your entire body as every moist rod vibrates and rolls around in the confines of the ghost's gluttonous gullet.  Your inflated mutinous cheeks do their best to contain the invasion through each escalating thrust.");
...
private function nongenderlessAnalShouldraMasturbation():void {
	...
	output("\n\n\"<i>If there were ever a more... appropriate time to say something profound... to say something poetic...</i>\"");
	output("\n\nYou can't help but be perplexed by the sudden somber shift.  Though, honestly, it was just a ruse to disarm you; the ghost girl ardently crams the sucker down her gullet, sending shivers racing up your spine.  Nearly all eight inches of coarse demon pecker burrow deep within your haunted hole; the ghoul shifts the dildo around within you, thoroughly brushing your insides with its every nodule.  Dying to continue escalating things, the phantom swings her tongue up to the base and switches on the vibrator, triggering moans from both mouths.  Your bewitched butt grasps the rod once more, thrusting it in and out of you; the combined sensations of  the pseudo oral and anal assault is as only half as confusing as it is pleasurable.");
	output("\n\nBut Shouldra is far from satisfied; without letting up on your current predicament, she directs your [foot] back inside her chest.  It begins indiscriminately shoving dildos of every variety up your besieged bum with undue haste.  Ectoplasmic slobber pours down your ");
...
private function shouldraMakesCocksDisappear():void {
	...
	//MULTI
		...
		output("\n\n\"<i>I'm sorry, [Master]!  Please have mercy on me!</i>\" your [pc.cock " + pc.biggestCockIndex() + "] pleads.");
		output("\n\n\"<i>[Master], have mercy!  I'll make it up to you!  Please!</i>\" the [pc.cock " + pc.smallestCockIndex() + "] begs.");
...
public function shouldraWakesUpOrPokesPCsForShitsAndGigglesIdunnoHowLongCanIMakeThisFunctionNameQuestionMark():void {
	...
	switch(select) {
		...
		case 1:
			...
			else if (subSelect == 2) eventBuffer += ("You're distracted as you notice your [pc.cock] snaking its way down your [leg], quickly growing larger.  You make your displeasure obvious, causing it to recoil back to its original size.  Seems as though your ghostly friend is getting restless.");
		...
		case 2:
			...
			if (subSelect == 0) eventBuffer += ("Your [pc.cockBiggest] begins to feel incredibly warm and dense. You place your hands along your enormous rod, causing it to illicit a low hum.  That \"<i>mmmm</i>\" sounded vaguely like Shouldra.  Best you can figure, the ghost girl is having the time of her life concentrating her being throughout your totem pole.  Shaking your head, you decide it best to carry on, doing your darndest to ignore her.");
				...
				eventBuffer += ("Lightheadedness is setting in.  You're unsure as to the reason until you notice your [pc.cockBiggest]; it's engorged with blood!  The warm, throbbing, erect fullness is nuzzling peacefully against your [leg] in agony for release.  Shouldra's enjoying your powerful penis so much that she's starting to influence your own libido!");
				pc.slowStatGain("l", 1)
				pc.lust(10);
			}
			break;
