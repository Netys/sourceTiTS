...
public function followerCampMenuBlurbShouldra(showInteractButton:Boolean):void {
	if (followerShouldra()) {
		if (showInteractButton) addButton(followerBtnNum++, "Shouldra", function():* { shouldraFollowerScreen() });
	}
}
...
private function shouldraSleeping(changes:int = 0, reset:Boolean = false):Boolean {
	//Adjust sleep timer
	if (reset) {
		flags["COC.SHOULDRA_SLEEP_TIMER"] = changes;
	}
	else flags["COC.SHOULDRA_SLEEP_TIMER"] += changes;
	if (flags["COC.SHOULDRA_SLEEP_TIMER"] < 0) flags["COC.SHOULDRA_SLEEP_TIMER"] = 0;
	if (flags["COC.SHOULDRA_SLEEP_TIMER"] > 48) flags["COC.SHOULDRA_SLEEP_TIMER"] = 48;
	//Is she sleeping?
	if (flags["COC.SHOULDRA_SLEEP_TIMER"] > 0) return true;
	return false;
}
...
internal function initialShouldersRecruitment():void {
	...
	processTime(1);
	clearMenu();
	addButton(0, "Yes", recruitShouldraForCampSexyTimes);
	addButton(1, "No", noFollowerShoulders);
}
...
private function noFollowerShoulders():void {
	clearOutput();
	shouldraSprite();
	output("Somewhat bluntly, you inform her of your lack of interest regarding having a ghostly tagalong.  Though she looks a bit disappointed, she nods, scuffing her shoes against the ground and huffing a little sigh.  \"<i>At least I'll see you later, hey?</i>\"");
...
private function recruitShouldraForCampSexyTimes():void {
	clearOutput();
	shouldraSprite();
	output("After what you've been through, you'd be glad to let her come adventuring with you.  You let her know your thoughts, and her face brightens instantly.  \"<i>Awesome!</i>\" she exclaims, clapping her hands happily... then launching herself forward.  You brace for impact, but you needn't worry; she simply phases into you, quickly settling into the now-familiar frame.  For a moment, your eyes flash ghostly yellow, but the glow recedes to your natural eye color as she allows you full control.  \"<i>All set!</i>\" she says happily");
	if(pc.hasCock()) output(", already vying to stroke your wang through your [pc.gear] despite her relinquished hold on your body.");
	...
	flags["COC.SHOULDRA_FOLLOWER_STATE"] = .5;
	processTime(4);
	clearMenu();
	addButton(0, "Next", function():*{ processTime(10 + rand(10)); mainGameMenu(); } );
}
...
public function morningShouldraAlert():void {
	...
	flags["COC.SHOULDRA_FOLLOWER_STATE"] = 1;
	flags["COC.SHOULDRA_PLOT_COUNTDOWN"] = 7;
	addNextButton();
}
...
private function shouldraAndValaGetBigger():void {
	clearOutput();
	shouldraSprite();
	if (flags["COC.SHOULDRA_MET_VALA"] < 1) flags["COC.SHOULDRA_MET_VALA"] = 1;
	output("You decide to make your way down to the Wet Bitch to introduce Vala to her.  A few minutes into your stay, you see the fairy serving a few tables while holding a tray filled with drinks and empty glasses.  Pointing her out, Shouldra gives a delighted squeal.");
	...
	output("\n\nBefore you can object, you realize that the size difference between you would make it pretty hard to resist her demand.  Deciding that it's safer to play along, you undress in short order, tossing your [pc.gear] to the ground below.  After the last scrap of clothing is gone, she gives you a light tap that causes you to fall back on her hand.");
	clearMenu();
...
private function pureMacroValaCont():void {
	...
	//Female:
		...
		output("Her finger starts pressing firmly against your chest.  You try to push it away, but the size difference makes the effort futile.  The ghost girl starts grinding against your chest with her fingertip, the friction against your breasts causing a small gasp to escape your lips, and your nips to become slightly firmer.  She runs her pinky up your leg, stopping at your vagina, and you reflexively clench your legs together. Unfazed, Shouldra forces them back open with her fingers, exposing you to the open air.  A small breeze blows through, tickling your cunt and causing you to bite your lip.");
...
private function pureValaAndShouldraMacroMax():void {
	...
	clearOutput();
	//pc.slimeFeed();
	output("Before she can do anything, you shout out a rather unusual suggestion, though to you it sounds quite exciting.  Vala or Shouldra, whoever she is, smiles wickedly and nods, lifting you up towards the glittering gash between her legs.");
	...
	output("\n\nUp higher, you can see her puffy labia on display, glistening with moisture that's already beginning to bead on the quickly-flushing skin.  Indeed, her rosy pussy stands in stark contrast to the creamy white skin around it, visibly pulsing and engorging as you close in on it.  A moment later, your nude body makes contact with Vala's honey-pot, pressing against her lips, into her slit and all over her mons.  A sweet, slightly musky smell smears across you as you bump into the gigantic snatch, growing dizzy as the aroma overpowers your senses.  Almost immediately, you give yourself over to that steamy muff, happily stuffing your arms through her curtain-like lips and pulling them wide.  The dripping moisture oozing from the pink chasm seems to fog the very air, and before you can do anything else, a fair hand is clamping around your [pc.legs] and tilting you forward, up and in...");
	output("\n\nYour vision goes pink as the channel devours you, sliming your hair with clear, female lubricants.  You can feel your shoulders sliding in after you, and in your excitement, you pull your arms in after, pushing and stroking the silky smooth walls as you explore the inner workings of the Vala's vagina.  You can see the flesh pulsate as you touch it, and after a few particularly successful gropes, the entire channel snaps closed around you, smothering you with pussy as it involuntarily clenches around you.  The entire thing vibrates with the faerie's moan, and she pushes the rest of you in faster, her giant clit bouncing over your [pc.nipples] as she rams you in.");
	output("\n\nSoon, your body is engulfed up to your lower [pc.legs], mired in pussy and lubricant.  It's like taking a bath in slime, only the bathtub is giving you a whole-body embrace, slipping, sliding, and taking pleasure from every motion you make.");
	if (pc.hasGenitals()) {
		output("  Inspired by this, your own body has long since responded");
		if (pc.hasCock()) output(", becoming firmly erect.  You happily piston your hips to grind your [pc.multiCocks] along the pink-glossed walls, oozing your fluids in delight.");
		else output(", growing wet, though in this slick fluid, your contribution is a mere drop in the ocean.");
	}
	output("  The warm fleshy dream is abruptly ended as Shouldra yanks you out by your [pc.feet].  \"<i>I'm gonna put you the whole way in.  Do me a solid and get me off a few times, will ya?</i>\"");
	
	output("\n\nDripping with her lusty leavings, you vigorously nod and crane your head back up to the randy passage.  Your plus-sized poltergeist wastes no time in returning you to her box's moist embrace, stuffing you most of the way in with a simple motion.  A finger as big as your [pc.legs] pushes your [pc.feet] the rest of the way inside, stuffing you so high up you bump your head on the narrow entrance of her womb.  It's dark inside her, but you quickly get to work, sliding and squirming around, humping your ");
	if (pc.hasCock()) output(pc.cocksDescript());
	else if (pc.hasVagina()) output(pc.vaginaDescript());
	else output("[pc.butt]");
	output(" against the slick walls.  You push your way towards the pinkish slit in the distance begin to slide your [pc.legs] over the inner edges of her lips, pressing your arms up above you for stability.");
	...
	if (pc.hasCock()) {  
		output("  [pc.EachCock] is quickly brought to orgasm by the exotic situation, and you fire off your own load into the deluge of sex-juice.");
		if (pc.cumQ() >= 1000) output("  Somehow, you pour out almost as much spunk as Vala's orgasm, turning the inside of her honeypot into an off-white mess.");
	}
	else if (pc.hasVagina()) {
		output("  Your [pc.vagina] can scarcely resist the allure of the sweet, female flesh pressing against it, and with an explosion of hot bliss, you climax");
		if (pc.isSquirter()) output(", squirting with joy");
		output(".");
	}
	output("\n\nSlowly, the tumultuous orgasm concludes, but no sooner than it finishes, your pink prison begins to sway back and forth.  The possessed faerie is walking somewhere!  Shouldra's face peeps out of the tunnel's soaked edge, illuminated by its own inner radiance.  She says, \"<i>Don't stop now, Champ!  You were doing so well!</i>\"  Her hand appears to flick one of your [pc.nipples], and suddenly, your lust washes through you.  You try to grab hold of your ghost by the head to fuck her");
	if (!pc.hasGenitals()) output(" somehow");
	output(", but she vanishes with a high-pitched giggle.");
	
	output("\n\nDriven nearly mad by lust, you swing your [pc.legs] out of the tunnel and wrap them around the faerie's embiggened clit, grinding yourself against the top of the twat with the added leverage.  Your hands grab hold of your [pc.nipples] and tug, tweaking and twisting as you writhe in Vala's pretty, pink pussy.  Her sodden snatch has become your entire world, and you give your body and its lusts over to it, doing everything in your power to please and be pleased by the cavernous obsession.");
...
public function shouldraMeetsCorruptVala():void {
	...
	if (pc.hasCock()) output("  Your cock slips past the folds, pressed up against your stomach as the underside is massaged with the gentle tightness within.");
	output("  Once you're up to your chest, Vala stops, instead grasping your shoulders between her thumb and forefingers as she begins to gently slide you in and out of her.");
...
public function sandWitchGetsGhostly():void {
	...
	if (pc.hasCock() && (!pc.hasVagina() || rand(2) == 0)) {
		...
		output("\n\nFour hands, four boobs, more than enough to pleasure a man.  Not that that stops Shouldra from ramping things up even further, submerging your [pc.cockHead] deep within the witch's gullet.  Your fingers dig into supple sandbags as your whole body tenses up, the salacious working of your giant prick dragging you closer to your climax.  Sensing your event horizon approaching, the ghost girl redoubles her efforts: her tongue explores every inch of your crow's nest while her fearsome foursome speed up their thrusting all along your mast, drenching your body in ever-increasing torrents of milky mayhem.");
		
		output("\n\nThe spirit's efforts don't stop there, however, as both her quad-knockers and your own fuck stick have started swelling again! Unable to take much more, you finally crack.  ");
		if(pc.cumQ() < 50) output("Your modest load puffs the witch's cheeks a little, though it isn't anything the ghost can't make her handle");
		else if(pc.cumQ() < 150) output("Your load smacks the hungry ghost fairly hard, enough to distend her cheeks as far as they'll go.");
		else if(pc.cumQ() < 500) output("Your massive load just about knocks your cock free of the witch's mouth-hold, its strength distending her cheeks and neck as she works to contain it.");
		else if(pc.cumQ() < 1000) output("  Your torrent of jism pushes the ghost girl to her limits.  It takes everything in her to keep from losing her mouth-hold on your cock as your blast distends her every feature.");
		else output("  Your supernatural cum summoning is too much, blasting the willing ghost clear from your cock.  Both of your faces are soaked by the oncoming torrent, mixing in with the already heaping helping of breastmilk surrounding the dunes.");
		if(pc.cumQ() < 1000) output("  Satisfied with your offering, the enchanted sand sorceress frees your [pc.cockHead] from her maw.");
		...
		output("Shouldra pokes her head out from your torso, rubbing her hands together menacingly.  \"<i>So, we're going to have some fun with this little gal, aren't we, Champ?</i>\"  The sand witch is paralyzed with fright, able only to gaze at the bizarre spectacle before her.  Looking down at the shade sticking out of you, you see her hands now poised against your chest.  The ghost girl is ready to fly out at a moment's notice.  You decide not to keep her waiting and give her the go ahead; the force of her excited exit about throws you to the sandy ground.  The eager spirit quickly hammers into the witch, digging her sitting body into the sand.  There's a little struggling, but it isn't long until the ghost subdues her prey.");
		output("\n\n\"<i><b>I</b> always get what I want, dear.</i>\" mocks the ghost girl.  You resist the urge to roll your eyes as the sand witch turns to face you, her eyes that familiar glowing yellow hue.  You slip out of your [pc.gear] as Shouldra rises the witch to her feet.  Rising her host's fist to her lips, it appears as if she's on the cusp of discovering something.  With a snap of her fingers, she mouths a familiar spell while drawing a circle in the air with an outstretched finger.  Just as it dawns on you what she's doing, a smooth and circular object flies up from the ground, along your [pc.leg], and slips itself into your [pc.vagina].  Without the adrenaline from combat to fuel you, the besiegement of your beaver melts you ");
		if(pc.isBiped()) output("to your knees");
		else output("to the ground");
		output(", helplessly grasping for the stone orb as it vibrates, pulsates, and even changes size within you.");
		output("\"<i>So, looks like this busty blonde is also some sort of summoner!</i>\" Shouldra remarks, happily watching as you squirm around on the sandy ground.  \"<i>Now, how best can I abuse this gal's power with my own?</i>\" she ponders aloud while groping the witch's four frantic milk factories.  As usual, she comes to a decision in short order, marking the occasion with a snap of her fingers.  The haunted sorceress' gaze hones in on your writhing body.  She pushes you over onto the warm desert sand with a light touch - in your state, you can't really offer much of a fight - and climbs up on top of you, gracing you with front row access to the witch's dual vaginas while dousing you in her never-ending flow of breast milk.  Unable to reach around to the aid of your own [pc.vagina] while it endures its assault, you resist the mounting lust to best of your ability through controlled breathing.  In the meantime, all you can do is stare up at the possessed desert dweller as she hatches the next step in her inane scheme.");
		...
		output("\n\nShouldra would just melt right there on you if she could (you suspect that she really could, actually).  All four of the sand witch's howitzers bounce around and vibrate with glee as the spheres go to work.  The jostling is intense enough that you can feel the vibrations radiate down into your [pc.chest], teasing you.  Looking up into her eyes, you can see the yellow effulgence dimming, revealing the caged witch inside fighting between feelings of appetence and apprehension.  Meanwhile, the greedy ghoul goes for seconds, casting the spell a second time; it takes her a few tries as the simple act of tracing a circle in the air in her state is made maybe five times more difficult.");
		...
		output("\n\nHoly fucking...the cadre of sexual enablers instead charge deep into your [pc.vagina] and [pc.butt], taking you completely by surprise.  Your grasp on the poor sorceress' vaginas about smashes them together.  Instinctually, your [pc.legs] clench tight, your ");
		if(pc.isBiped()) output("knees");
		else output("form");
		output(" rising up against the witch's back.  The possessed sand witch leans back, her hands sliding down your [pc.legs] pinning ");
		...
		output("\n\nYour extraordinary determination wins out as Shouldra's host concedes, a cocktail of breastmilk and femspunk blasting all over your bound body.  You fall in short order after her, your [pc.vagina] letting loose its own juice");
		if (pc.hasCock()) output(", right alongside your spraying [pc.cock]");
		output(".  It's a wonder you haven't started seeing stars through all your convulsing.  Dragged through unnatural ecstasy and back, Shouldra and her host flop down ");
		if (pc.isBiped()) output("between your [pc.legs]");
		else output("on top of you");
		output(", their dual voices still mixing together as the duo try and climb down from their sexual high.  After a few moments, you slide out from underneath the witch and rise to your [pc.feet] - an action made most difficult by the continued orb penetration.");
		...
		if (!pc.hasFuckableNipples()) output("\"<i>You know, maybe I should give you a couple of those chest-mounted treats.  They're pretty fun,</i>\" Shouldra teases, tweaking your [pc.nipples].  ");
		output("With a very telling exasperated sigh, you snatch up your [pc.gear] and march back to camp.");
	}
	processTime(50 + rand(20));
...
private function shouldraFappinTimes():void {
	...
	else if (!pc.hasGenitals()) genderlessShouldraMasturbation();
	else if (pc.hasCock() && (!pc.hasVagina() || rand(2) == 0)) maleMasturbationProper();
	else {
...
//Uses [pc.foot] fully aware that it will be awkward with hooves.  FUCK THOSE MONSTERS.
//Rework into anal option for all players?

private function genderlessShouldraMasturbation():void {
	Flag("COC.SHOULDRA_GENDERLESS_FUCK_COUNT"); // maybe init
	Flag("COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"); // maybe init
	
	clearOutput();
	shouldraSprite();
	output("Shouldra runs your fingers along your ");
	//[if (femininity < 50) 
	if (pc.isMasculine()) output("masculine ");
	else if (pc.isFeminine()) output("feminine ");
	output("form while processing your request, your eyes glowing yellow as she mulls over her choices.");
	//(same paragraph follows)
	//{if SHOULDRA_GENDERLESS_FUCK_COUNT = 0 & event occurrence = 0}
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] == 0 && flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] == 0) {
	...
	//if SHOULDRA_GENDERLESS_FUCK_COUNT > 0 & event occurrence = 0
	else if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0 && flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] == 0) {
	...
	//if event occurrence > 0
		...
		output("\n\n\"<i>Up for another round then, Champ?</i>\" she asks, rubbing your hands down your [pc.butt].  ");
		//[if (corruption < 50) 
		if (pc.cor() < 50) output("There isn't an answer or outcome to that question that you're in favor of, honestly.");
		else output("You sure as hell wouldn't have bothered asking if you weren't.");
	}
	output("  The ghost girl promptly discards your [pc.gear] before hurrying your naked body along into the wilderness away from camp.");
	...
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] == 0 && flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] == 0) output("Within lies a rather rustic yet well-built chest.");
	else if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0 && flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] == 0) output("The moment the light reveals what lies within, your [pc.asshole] instinctively clenches shut.  \"<i>You didn't think I'd leave my most treasured possessions behind for some goblin to run into, did you?</i>\" It's the ghost girl's chest of dildos, as well-kept as the last time you laid worried eyes on it.");
	else output("Inside rests the ghost's familiar treasure trove of dildos and other toys you have yet to discover.");
	output("  She has you pull the container out from its hiding place, removing the clear tarp she used to protect it from the elements.  Despite the fact that you have yet to control your body once through this entire ordeal, an intrinsic urge to open the container has you bending over to pry into the contents within.");
	output("\n\nHowever, an unusual stirring deep within your midsection grinds your pursuit to a halt; the familiar visage of your companion has formed atop your feature-less groin.  \"<i>Let me take care of this, Champ,</i>\" she exclaims before thrusting forward and - after carefully wiping it clean - using your [pc.foot] to open and sift through the chest's contents.  While doing so, she begins to recite some manner of spell in a singsong voice; whatever her target is, she certainly seems to be enjoying herself.  You feel as though you could lose your balance at any time... if you actually had any command over it.  No, the poltergeist is in full control from your waist and downward, defying gravity as she continues chanting and searching through her collection.  Thanks to the incredibly awkward forward thrust you're locked in, you can't really make out the contents of her chest.  At least not visually, but as the specter guides your [pc.foot] around you can plainly tell that it's full of all sorts of dildos... among other things.");
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0) output("  Just what else did she pack in there since last you peered at its contents back at the ruins?");
	output("\n\n\"<i>Okay, here we go,</i>\" she declares, quickly ending whatever spell she was working on.  Shouldra pulls your [pc.foot] back out of the chest, a ");
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0 || flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] > 0) output("familiar, ");
	output("bumpy, eight-inch demon vibrator firmly in her \"grasp.\"  A tingling sensation coursing through your hind end draws your attention away from the ghost as she inspects her quarry.  You honestly aren't too surprised to peer around and discover your [pc.butt] plumping up, each burst of expansion quaking your flesh.");
	output("\n\n\"<i>Now, this will take me a minute to get used to...</i>\"");
	output("\n\n...Yup, now she's speaking through your [pc.asshole].  Some day you'll cease underestimating the lengths this eerie eidolon's creativity will reach in order to have a good time.  You glance forward to confirm that the woman's face has disappeared from your bare groin; this circus attraction has moved on to the main event.  ");
	if (pc.ass.looseness() < 3) {
		output("Your nerves screech out in pain as your rear revenant stretches out her puckered little \"jaw\" to something more fitting for what she has in store.  A few seconds later and the sensations begin to only register as pleasure.");
		//[if (corruption < 50)
		if (pc.cor() < 50) output("..  This only worries you further.");
		output("  It doesn't take her long to <b>prepare your anus for any insidious ploy she's thought up.</b>");
	}
	//if analLooseness >= 3
	else {
	...
	if (flags["COC.ZETSUKO_MET"] > 0) output("\"<i>Your run-in with a particular kitsune inspired me,</i>\" Shouldra teases");
	else output("Shouldra is too caught up in her machination to give you any hint as to what is going on, leaving you confused");
	output(" as the foreign object circles your sphincter.  Though difficult to get a clear visual - the amative apparition still maintains authority over your lower half - you can make out what appears to be a long, emerald, translucent tongue.  The ectoplasmic slobber running down your ");
	if (pc.isBiped()) output("[pc.leg]");
	else output("form");
	output(" essentially confirms your presumptions.  The phantom tongue strokes along your skin, making clear the fact that you can experience its sense of touch just as well as you can with your own.  You count your blessings that the imparted feelings end there; a dual sense of taste would probably end poorly in this circumstance.");
	output("\n\nWith preparation complete, the eager spirit gets right to action.  Your [pc.foot] ");
	if(pc.isBiped()) output("- still clutching the dildo while in the midst of making any yoga instructor jealous as it continues to hang in midair - ");
	output("anxiously delivers its cargo to your possessed posterior.  The ghost girl uses her augmented cheeks to grab hold of the fun stick, allowing you to regain a normal posture as your [pc.foot] returns to the ground.  The anxiety of the impending onslaught causes you to tense up; confoundment replaces anxiety when you go a few seconds without any forceful entry into your backstage.  Prying back over your shoulder, you find the ghoul merely rolling the dildo back and forth in front of her \"mouth\" tantalizingly.");
	...
	output("\n\nBut Shouldra is far from satisfied; without letting up on your current predicament, she directs your [pc.foot] back inside her chest.  It begins indiscriminately shoving dildos of every variety up your besieged bum with undue haste.  Ectoplasmic slobber pours down your [pc.legs] as each fun stick is switched on and added to the collection.  You think she makes it to five before her hold over your [pc.legs] dissolves; lacking the ghost girl's willpower and gumption for ignoring simple laws of nature, you tumble to the ground, a small blessing in disguise as now you at least have things to grapple onto now.  Holding on with all your might is exactly what you do; the rear onslaught is rocking your entire body as every moist rod vibrates and rolls around in the confines of the ghost's gluttonous gullet.  Your inflated mutinous cheeks do their best to contain the invasion through each escalating thrust.");
	...
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0 || flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] > 0) output("You recognize it instantly as she pulls it free from her chest: the nearly foot-long floppy horse cock she impaled you on before.");
	//{if SHOULDRA_GENDERLESS_FUCK_COUNT = 0}
	else if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] == 0) output("She holds her catch up clear for you to see; to your horror, you have clutched onto an enormous horse cock replica.  All 13 inches flop restlessly in your grip, seemingly taunting you with the foreboding future that lays before you.");
	output("  Shouldra smacks the dildo of doom onto a nearby boulder as she wearily rises you to your [pc.feet].  The inferior, forgotten playthings slide out uselessly from the ghoul's gasping craw as she slowly clambers over top the wiggling horsey wang.");
	...
	flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"]++;
...
private function nongenderlessAnalShouldraMasturbation():void {
	...
	output("form while processing your request, your eyes glowing yellow as she mulls over your request.  \"<i>So, let me get this straight.  Despite");
	if (pc.hasCock()) output(" this dandy dick");
	if (pc.isHerm()) output(" and");
	if (pc.hasVagina()) output(" this serviceable snatch");
	output(" you want me to work with this?</i>\" the spirit asks, smacking your hand against your [pc.butt].  A smug nod reaffirms your desire.  ");
	//(same paragraph follows)
	//if event occurrence = 0
	if (flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] == 0) {
		output("Your spectral visitor cracks your knuckles in a blustering show of confidence.  \"<i>You think you've thrown down the gauntlet with your challenge, eh, Champ?  You think rules, regulations, sanctions, trade embargos... these things can keep me down?</i>\"  What is she blathering on about?  You suspect she's just stalling; call it your own sixth sense, but as she waves your hands around as she boasts, it feels like it's taking some willpower to not just listlessly stroke your goods.  At least, it seems that way until some errant thought interrupts her tirade, a knowing grin blossoming along your mug.  \"<i>No blockade can stop me.</i>\"");
	}
	else {
		output("\"<i>Up for another round then, Champ?</i>\" she asks, your body striking a familiar boxing stance from bouts long since fought.  \"<i>If you think I'll be pulling any punches then you don't have a ghost of a chance.</i>\"  Only if you had control of your body could you respond with even half the appropriate groan.");
	}
	output("  The ghost girl promptly discards your [pc.gear] before hurrying your naked body along into the wilderness away from camp.");
	...
	output("  She has you pull the container out from its hiding place, removing the clear tarp she used to protect it from the elements.  Despite the fact that you have yet to control your body once through this entire ordeal, an intrinsic urge to open the container has you bending over to pry into the contents within.");
	output("\n\nHowever, an unusual stirring deep within your midsection grinds your pursuit to a halt; the familiar visage of your companion has pushed its way out of your groin.  You can't decide whether to laugh or cry at the sight as she");
	if (pc.hasCock()) output(" substitutes your [pc.cock] in place of her nose");
	if (pc.isHerm()) output(" and she");
	if (pc.hasVagina()) output(" shuffles your [pc.vagina] for a moment, using it as her mouth");
	output(".  \"<i>I had to get dressed up for the occasion,</i>\" she jests before thrusting forward and - after carefully wiping it clean - using your [pc.foot] to open and sift through the chest's contents.  While doing so, she begins to recite some manner of spell in a singsong voice; whatever her target is, she certainly seems to be enjoying herself.  You feel as though you could lose your balance at any time... if you actually had any command over it.  No, the poltergeist is in full control from your waist and downward, defying gravity as she continues chanting and searching through her collection.  Thanks to the incredibly awkward forward thrust you're locked in, you can't really make out the contents of her chest.  At least not visually, but as the specter guides your [pc.foot] around you can plainly tell that it's full of all sorts of dildos... among other things.");
	//if SHOULDRA_GENDERLESS_FUCK_COUNT > 0
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0) output("  Just what else did she pack in there since last you peered at its contents back at the ruins?");
	output("\n\n\"<i>Okay, here we go,</i>\" she declares, quickly ending whatever spell she was working on.  Shouldra pulls your [pc.foot] back out of the chest, a ");
	//if SHOULDRA_GENDERLESS_FUCK_COUNT > 0 OR event occurrence > 0
	...
	output("\n\n\"<i>If there were ever a more... appropriate time to say something profound... to say something poetic...</i>\"");
	output("\n\nYou can't help but be perplexed by the sudden somber shift.  Though, honestly, it was just a ruse to disarm you; the ghost girl ardently crams the sucker down her gullet, sending shivers racing up your spine.  Nearly all eight inches of coarse demon pecker burrow deep within your haunted hole; the ghoul shifts the dildo around within you, thoroughly brushing your insides with its every nodule.  Dying to continue escalating things, the phantom swings her tongue up to the base and switches on the vibrator, triggering moans from both mouths.  Your bewitched butt grasps the rod once more, thrusting it in and out of you; the combined sensations of  the pseudo oral and anal assault is as only half as confusing as it is pleasurable.");
	output("\n\nBut Shouldra is far from satisfied; without letting up on your current predicament, she directs your [pc.foot] back inside her chest.  It begins indiscriminately shoving dildos of every variety up your besieged bum with undue haste.  Ectoplasmic slobber pours down your ");
	if (pc.isBiped()) output("[pc.legs]");
	else output("form");
	output(" as each fun stick is switched on and added to the collection.  You think she makes it to five before her hold over your [pc.legs] dissolves; lacking the ghost girl's willpower and gumption for ignoring simple laws of nature, you tumble to the ground, a small blessing in disguise as now you at least have things to grapple onto now.  Holding on with all your might is exactly what you do; the rear onslaught is rocking your entire body as every moist rod vibrates and rolls around in the confines of the ghost's gluttonous gullet.  Your inflated mutinous cheeks do their best to contain the invasion through each escalating thrust.");
	output("\n\nThe moist quivering shafts - the bizarre conglomeration of shapes - the unnatural sounds and breathing emanating from your bottom - the unending geyser of diluted ectoplasmic drool soaking your body - the unorthodox tongue rooted in your asshole lashing about - your vexed cheeks simultaneously tightening around their cargo while their abnormal mass violently jiggles about - It's all too much!");
	output("\n\nShouldra doubles down on her payload, yanking it free from your bruised bottom.  But this is no act of mercy.  You're left breathless as the fiend hammers her freight as far down your cargo hold as she can muster.  Now would be a horrible time for her to choke.  The final delivery throws you over the deep-end, ");
	if (pc.hasCock()) output("your [pc.cock] spraying [pc.cum] everywhere");
	if (pc.isHerm()) output(" while ");
	if (pc.hasVagina()) output("your [pc.vagina] sprays [pc.girlCum], mixing in with the otherworldly drool already coating your [pc.legs]");
	output(".  Your humongous ass lightly quakes as the vibrating dildos continue their melodious humming, going lax in your gaping bum with the ghost girl's grip relaxing.  The torment - however alarmingly pleasurable it turned out to be - is over.");
	...
	//if SHOULDRA_GENDERLESS_FUCK_COUNT > 0 OR event occurrence > 0
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0 || flags["COC.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT"] > 0) output("You recognize it instantly as she pulls it free from her chest: the nearly 2-foot floppy horse cock she impaled you on before.");
	//if SHOULDRA_GENDERLESS_FUCK_COUNT = 0
	else output("She holds her catch up clear for you to see; to your horror, you have clutched onto an enormous horse cock replica.  All 13 inches flop restlessly in your grip, seemingly taunting you with the foreboding future that lays before you.");
	output("  Shouldra smacks the dildo of doom onto a nearby boulder as she wearily rises you to your [pc.feet].  The inferior, forgotten playthings slide out uselessly from the ghoul's gasping craw as she slowly clambers over top the wiggling horsey wang.");
	output("\n\nToo tired to object or plead, you meekly brace for impact as the wraith lines up its target.  Your immense cheeks part way.  Your rectum gapes wide.  Your anal tongue presses firmly against your taint.  \"<i>Down the hatch!</i>\"");
	output("\n\nThe forest shudders with your scream.  The phantom easily downs six inches on the first go.  She wraps her tongue around the shaft, forcing more and more into you.  You swear your pelvis is bulging.  Muffled moans blended with laughter emit from your belabored behind.  You dare not guess how deep Shoudra drills the cock into you before she climaxes - hard.  Your voluptuous ass quavers with ferocity alongside her gagged yelping, throwing you from your perch atop the rock back down to the earth.  Her fun over, you begin to feel the magic subsiding.  Having no desire to learn of the consequences of leaving a massive wang lodged in your shrinking anus, you muster what little strength you can to plumb it free.  With the experience settling down, you can't help but laugh - closer to a timid chuckle, as its the best your exhausted body can offer.  You think you hear Shouldra saying something to you, but you're too worn out to listen to her boasting.");
...
private function maleMasturbationProper():void {
	...
	output("You are nearly overwhelmed by Shouldra's delight when you allow her to focus on your [pc.cock " + x + "].  She instantly takes the lead, steering you behind a good-sized boulder and flinging your [pc.gear] piece-by-piece as you go.");
	...
	output("\n\nYou don't bother responding.  She reaches to you, and you take her hand, letting her guide you to your [pc.feet].");
	//if cocksize <200: 
	if (pc.cockVolume(x) < cockVolume(200)) output("  You stagger a bit at the unaccustomed heft of your junk altering your center of gravity, but you know that will wear off soon enough.");
	output("  She reaches into her tunic and tosses you a full bottle of ectoplasm, giving you a wink before incorporealizing once more and floating into you.  All's well that ends well.");
	output("\n\n");
	processTime(50 + rand(20));
	pc.orgasm();
	//dynStats("sen", -2);
...
private function girlyMasturbationWithGhosts():void {
	...
	output("\"<i>Tsk!  Saying those kinds of things aloud!  Still... if you want to let it out so badly, I might let you if you beg a little more...</i>\"");
...
private function shouldraTongueLicksPCs():void {
	Flag("COC.SHOULDRA_GENDERLESS_FUCK_COUNT"); // maybe init
	Flag("COC.SHOULDRA_TONGUE_LICKS_TIMES"); // maybe init
	...
	//if SHOULDRA_GENDERLESS_FUCK_COUNT > 0 || event occurrence > 0
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0 || flags["COC.SHOULDRA_TONGUE_LICKS_TIMES"] == 0) output("  The consistency of your forgetfulness while traveling this path leads you to believe that your ethereal inhabitant would rather you not come back here on your own.");
	...
	if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] == 0 && flags["COC.SHOULDRA_TONGUE_LICKS_TIMES"] == 0) output("  Within lies a rather rustic yet well-built chest.");
	else if (flags["COC.SHOULDRA_GENDERLESS_FUCK_COUNT"] > 0 && flags["COC.SHOULDRA_TONGUE_LICKS_TIMES"] == 0) output("  \"<i>You didn't think I'd leave my most treasured possessions behind for some goblin to run into, did you?</i>\"  It's the ghost girl's chest of dildos, as well-kept as the last time you laid worried eyes on it.");
	else output("  Inside rests the ghost's familiar treasure trove of dildos and other toys you have yet to discover.");
	output("  She has you pull the container out from its hiding place, removing the clear tarp she used to protect it from the elements.  Despite the fact that you have yet to control your body once through this entire ordeal, an intrinsic urge to open the container has you bending over to pry into the contents within.");
	...
	//if event occurrence == 0
	if (flags["COC.SHOULDRA_TONGUE_LICKS_TIMES"] == 0) {
		...
		if (pc.hasLongTongue()) output("some of ");
		output("your [pc.tongue] out, examining it.  Already, you think you've got a pretty good idea of where she's going to take this.");
	...
	if (pc.hasPerk("Flexibility") || pc.isFlexible()) {
		//if event occurrence = 0
		if (flags["COC.SHOULDRA_TONGUE_LICKS_TIMES"] == 0) {
			...
			output("\n\nShe sits you down and lets her dildos fall to the ground, forgotten for the moment.  \"<i>How's this one go?</i>\" she asks, leaning down in an awkward attempt to get your face in your " + pc.vaginaDescript(0) + ".  You start to explain the proper 'technique' to what she's trying to do, but before you can even finish your thought she's stuck a leg up in the air and has your mouth to your own snatch.  You doubt you'll ever get used to having her inside your thoughts.");
		}
		...
		if (flags["COC.SHOULDRA_TONGUE_LICKS_TIMES"] == 0) {
			output("  Almost shocked enough to wrest control away from your companion, you begin to babble dissent and try to reel your lengthening tongue back in to no avail.  Shouldra stops for a moment, quite frustrated by the interruption.  Sitting straight up, she consoles you, \"<i>Relax, Champ, it'll stop feeling weird in a minute and you know it's all temporary.</i>\"");
		...
		output(" sliding fingers along the wet appendage, humming a little tune over your tongue until more than a foot of it droops from your mouth.  \"<i>Now we're getting somewhere,</i>\" you hear her thinking as she works her magic.  There doesn't seem to be a limit to how much she can pull out of your mouth, and soon she has more than three feet of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can't manage to wiggle more than the tip.  \"<i>Too thin,</i>\" she mutters, \"<i>much too weak. Doesn't feel right...</i>\"");
	...
	// actually, draconic one is long enough as is even without her upgrades
		...
		if (flags["COC.SHOULDRA_TONGUE_LICKS_TIMES"] == 0) output("  Almost shocked enough to wrest control away from your companion, you begin to babble dissent and try to reel your lengthening tongue back in to no avail.  Shouldra stops for a moment, quite frustrated by the interruption.  Sitting straight up, she consoles you, \"<i>Relax, Champ, it'll stop feeling weird in a minute and you know it's all temporary.</i>\"\n\nGranted a moment to adjust, you let yourself settle down and hand her the reins once more.  She happily goes back to ");
		else output("\n\n She happily continues ");
		output("sliding fingers along the wet appendage, humming a little tune over your tongue until more than an additional foot of it droops from your mouth.  \"<i>Now we're getting somewhere,</i>\" you hear her thinking as she works her magic.  There doesn't seem to be a limit to how much she can pull out of your mouth, and soon she has more than three feet of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can't manage to wiggle more than the tip.  \"<i>Too thin,</i>\" she mutters, \"<i>much too weak. Doesn't feel right...</i>\"");
		output("\n\nTaking the midsection of your tongue in your hand, she slowly starts to rub her hand along some of its length.  It feels... odd, somehow, but not entirely unpleasant.  Though you shudder at the first rub, they start to feel more natural as she pushes you on.  Actually, it feels sort of good.  Her strokes remain constant, though some part of you wishes she'd go faster.  It doesn't even register as odd in your addled mind that your tongue is swelling in your hand with every stroke.  Shouldra starts to make wider movements along your smooth stretch of muscle.  Its girth plumps up to fill your palm nicely wherever she brings your hand, and the strange sensations of your flesh on its nerves wrack your body with shudders of pleasure even through Shouldra's grip.");
	...
	output("\n\nYou wake some time later, lying naked beside a pile of your [pc.gear].  You're right back at camp.  The ghost girl managed to drag you back somehow - no doubt interested in keeping the location of her secret goodies safe.");
	processTime(50 + rand(20));
	pc.orgasm();
	//dynStats("lib", .25, "sen", -2);
	pc.slowStatGain("l", 0.25);
	shouldraSleeping((10 + rand(26)), true);
	flags["COC.SHOULDRA_TONGUE_LICKS_TIMES"]++;
	addNextButton();
}
...
public function shouldraDream1():void {
	Flag("COC.SHOULDRA_PLOT_LEVEL"); // maybe init
	...
	else if (flags["COC.SHOULDRA_PLOT_LEVEL"] == 1) {
	...
	else if (flags["COC.SHOULDRA_PLOT_LEVEL"] == 2) {
		//Dream 3 - "Recent" Goblin Possession
		//triggers one week after Dream/Talk 2
		output("Few things more relaxing than heading home after a day of work.  But as you approach the dilapidated hut, some strange noises from within catch you off guard.  If it's that fucking mouse again...");
	...
	if (flags["COC.SHOULDRA_PLOT_LEVEL"] == 3) {
		//Dream 4 - Backstory
	...
	flags["COC.SHOULDRA_PLOT_LEVEL"]++;
	flags["COC.SHOULDRA_TALK_NEEDED"] = 1;
	addNextButton();
}
...
private function shouldraYappin():void {
	Flag("COC.SHOULDRA_PLOT_LEVEL"); // maybe init
	Flag("COC.SHOULDRA_TALK_NEEDED"); // maybe init
	Flag("COC.SHOULDRA_PLOT_COUNTDOWN"); // maybe init
	
	clearOutput();
	//Plot dreams!
	if (flags["COC.SHOULDRA_TALK_NEEDED"] == 1) {
		//unlocked with Dream 1
		if (flags["COC.SHOULDRA_PLOT_LEVEL"] == 1) {
			//Clear out that talk happened and start a countdown till next dream sequence.
			flags["COC.SHOULDRA_TALK_NEEDED"] = 0;
			shouldraSprite();
			if (flags["COC.SHOULDRA_PLOT_LEVEL"] < 4) flags["COC.SHOULDRA_PLOT_COUNTDOWN"] = 7;
			...
			output("You decide not to beat around the bush and ask about the strange dream you had the other night.  The spirit puts on a surprised reaction, your shoulder returning to normal as she casually walks outside of your body.");
			...
			if (pc.hasPerk("Incorporeality")) output("  Shouldra bumps you to the side a little as she makes her next point, \"<i>Even with your hoaky quasi-possession power, you don't really know what it's like to actually possess someone.</i>\" You look at her funny, unaware that you weren't really getting the full effect.  Not that you care!");
			output("\n\nShouldra scootches over against you until almost half of her body is inside of yours.  She moves your arm and [pc.leg] around as she illustrates her next point, \"<i>The expectation is that you're just 'putting on' the host.  Like a glove or a suit.  But the instant you dive inside someone");
			if (pc.hasPerk("Incorporeality")) output(" - and I mean <b>really</b> possess someone -");
			output(" you find out just how much more there is to it.</i>\" Shouldra directs your hand up, staring at it intently as she sprawls out your fingers, \"<i>You aren't crawling inside a husk.  There's a lot to a living being.  You felt it in my dream.  I know how to deal with it now but back then? It took real determination to not lose yourself in a person.  Even the most boring scumbag has a life's worth of history and an endless program of emotion and thought.</i>\"");
			output("\n\nShouldra puts on a mischievous smile, turning to face you, \"<i>That's not to say I never pry, mind you.  Given all the time I've spent with you, I've been able to learn plenty.  Like about your hometown of Ingnam, Champ.</i>\" Shouldra laughs as you shuffle around uncomfortably, the notion of the ghost girl ransacking your mind of its every fiber not sitting well with you.  \"<i>Don't worry your pretty little head over it, though.</i>\"  Your hand reaches down unbidden, grasping at your ");
			if (!pc.hasGenitals()) output("[pc.asshole]");
			else output("[pc.crotch]");
			output(".  \"<i>No matter what treasure trove of knowledge I dig up from you, there's always something I'm more interested in.</i>\"  Your hand lifts back up, and you watch as Shouldra's hand splits off from your own, meeting below the wrist.  She holds your hand with her own ghostly appendage, resting her head on your shoulder.  The ghost girl sits there for a moment, silent, leaving you to wonder if maybe, just maybe, you're starting to mean a little more to her than just a sex toy.");
			output("\n\nObviously aware of your inner monologue, Shouldra slips back inside you and digs both your hands into your [pc.gear].  You may not have a clear answer, but you figure you have enough information to come to your own hypothesis.");
		}
		//Talk 2 - First Transformation Discussion
			...
			if (pc.hasGenitals()) {
				...
				output(" start to swell up; looking up at the ghost, you realize that she hasn't uttered a single word!");
			}
			else output("  A fleshy, penis-shaped bulge begins to swell out of your loins; looking up at the ghost, you realized she hasn't uttered a single word!");
			output("\n\n\"<i>When I get involved, I turn things into a two-handed job.</i>\"  Your hands move up and slip inside your [pc.gear], sensually massaging your puffing package.  \"<i>Things that are unique to <b>me.</b>  That only I can deliver.  That's my rule.  As long as I'm turning something otherwise ordinary into something extraordinary, I'm never bored.</i>\"  Shouldra casts you a lewd smile, resting her free hand over your over-active bulge.  Your [pc.gear] is only feeling more and more constrictive as your ");
			if (pc.hasCock()) output("dick");
			if (pc.isHerm()) output(" and ");
			if (pc.hasVagina()) output("cootch");
			if (!pc.hasGenitals()) output("dick");
			if (!pc.isHerm()) output(" continues its");
			if (pc.isHerm()) output(" continue their");
			output(" march of magnification while your fingers vigorously explore their new frontiers.");
			output("\n\n\"<i>No potions, no tonics, no needles, no booze, no eggs, nothing.</i>\"   Your genitals pulse adding emphasis to the ghost's boast, quickly plumping up an extra step as your digits dig into your flesh.  \"<i>Nothing but me.  That's what makes me unique.</i>\"  Shouldra undoes your outfit with her free hand, releasing you from your constraints.  Without it in the way, the phantom directs your hands all along your ");
			if (pc.hasCock()) output("burgeoning dickflesh");
			if (pc.isHerm()) output(" and ");
			if (pc.hasVagina()) output("widening feminine walls");
			if (!pc.hasGenitals()) output("burgeoning dickflesh");
			output(".  It takes some gumption for you to work through the arousal and contribute to the conversation, but you manage to point out how you're pretty sure there are other people in Mareth with the same sort of power, to some degree at least.");
			...
			output("\n\nYou're about knocked off your [pc.feet] as your hands go into double time, covering every new square inch of flesh on your midsection.  ");
			if (!pc.hasGenitals()) output("Your now erect dick is leaking out pre at an alarming rate, which your possessed hands greedly lap up and distribute all along your length.  ");
			if (pc.hasCock()) output("Your now erect dick is leaking out pre at an alarming rate, which your possessed hands greedly lap up and distribute all along your length.  ");
			if (pc.hasVagina()) output("Your cunt has ballooned up enough to press hard against your [pc.legs], its increased wetness allowing for your hands to effortlessly glide along its canyon walls and north watchtower.  ");
			output("\"<i>You know, I've grown so accustomed to your body... I easily understand it as well as my own.</i>\"  You aren't quite sure how reassuring that is, considering her lack of a body, but the point is made just the same.");
			output("\n\n\"<i>I'm willing to try and see if I can't get my magic to make for more permanent changes.  And if you change your mind, I'm sure I can shrink it back down, too.</i>\"  Your hands slow back down, back to a more erotic pace, as the ghost girl considers her own ability.  \"<i>I wouldn't want to do it too much or too often; I haven't exactly made it into a science... yet.  But I'm always up for a challenge.</i>\"  Shouldra pays you a warm smile, placing her free hand down on your billowing sex");
			if (pc.isHerm()) output("es");
			output(".  \"<i>Just let me know if you're ever interested.  I'm sure nothing will go wrong.</i>\"");
			output("\n\nOn that unsettling remark, the ghost girl climbs back inside of your body.  Your automated hands finally go limp and the expanding finally ceases, leaving you with")
			if (!pc.isHerm()) output(" an extra large sexual toolset waiting for release.");
			if (pc.isHerm()) output(" a couple of extra large pride and joys waiting for the big finale.");
			output("  You embrace the ghost's gift");
			if (pc.isHerm()) output("s");
			output(", wondering if it's worth taking her up on the offer.  Doing your best to ignore her last statement, you continue mulling it over while enjoying your current predicament before it vanishes and returns you to normalcy.  As normal as you ever are, anyway.");
			//Unlocks Grow/Shrink options
		}
		//Talk 3 - "Recent" Goblin Possession Discussion
		else if (flags["COC.SHOULDRA_PLOT_LEVEL"] == 3) {
			//Clear out that talk happened and start a countdown till next dream sequence.
			flags["COC.SHOULDRA_TALK_NEEDED"] = 0;
			shouldraSprite();
			if (flags["COC.SHOULDRA_PLOT_LEVEL"] < 4) flags["COC.SHOULDRA_PLOT_COUNTDOWN"] = 7;
			//unlocked with Dream 3
			output("You stare at Shouldra.  \"<i>Oh, <b>what</b>?</i>\"  You stare at Shouldra.  \"<i>She fucking pissed on my floor!</i>\"  You stare at Shouldra.  The ghost shakes her head, sinking it back inside your skin. The ghost girl quickly flies out of your chest.  \"<i>You don't fuck with my stuff!</i>\"");
			...
			if (pc.hasCock()) output("</i>\"  Shouldra eyes your [pc.cock] gingerly, acting as if she can stare right through your outfit at it.  \"<i>");
			else output("  ");
			output("The half-millenium or so of scarcity has really shaped my interests.  I'm at the point now where I just lose it whenever I get these ghostly mitts on a slab of meat.  And the big ones?  ");
			if (pc.biggestCockVolume() >= cockVolume(200)) output("Ones like yours?  ");
			output("Then I'm just in heaven.</i>\"  Hold on.  She can turn any dick into a towering monument.  What's so special about ones that come pre-packaged, you ask?  \"<i>I kinda break the one rule I had at that point, but when I find someone with a big boner, it just... feels so good to me.  There's just something about an all-natural magnum opus that just lights my fire.</i>\"");
			...
			output("\"<i>Oh,</i>\" she says, stepping out of you and sitting herself across from you.  \"<i>You saw that.</i>\"");
	...
	//Generic Oni Discussion!
		...
		output("On a whim, you decide to have a chat with your spectral companion, who obligingly pops free of your torso to spare you the awkward sensation of conversing with one of your own body parts.");
...
public function shouldraFollowerScreen():void {
	shouldraSprite();
	clearOutput();
	if (!shouldraSleeping()) output("You pulse a desire for interaction with Shouldra, summoning her head to form from your shoulder. \"<i>What's on your mind, Champ? I could've found out on my own, but I was... preoccupied.</i>\"");
	//Follower Screen Quick Text - Shouldra asleep
	else {
		output("You try and contact Shouldra, but the ghost is still sound asleep within you.  Or whatever ghosts consider sleep after an arousing round of debauchery. Either way, you garner no response.  Best to try again later.");
		addNextButton();
		return;
	}
	...
	if (pc.lust() >= 33) addButton(1, "Sex", shouldraSexMenu);
	else addDisabledButton(1, "Sex", "Sex", "This option requires you to have sufficient arousal.");
	addButton(9, "Go Away", kickFollowerShouldraOut);
...
private function shouldraSexMenu():void {
	clearOutput();
	shouldraSprite();
	output("Shouldra stirs from somewhere deep inside you, excitement evident in the swiftness of her reaction.  \"<i>Is it time for some fun, Champ?</i>\" she asks happily, her increased lust affecting you just a bit.  Do you oblige her?");
	
	clearMenu();
	addButton(0, "GhostMast", shouldraFappinTimes);
	if (pc.hasGenitals()) addButton(1, "Anal Mast", nongenderlessAnalShouldraMasturbation, undefined, "Anal Masturbation", "Shouldra could also let you have a little anal fun, if you'd like.");
	if (int(flags["COC.FREED_VALA"]) != 0 && (hours >= 12 && hours <= 21)) addButton(2, "Visit Vala", shouldraAndValaGetBigger, undefined, "Visit Vala", "Vala might interest Shouldra.  You could go introduce them...");
...
private function shouldraTalkMenu():void {
	...
	if (flags["COC.SHOULDRA_PLOT_LEVEL"] >= 2) {
		if(int(flags["COC.SHOULDRA_MAGIC_COOLDOWN"]) <= 0) {
...
private function shouldraGroPlus():void {
	clearOutput();
	shouldraSprite();
	output("You decide to take up Shouldra's offer on natural body enhancement.  Before you tell her as much, the eager spectre quickly assumes control of your body.  \"<i>Alright, Champ, now we're in business.  So, what did you have in mind?</i>\"");
	//Balls     Breast     Clit     Cock     Nipples     Butt     Nevermind
	clearMenu();
	if (pc.balls > 0) addButton(0, "Balls", groBallsBiggaGHOSTYSTYLE);
	else addDisabledButton(0, "Balls", "Balls", "You have no balls to grow.")
	addButton(1, "Breasts", shouldraGrowsYoTits);
	if (pc.hasClit()) addButton(2, "Clit", shouldraGrowsYoClit);
	else addDisabledButton(2, "Clit", "Clit", "You have no clit to grow.")
	if (pc.hasCock()) addButton(3, "Cock", shouldraCockBloating101);
	else addDisabledButton(3, "Cock", "Cock", "You have no cock to grow.")
...
private function groBallsBiggaGHOSTYSTYLE():void {
	...
	clearOutput();
	shouldraSprite();
	output("\"<i>Interested in a bigger ballsack, huh?  Not only will it help pronounce your package, but a big ol' swinging sack of nuts feels great when you're really pounding.</i>\" Shouldra grasps your [pc.balls] with both your hands and begins reciting the appropriate spell.");
	//ballsize + 2 + rand(4) 20% chance
	if (rand(5) == 0) {
		pc.ballSizeRaw += 2 + rand(4);
		output("\n\nYour testicles rumble greatly, inch after inch of flesh enveloping their impressive new bulk.  Shouldra gives your enlarged [pc.balls] a little squeeze and leaves you to reacquaint yourself with a new center of balance.");
	}
	//ballsize + 1 + rand(2) Else
	else {
		pc.ballSizeRaw += 1 + rand(2);
		output("\n\nA tingling sensation courses through your scrotum, your going taut as it gains additional mass.  Shouldra rewards your new [pc.balls] with a light massage.");
	}
	//if ballsize > 10
	if (pc.ballDiameter() > 10) output("  You second guess your decision when your swinging cum barrels seem to impede walking.  Shouldra reassures you that the enhanced libido and baby batter supply is worth the wider gait.");
	processTime(10 + rand(5));
	pc.lust(10);
	addNextButton();
}
...
private function shouldraGrowsYoTits():void {
	...
	clearOutput();
	shouldraSprite();
	output("\"<i>I'll give you a rack that could hypnotize anyone into a faithful tit slave,</i>\" Shouldra boasts, stretching your shoulders in preparation.  Your hands grope your [pc.fullChest] as the spirit slips into the arcane language you've come to grow so familiar with.\n\n");
	//same growtits() as Gro+
	if (pc.breastRows.length == 1) Mutator.growTits(pc, (1 + rand(5)), 1, true, 3);
	else Mutator.growTits(pc, (1 + rand(2)), pc.breastRows.length, true, 1);
	processTime(10 + rand(5));
	pc.lust(10);
	addNextButton();
}
...
private function shouldraGivesYaSomeFukkinTeats():void {
	...
	clearOutput();
	shouldraSprite();
	output("Shouldra rubs your hands together in anticipation, \"<i>A beautiful blossoming pair of nipples is what you need to really compliment a nice set of tits.</i>\"  Your hands gleefully tweak your [pc.nipples] as the spirit's incantation gets underway.");
	output("\n\nYour nipples press hard against your [pc.gear], easily gaining at least a quarter of an inch in size.  Shouldra gives each [pc.nipple] a hasty inspection, ensuring her work.");
	//same increase and potential for fuckable nipples as Gro+
	pc.nippleLengthRatio += 0.25;
	//NIPPLECUNTZZZ
	if (!pc.hasFuckableNipples() && pc.biggestTitSize() >= 3 && rand(4) == 0) {
		var temp:Number = pc.breastRows.length;
		var temp2:Number = 0;
		//Set nipplecunts on every row.
		while(temp > 0) {
			temp--;
			if (!pc.breastRows[temp].fuckable() && pc.nippleLength(temp) >= 2 && pc.nippleTypeUnlocked(temp, GLOBAL.NIPPLE_TYPE_FUCKABLE)) {
		...
		if (temp2 > 0) output("  While doing so, she manages to slip a few of your fingers within the engorged teats, ecstatcy flowing through you as your digits explore their inner workings.  \"<i>I may not be a doctor, Champ, but it looks to me like <b>you've managed to gain yourself a pair of fuckable nips.</b></i>\"  The ghost girl spends a few minutes running your fingers around your [pc.nipples], inside and out, just to confirm her diagnosis.");
	}
	processTime(10 + rand(5));
	pc.lust(15);
	addNextButton();
...
private function shouldrasButtBigginator():void {
	...
	clearOutput();
	shouldraSprite();
	output("Shouldra's haunting laugh works its way out from your mouth.  \"<i>Looking for a little more jiggle in your step, Champ?  I can get BEHIND that.</i>\"  This damnable ghost won't let you roll your eyes!  Is there no end to her torment?  After a quick crack of your knuckles, Shouldra directs your hands back onto your derriere as she transitions into spellcasting.");
	//this.pc.buttRating = this.pc.buttRating + 1 + rand(3)); or so
	pc.buttRatingRaw += 1 + rand(3);
	output("\n\nYour cheeks quake as the magic takes hold, warm ripples greeting the inches of new retail estate on your hind quarters.  Shouldra can't resist herself, giving your [pc.butt] a vigorous slap.");
...
private function shouldraReductoMenu():void {
	clearOutput();
	shouldraSprite();
	output("Shouldra's offer to shrink aspects of your body sounds right up your alley, and you pulse as much to your ghostly compatriot.  There's no response.  You remind her that it was HER suggestion in the first place.  \"<i>Come ooooon, Champ.  It was just a slip of the ol' spiritual tongue.</i>\"  You cross your arms and look up and off to the side, the best way you can figure to glare at something that isn't there. \"<i>Ugh, fine.  Let's just get this over with,</i>\" Shouldra concedes, removing your [pc.gear].");
	//Balls     Breast     Clit     Cock     Nipples     Butt     Nevermind
	clearMenu();
	
	if (pc.balls > 0 && pc.ballDiameter() > 1) addButton(0, "Balls", shouldraReductosYourBallsUpInsideYa);
	else addDisabledButton(0, "Balls", "Balls", "This option requires you to have large enough balls.");
	
	if (pc.biggestTitSize() >= 1) addButton(1, "Breasts", shouldraReductosYourTits);
	else addDisabledButton(1, "Breasts", "Breasts", "This option requires you to have breasts.");
	
	if (pc.hasClit() && pc.clitLength > .25) addButton(2, "Clit", clittyVanishingActShouldra);
	else addDisabledButton(2, "Clit", "Clit", "This option requires you to have large enough clit.");
	
	if (pc.hasCock() && pc.longestCockLength() > 4) addButton(3, "Cock", shouldraMakesCocksDisappear);
	else addDisabledButton(3, "Clit", "Clit", "This option requires you to have large enough cock.");
	
	if (pc.nippleLengthRatio > .25) addButton(4, "Nipples", shrinkDemNipplzForYoGhost);
	else addDisabledButton(4, "Nipples", "Nipples", "This option requires you to have large enough nipples.");
	
	if (pc.buttRatingRaw >= 2) addButton(5, "Butt", shrinkDatBootyForYoGhost);
	else addDisabledButton(5, "Butt", "Butt", "This option requires you to have large enough butt.");
...
public function shouldraReductosYourBallsUpInsideYa(rescue:Boolean = false):void {
	...
	shouldraSprite();
	if (rescue) {
		output("\"<i>Gone a bit too far and got those delicious cumquats too big?</i>\"  Shouldra's arsenal of puns and teases don't affect your request in the slightest.  The ghost girl moves into a quick spell, savoring your testicles before finishing.");
		if (pc.ballSizeRaw > 18 + (pc.tallness / 4)) pc.ballSizeRaw = 16 + (pc.tallness / 4);
	}
	else
		output("\"<i>Why would you want to shrivel these delicious cumquats?</i>\"  Shouldra's arsenal of puns doesn't affect your request in the slightest.  The ghost girl moves into a quick spell, savoring your testicles before finishing.");
	//this.pc.ballSize = this.pc.ballSize - (2 + this.rand(4));
	pc.ballSizeRaw -= (1 + rand(3));
	if (pc.ballSizeRaw < 1) pc.ballSizeRaw = 1;
	output("\n\nYour scrotum shifts and squirms, clinging to your testicles as your package recedes into your body by a few inches.  The pouting ghost is quick to give you back your body, disappointed in your new [pc.balls].");
...
private function shouldraReductosYourTits():void {
	...
	clearOutput();
	shouldraSprite();
	output("Your arms clasp themselves around your [pc.fullChest].  \"<i>Not the gals!  What monster would want to deflate their knockers?</i>\"  This monster, evidently.  Shouldra sighs, holding your hands in a weak casting stance as she gets the heinous act over with.");
	Mutator.shrinkTits(pc, true);
	output("\n\nYou explore your [pc.fullChest] carefully, confirming their new size.  As you brush over your right [pc.nipple], a tiny burst of [pc.milk] soaks your hand.  You suppose your mutinous friend isn't too thrilled with your new brassiere size.");
...
private function clittyVanishingActShouldra():void {
	...
	clearOutput();
	shouldraSprite();
	output("\"<i>Aw, really, Champ?  The best part of your snatch?</i>\"  A nod of your head reasserts your desire.  The depressed phantom hastily works through the spell, the notion of shrinking your [pc.clit] not sitting well with her.");
	pc.clitLength = int(pc.clitLength * 100 / 170);
	if (pc.clitLength < 0.25) pc.clitLength = 0.25;
...
private function shouldraMakesCocksDisappear():void {
	...
	clearOutput();
	shouldraSprite();
	output("Your hands dart for your [pc.cocks] as if to protect your poor masculinity.  \"<i>You're kidding, right?  You can't mean to rob me of my pride and joy!</i>\"  You remind Shouldra just whose dick she's talking about; the eidolon is getting a little too accustomed to your [pc.cocksLight].  \"<i>Please, Champ.  Not the dick...</i>\"  You slowly remove your hands from your crotch, asking the ghost to proceed.  She complies with a frustrated sigh and a rather perturbed incantation.");
	if (pc.cocks.length == 1) {
		...
		if (choice == 0) output("murderer");
		else if (choice == 1) output("bastard");
		else if (choice == 2) output("jerk");
		else if (choice == 3) output("monster");
		else if (choice == 4) output("cretin");
		else if (choice == 5) output("fiend");
		else if (choice == 6) output("asshole");
		else if (choice == 7) output("villain");
		else output("dick");
		output("!</i>\" it shouts.  The tiny voice fades away as your [pc.cock] goes still, resting at two thirds of its original size.  A single tear rolls down your cheek; you suspect the melodramatic spirit is at fault here.");
		pc.cocks[0].cLengthRaw *= 2/3;
	}
	//MULTI
	else {
		output("\n\nYour dicks vibrate slightly as the magic begins to sink in.  You about jump out of your skin when they suddenly start smoking and flailing about.  Your fear is short lived, however, when they begin to wail and cry.");
		output("\n\n\"<i>I'm sorry, [pc.Master]!  Please have mercy on me!</i>\" your [pc.cock " + pc.biggestCockIndex() + "] pleads.");
		output("\n\n\"<i>[pc.Master], have mercy!  I'll make it up to you!  Please!</i>\" the [pc.cock " + pc.smallestCockIndex() + "] begs.");
		if (pc.cockTotal() > 2) output("\n\n\"<i>I'll fuck extra hard, [pc.Master]!  Just give me a chaaaance!</i>\" another yells.");
		if (pc.cockTotal() > 3) output("\n\n\"<i>What did we do wrong?  At least tell us that much!</i>\" one of your cocks begs.");
		if (pc.cockTotal() > 4) output("\n\n\"<i>I'll never fucking forgive you for this!</i>\" another of your dicks shouts furiously.");
		if (pc.cockTotal() > 5) output("\n\n\"<i>Are we a nuisance?  Please, [pc.Master], there must be another way!</i>\" yet another one of your many cocks pleads.");
		if (pc.cockTotal() > 6) output("\n\nThe remainder of your plentiful penises are a sad mixture of crying and begging.");
		...
		for(var ii:Number =0;ii<pc.cocks.length;ii++) {
			pc.cocks[ii].cLengthRaw *= 2 / 3;
		}
	}
	//dynStats("sen", -2, "lus", -10);
...
private function shrinkDemNipplzForYoGhost():void {
	...
	clearOutput();
	shouldraSprite();
	output("\"<i>Are you kidding me, Champ?  Nipples are the most important-</i>\"  You cut the ghost girl's argument there, not wanting to leave your decision up for debate.  She instead leaves you with a deep sigh of disapproval before quickly casting the appropriate spell.");
	//Shrink
	if (pc.nippleLengthRatio / 2 < .25) {
		output("\n\nYou run a couple fingers around your [pc.nipples], finding them shrunk to a quarter-inch long.  A quick squirt of liquid from each surprises you, causing you to jerk back a little.  Shouldra is evidently not too thrilled over your alterations.");
		pc.nippleLengthRatio = .25;
	}
	else {
		output("\n\nYou run a couple fingers around your [pc.nipples], finding them at nearly half their original size.  A quick squirt of liquid from each surprises you, causing you to jerk back a little.  Shouldra is evidently not too thrilled over your alterations.");
...
private function shrinkDatBootyForYoGhost():void {
	...
	clearOutput();
	shouldraSprite();
	output("Your hands quickly grasp at your bare [pc.butt].  \"<i>You... you're desecrating a national treasure here!</i>\"  The rather odd declaration gets a chuckle from you, but you remain firm in your request to dull your derriere.  The ghost girl furthers her attempts to change your mind, but without literally changing your mind, you remain steadfast.  Defeated, your hands take one last trip around your posterior before the poltergeist recites her incantation.");
	if (pc.buttRatingRaw >= 15) {
		pc.buttRatingRaw -= 3 + int(pc.buttRatingRaw / 3);
		output("\n\nWithin seconds, your cheeks feel noticeably lighter.  You confirm with a glance that your [pc.butt] is much smaller than before.  Shouldra confirms with a pouting sigh that she is much sadder than before.");
	}
	else if (pc.buttRatingRaw >= 10) {
		pc.buttRatingRaw -= 3;
		output("\n\nYour ass jiggles as it recedes into your body.  A few moments later and your [pc.butt] settles into its new, compact form.  The ghost girl recedes deep back into your body with a depressing sigh.");
	}
	else {
		pc.buttRatingRaw -= 1 + rand(3);
		if (pc.buttRatingRaw < 1) pc.buttRatingRaw = 1;
		output("\n\nIn a few brief seconds, your [pc.butt] relaxes into its new, slightly tinier form.  Shouldra huffs and puffs inside you, not wanting to discuss your bottom any further.");
	}
...
private function kickFollowerShouldraOut():void {
	...
	if (flags["COC.SHOULDRA_PLOT_LEVEL"] < 4 || flags["COC.SHOULDRA_TALK_NEEDED"] > 0) {
		output("\"<i>Ah, you're booting me out, hey?</i>\"  Shouldra asks innocently, tumbling out of your body and corporealizing. \"<i>Wouldn't be the first, and won't be the last.  I do realize I have certain 'needs' that got cloying to many of my former hosts.</i>\"");
		...
		flags["COC.SHOULDRA_FOLLOWER_STATE"] = 0;
		processTime(10 + rand(5));
		addNextButton();
	}
	//She Fucking Explodes
	else {
		output("Are you sure you want to ask her to leave after she opened herself up to you?  It's just a hunch, but she might not take this very well.");
		clearMenu();
		addButton(0, "Yes", definitelyKickOutCrazyGhosts);
		addButton(1, "No", shouldraTalkMenu);
	}
}
...
public function shouldersWarnings():Boolean {
	...
	if (flags["COC.SHOULDRA_SLEEP_TIMER"] == -96) {
		shouldraSprite();
	...
	else if (flags["COC.SHOULDRA_SLEEP_TIMER"] == -168) {
		shouldraSprite();
		trace("LEVEL 2 LUST INCREASE HAPPEN");
		//increased minimum lust +20 until Shouldra is satisfied
		if (rand(3) == 0) {
			eventBuffer += ("\n\nYour ");
			if(pc.hasCock()) eventBuffer += ("dick is begining to get hard");
			if(pc.isHerm()) eventBuffer += (" while your ");
			if(pc.hasVagina()) eventBuffer += ("cunt is getting moist with need");
			if (!pc.hasGenitals()) eventBuffer += ("libido seems to be going haywire");
			eventBuffer += (".  Shouldra's unfulfilled sexual needs are starting to blend into your own.  Nothing you do will satisfy your urging until she's seen to her own.\n\n<b>Minimum lust raised by 20.</b>");
		}
		else if (rand(2) == 0) {
	...
	if (flags["COC.SHOULDRA_SLEEP_TIMER"] == -216) {
		shouldraSprite();
...
public function nightTimeShouldraRapesThePC():void {
	...
	flags["COC.SHOULDRA_SLEEP_TIMER"] = 0;
	shouldraSprite();
	pc.orgasm();
	pc.slowStatGain("l", 1);
	...
	//event occurance = 0
	if (flags["COC.SHOULDRA_TIMES_NIGHT_RAPED_PC"] == 0) {
	...
	output("\n\nYou noticed that the pace of your breathing has picked up; the horny ghost is really getting into this madness.  The foreplay - or is it five-play in this case? - isn't going to end so soon, however.  After a few more loving strokes from one hand to the other, Shouldra begins teasing your naked body with the squadron of cocks.  She runs their dribbling tips up along your [pc.hips].  She glides their velvet shafts down your [pc.legs].  She pinches your [pc.nipple] with their bulbous heads");
	if (pc.biggestTitSize() >= 1) output(", circling their entire lengths around your [pc.fullChest]");
	output(".  It's quite amazing how ecstatic the tour feels, each pre-smeared exploration smothering you in sensual vibes.  Just moving the stiff little devils - particularly at your joints - sends shivers up your arm.");
	...
	output(" back to a much less craggy complexion.  Shouldra slowly drags you back to your [pc.feet] after a minute or two of blissful respite and walks you closer to the cliffside to stare off into the moonlit horizon.  It never really dawned on you just how fucking high you are; just where the fuck did she take you?");
...
private function edwardShouldraDickHandsPartII():void {
	...
	IncrementFlag("COC.SHOULDRA_TIMES_NIGHT_RAPED_PC");
	addNextButton();
}
...
public function shouldraWakesUpOrPokesPCsForShitsAndGigglesIdunnoHowLongCanIMakeThisFunctionNameQuestionMark():void {
	...
	//1 PC with cock - 1
	if (pc.hasCock() && pc.biggestCockVolume() < cockVolume(200)) {
		choices[choices.length] = 1;
		choices[choices.length] = 1;
		choices[choices.length] = 1;
		choices[choices.length] = 1;
	}
	//2 PC with BIG COCK - if (this.pc.biggestCockArea() >= 200)
	else if (pc.hasCock()) {
	...
	if (pc.statusEffectv1("Exgartuan") == 1 && 9999 == 9999) {
	...
	choices[choices.length] = 7;
	//8 (Tel'Adre unlocked)
	if (flags["COC.TEL_ADRE_KNOWN"] >= 1) choices[choices.length] = 8;
	//9 (is preggers)
	if (pc.isPregnant(0)) choices[choices.length] = 9;
	//10 (is preggers2)
	if (pc.isPregnant(0)) choices[choices.length] = 10;
	//11 (is butt pregnant)
	if (pc.isPregnant(3)) choices[choices.length] = 11;
	//12 (can fly)
	if (pc.canFly()) choices[choices.length] = 12;
	//13 (is Naga)
	if (pc.isNaga()) choices[choices.length] = 13;
	//14 (Amily is a follower)
	if (amilyFollower()) choices[choices.length] = 14;
	//15 (Pure Jojo is a follower)
	if (flags["COC.JOJO_IN_CAMP"] == 1) choices[choices.length] = 15;
	//16 (has any of Marae's gift perks)
	if (pc.hasPerk("Marae's Gift: Stud") || pc.hasPerk("Marae's Gift: Fertility") || pc.hasPerk("Marae's Gift: Profractory") || pc.hasPerk("Marae's Gift: Buttslut")) choices[choices.length] = 16;
	//17 (has had children with Izma)
	if (int(flags["COC.IZMA_CHILDREN_SHARKGIRLS"]) + int(flags["COC.IZMA_CHILDREN_TIGERSHARKS"]) > 0) choices[choices.length] = 17;
	//18 (has Incorporeality perk)
	if (pc.hasPerk("Incorporeality")) choices[choices.length] = 18;
	//19 (possessed by Boobgartuan)
	if (pc.statusEffectv1("Exgartuan") == 2) choices[choices.length] = 19;
	//20 (PC knows any spells)
	if (hasSpells()) choices[choices.length] = 20;
	//21 (PC has anemone dick)
	if (pc.cockTotal(GLOBAL.TYPE_ANEMONE) + pc.cockTotal(GLOBAL.TYPE_SIREN) > 0) choices[choices.length] = 21;
	//22 (Computer date is within a week before or after Halloween/or on Halloween whichever's easier)
	if (checkDate(29, 10, 3)) choices[choices.length] = 22;
	...
	switch(select) {
		...
		case 1:
			subSelect = rand(5);
			if (subSelect == 0) eventBuffer += ("Your [pc.cock] tingles, and your [pc.gear] suddenly feels much tighter.  A little giggle from Shouldra reveals her intention.  Though adamant about making you as big and virile as possible, Shouldra does realize it <b>is</b> your body, and your meat shrinks at least three inches to its former glory.");
			else if (subSelect == 1) eventBuffer += ("An uncomfortable stirring in your nether regions has you stop to undo your [pc.gear] and figure out what's the matter.  Your [pc.cock] is wagging enthusiastically.  Shouldra's face quickly sprouts from your shoulder, \"<i>Oh look, he's happy to see you!</i>\" You pay her an irritated glance which she returns with a content snicker.  With your cock under control, you redo your [pc.gear] and continue on your way.");
			else if (subSelect == 2) eventBuffer += ("You're distracted as you notice your [pc.cock] snaking its way down your [pc.leg], quickly growing larger.  You make your displeasure obvious, causing it to recoil back to its original size.  Seems as though your ghostly friend is getting restless.");
			else if (subSelect == 3) eventBuffer += ("You come to a halt as you suddenly lose control of your arms, forcing you to watch your hands dart down your [pc.gear] to fiercely grab at your [pc.cock].  Though you let out a growl for her to stop, it takes Shouldra a minute to return your arms to you.  She must be getting restless.");
			else if (subSelect == 4 && pc.cockTotal(GLOBAL.TYPE_EQUINE) == 0) eventBuffer += ("There's a sudden twisting pain in your [pc.cock], forcing you to undo your [pc.gear] and see what's wrong.  To your dismay, a large equine dong is staring back at you, leaking profusely.  \"<i>Just testing out some new transformations, Champ,</i>\" Shouldra snickers.  You yell out again as your dick quickly turns back to normal.");
			else eventBuffer += ("One of your hands begins playing with your [pc.cock], no doubt spurred on by your paranormal passenger.  \"<i>You know, Champ, I could make you some easy gems.  Just find some know-nothing and introduce them to The Amazing Penis, capable of astounding feats like responding to any vocal coital commands!</i>\"  Playing the part of a sideshow attraction is quite the tangent to your typical daily activities.  Probably best not to think about it.");
			break;
		case 2:
			//PC with BIG COCK 
			subSelect = rand(5);
			if (subSelect == 0) eventBuffer += ("Your [pc.cockBiggest] begins to feel incredibly warm and dense. You place your hands along your enormous rod, causing it to illicit a low hum.  That \"<i>mmmm</i>\" sounded vaguely like Shouldra.  Best you can figure, the ghost girl is having the time of her life concentrating her being throughout your totem pole.  Shaking your head, you decide it best to carry on, doing your darndest to ignore her.");
			else if (subSelect == 1) eventBuffer += ("A wet feeling within your [pc.gear] warrants checking, forcing you to stop and examine what's wrong.  Upon undoing your outfit, you discover an alarming stream of pre flowing from your... moaning urethra.  You scold the awestruck ghost girl, knocking her out of her trance.  \"<i>S-sorry, Champ!</i>\" your [pc.cockBiggest] apologizes, slurping her \"drool\" back into her... its slit. After a listless stare, you sigh and continue on.");
			else if (subSelect == 2) eventBuffer += ("Out of nowhere, your hands dive into your [pc.gear], furiously rubbing at your [pc.cockBiggest].  You regain control, lurching your mitts back into the open.  \"<i>Come ooooon, Champ! Can't you just take a break? Maybe take care of some stress?</i>\"  You shoo away the nagging voice in your head, anxious to move on.  \"<i>How can you ignore a package this wonderful?</i>\" Shouldra whines.");
			else if (subSelect == 3) eventBuffer += ("Your breath is about knocked out of you as an onslaught of desire rushes through you.  Your [pc.cockBiggest] bursts from your [pc.gear], triumphantly pointing skyward.  \"<i>You can't cage this mighty beast!</i>\" it shouts with a mighty growl.  It takes you a moment to regain your composure, and you ask the hyper ghost to settle down.  There's no way your outfit can cover such a huge erection.  Your massive wang roars once more before slowly deflating.");
			else {
				eventBuffer += ("Lightheadedness is setting in.  You're unsure as to the reason until you notice your [pc.cockBiggest]; it's engorged with blood!  The warm, throbbing, erect fullness is nuzzling peacefully against your [pc.leg] in agony for release.  Shouldra's enjoying your powerful penis so much that she's starting to influence your own libido!");
				pc.slowStatGain("l", 1)
				pc.lust(10);
			}
			break;
		...
		case 3:
			subSelect = rand(5);
			if (subSelect == 0) eventBuffer += ("Your [pc.balls] are getting warm.  They're getting... really hot.  \"<i>Don't mind me, Champ. Just... checking something out.</i>\"  You decide the best course of action would probably be not to pry any further into whatever machination the ghost girl is working on.");
			else if (subSelect == 1) eventBuffer += ("A tightness in your [pc.gear] reveals to you your swelling [pc.balls].  Shouldra continues to try and convince you of the importance of a virile package, but you remind her as to who's in control of this ship.  Regretfully conceding, the ghost girl returns your sac to its original proportions.");
			else if (subSelect == 2) {
				eventBuffer += ("You suddenly fall ");
				if (pc.isBiped()) eventBuffer += ("to your knees");
				else eventBuffer += ("to the ground");
				eventBuffer += (" as your [pc.balls] begin to thrash and vibrate wildly!  \"<i>Interesting. That was way more effective than I would have guessed.  I'll have to make a note of that,</i>\" your paranormal passenger says, ending the spell.  With a mild case of confusion, you're left to your thoughts as you go about your business.");
			}
			else if (subSelect == 3 && pc.hasCock()) eventBuffer += ("You feel your [pc.balls] quickly swell then tighten out of nowhere, forcing some of their payload out your [pc.cock].  Suddenly your hand darts down your [pc.gear] and delivers the errant cum directly to your mouth!  \"<i>Had some time on my hands, so I decided to try out some new recipes.  What do you think?</i>\" Shouldra asks.  Tastes... citrus-y?  That your loins are being used as an experimental factory is... disconcerting.");
			else eventBuffer += ("\"<i>Champ... you weren't thinking of impregnating anyone too soon, were you?</i>\"  You ask Shouldra what's wrong, afraid of the answer you'll hear.  The odd sensations you've felt in your [pc.balls] are probably related.  \"<i>Well, let's just say that your sperm may be little wild cards at the moment.  I'll... get that sorted out shortly.</i>\"  On that note, a rough churning starts up down below.  Your baby batter isn't safe with this ghost around, it seems.");
			break;
		//PC with boobs
		case 4:
			subSelect = rand(5);
			if (subSelect == 0) eventBuffer += ("Your [pc.gear] feels... tight.  Way too tight.  Around your chest.  You start to glance down before realizing you needn't bother; your bustline is so expansive (yet so constrictive!) it inches into your peripheral vision.  Sighing softly, you pulse your displeasure to Shouldra.  \"<i>Champ, seriously, you'll never get ahead in life without taking advantage of your assets!</i>\"  You remain firm in your objections, however, and she eventually deflates your boobs to their original size. \"<i>Spoilsport,</i>\" she mutters.");
			else if (subSelect == 1) eventBuffer += ("A stretching sensation on your [pc.chest] directs your attention.  Shouldra is puffing up your nipples. \"<i>If you just had some big, succulent teats, I'm sure that...</i>\"  You interrupt the phantom before she can finish, insisting that she leave well enough alone.  Your [pc.nipples] shrink down to their normal size, but not without a little disapproving huff from your ghostly roommate.");
			else if (subSelect == 2) eventBuffer += ("Your [pc.nipples] have started to lactate profusely... way more than you've ever seen.  Shouldra tries to explain to you how much of a turn-on it could prove to be, but you cite your soaked [pc.gear] as point to the contrary. With a sigh, the spirit returns your [pc.chest] milk eventBuffer +=  back to how it was.");
			else if (subSelect == 3) eventBuffer += ("The life is about spooked out of you when your hands suddenly force open your [pc.gear] and your [pc.fullChest] burst outward, ballooning to thrice their normal size!  \"<i>Next time you flash some fucker, you should totally let me in on it.  Who would be able to resist this?</i>\"  Probably anyone that doesn't burst out in laughter, you figure.  Shouldra forces a shrug out of you and returns your cans to normal.");
			else eventBuffer += ("\"<i>You know, I've noticed how rarely you wear a bra, Champ,</i>\" a particularly mischievous voice whispers into your ear.  Your [pc.fullChest] begin wiggling seductively all on their own.  \"<i>You should pick up a bunch of 'em sometime.  Then I can break them off with a nice surge of breast flesh.  Who could resist such an act?</i>\"  Shouldra is entirely too obsessed with hypnotizing onlookers with your tantalizing tits.");
			break;
		//PC with vagina
		case 5:
			subSelect = rand(5);
			if (subSelect == 0) {
				eventBuffer += ("You're nearly brought ");
				if(pc.isBiped()) eventBuffer += ("to your knees");
				else eventBuffer += ("to the ground");
				eventBuffer += (" by some rustling deep down in your flower box.  Your [pc.clit] is vibrating like crazy, no doubt due to some paranormal activity.  You think you hear her laughter, but you can't place the source.  After a moment, your [pc.vagina] calms down and you go about your business.  ...You have a sneaking suspicion that she knows you enjoyed it.");
			}
			else if (subSelect == 1) eventBuffer += ("Your [pc.vagina] puffs up slightly and begins nipping at your [pc.gear].  \"<i>What's wrong? Are you getting hungry?</i>\" you ask emphatically... involuntarily.  The enthusiastic box yips in response.  \"<i>Don't worry, momma will get you something to eat real soon!</i>\"  You're left frozen in place to enjoy awkward silence as your [pc.vagina] returns to its normal size.");
			else if (subSelect == 2) eventBuffer += ("You almost don't realize your hand creeping its way into your [pc.gear], trying to sneak a quick fingering. Looks like Shouldra is getting antsy.");
			else if (subSelect == 3) eventBuffer += ("What the... ?  Your [pc.vagina] has started gushing fluids everywhere, absolutely soaking your [pc.legs]!  \"<i>Don't mind me, Champ.  I'm just testing to see how far I can push this. Part of something I have in mind for later...</i>\"  No good can come of this...");
			else eventBuffer += ("You can sense Shouldra laughing to herself over something.  Though its usually a poor idea, you decide to ask and see what's on her mind.  \"<i>I was just scheming.  Would you get too upset if I spooked your next fuck?</i>\"  As she asks, you feel your [pc.vagina] clenching hard, giving you a clear idea of what the trickster has in mind.  There's no way that-  On second thought, maybe it could be kind of fun?");
			break;
		...
		case 6:
			subSelect = rand(6);
			if (subSelect == 0) eventBuffer += ("While minding your business, you realize faint whispering is coming from your [pc.cock].  Shouldra and Exgartuan are scheming something, probably something you wouldn't be a fan of.  Every so often your wang lets out a chuckle.  Maybe getting these two together wasn't in your best interest.");
			else if (subSelect == 1) eventBuffer += ("Your [pc.cock] is wiggling around inside your [pc.gear], making you incredibly uncomfortable.  You go to undo your outfit when the demonic dong plows its way out anyway, scaring you half to death.  Shouldra and Exgartuan just laugh, too content with one another to pay you much mind.  You never expected them to get along THIS well.");
			else if (subSelect == 2) eventBuffer += ("\"<i>So what other sorts of things can you concoct?</i>\" Exgartuan asks, shuffling around in your armor.  You're incredibly confused by the sudden question.\n\n\"<i>Honestly, that put me in the mood to make all of mother nature our bitch,</i>\" you respond... Shouldra responds.  The spirit is gabbing through your mouth to your possessed pecker.  The two prattle on like this for some time.");
			else if (subSelect == 3) eventBuffer += ("Your hands slip inside your [pc.gear], exploring your [pc.cock].  Your fingers caress each little nub and nodule they come across.  \"<i>That's the ticket,</i>\" Exgartuan gleefully responds, getting rigid in the tight confines of your outfit.  Looks like your ghostly partner is out to make everyone happy.");
			else if (subSelect == 4) eventBuffer += ("\"<i>Why don't you help out during battles, babe?</i>\" Exgartuan asks rather bluntly.\n\n\"<i>Hey, I've offered to help out with Champ's more seductive poses like you do...</i>\"\n\nIt isn't like you have much choice in the matter as far as Exgartuan is concerned!  The two continue their discussion, belittling your apparently meager combat performance.  Maybe your possessors could actually help deal some real damage for a change!");
			else eventBuffer += ("Your [pc.gear] has vanished!  You're butt naked!  It's pretty obvious who's at fau-\n\n\"<i>Really, [pc.name], you don't even need it,</i>\" Exgartuan says, surprising you.\n\nShouldra laughs, \"<i>Right, Champ?  Two sexually-charged tyrants dwelling within you and you insist on sneaking around like common rabble?  Why not let it all hang out?</i>\"\n\nYour hands caress your [pc.cock], exciting the demonic member into attention.  You remind the couple that your outfit isn't <b>just</b> for protection, citing many other-  Oh, your [pc.gear] is back.  Guess they don't want to hear you prattle.");
			break;
		//General flavor text
		case 7:
			subSelect = rand(6);
			if (subSelect == 0) eventBuffer += ("\"<i>Yoooo, Champ, are we gonna fuck something, or am I just gonna stagnate here?</i>\" Shouldra moans, managing to steal control of an arm long enough to give your [pc.butt] a honk.  You sigh.");
			else if (subSelect == 1) eventBuffer += ("Out of nowhere, a colossal yawn bursts forth from your craw.  \"<i>Come on, Champ. I'm dying to try out some new stuff I've cooked up.</i>\" What is this sense of dread consuming your being?");
			else if (subSelect == 2) eventBuffer += ("It's been pretty quiet recently.  No doubt Shouldra is up to something -- she always is.  Honestly, you've forgotten what it's like to not having your body passing for a bloated something or other.");
			else if (subSelect == 3) eventBuffer += ("As you are going about your business, you swear you make out muttering emanating from somewhere on your person. It sounds like the ghost girl is reciting some magic, but you don't feel any different. This only worries you even more.");
			else if (subSelect == 4) eventBuffer += ("\"<i>Do foot fetishes still apply if it's your own foot?</i>\" Shouldra asks.  For a moment you wonder how such a feat would even be possible.  But only for a brief, forgetful moment...");
			else if (subSelect == 5) eventBuffer += ("A familiar voice works its way from the back of your mind, \"<i>Hey, Champ.  You think there's any way to make armpits sexy?  What about knees or noses?</i>\"  This line of questioning could lead to some very troubling consequences...");
			else eventBuffer += ("\"<i>I like what you did with those racks,</i>\" Shouldra says unexpectedly, her voice losing its mischievous edge for a moment.  \"<i>I'm glad you kept them.</i>\"  You both sit in silence for several moments as you consider her mood shift to tenderness, but the moment passes.  Shouldra chuckles softly.  \"<i>Just thought I'd mention.</i>\"");
			break;
		//Special Flavor Texts (misc. prereqs)
		//(Tel'Adre unlocked)
		case 8:
			eventBuffer += ("Somehow, someway, you can feel Shouldra sifting through your memories.  \"<i>I'd love to visit the bakery in that desert town.  It's been at least a century since I tasted a decent sweet of some sort.</i>\"");
			break;
		//Preggo
		case 9:
			eventBuffer += ("Your hands circle your bulging belly unbidden.  Shouldra seems to be enjoying your pregnancy.  \"<i>A good deal of the goblins I got a hold of were pregnant, but they don't really treat the event with anything other than their usual 'decorum.'</i>\"  The ghost girl lets out a deep sigh.  \"<i>There isn't anything wrong with enjoying it while you can, is there?</i>\"  Do the dead normally have this much interest in the birth of the living?");
			break;
		//(is preggers2)
		case 10:
			eventBuffer += ("\"<i>Looks like the thing you're pregnant with is doing all right there, Champ,</i>\" Shouldra comments, your belly wiggling around a bit.  You ask that the ghost not go messing around with pregnancy, fearful of the consequences.  \"<i>Oh, please.  I wouldn't do anything crazy like that...</i>\" You can't see her, but you can picture the expression the ghost made as she trailed off.  And it worries you.");
			break;
		//(is butt pregnant)
		case 11:
			eventBuffer += ("\"<i>I must admit, Champ, haven't run into too many instances of rear-ended pregnancies!</i>\"  Shouldra laughs, smacking your hand on your [pc.butt].  \"<i>Just make sure that doesn't have to contend with all the other things that go in and out of your ass!</i>\"  You try not to dignify the crass remark with any sort of response.");
			break;
		//(can fly)
		case 12:
			eventBuffer += ("You're taken by surprise when your [pc.wings] act all on their own, lifting you off the ground with strong flaps.  \"<i>I'm trying to think of ways to use your own flight in some kinky shit, Champ,</i>\" Shouldra comments, \"<i>Nothing's coming to mind that's any better than me just floating your carcass instead.</i>\"  Well, we aren't all \"blessed\" enough to be deceased spirits!");
			break;
		//(is Naga)
		case 13:
			eventBuffer += ("Your [pc.tails] wiggles around on its own suddenly.  Catching on to how it appears to be sneaking to play around with something on your body, you calmly ask its spiritual captor to knock it off.  An otherworldly snicker emanates from it before it goes limp.");
			break;
		//(Amily is a follower)
		case 14:
			eventBuffer += ("Your fingers move around a little, signaling Shouldra's stirring.  \"<i>It would seem that that mouse follows me everywhere I go,</i>\" she complains.  You figure she's talking about Amily.  You ask what her beef is.  \"<i>Too much baggage.  Don't want to deal with it.  I scared her a few times back at the town, but it wasn't all that satisfying.</i>\"  Looks as though Shouldra wasn't always the warmest of neighbors.");
			break;
		//(Pure Jojo is a follower)
		case 15:
			eventBuffer += ("The silence bothers you a bit, so you decide to see if Shouldra is awake and ask her what she thinks about Jojo.  \"<i>You're talking about that holy mouse morph back at camp, right?  Not a fan,</i>\" she replies, shrugging your shoulders.  \"<i>Other than just not really being into people that remind me of rodents, I don't think he'd get along well with 'a spirit that has yet to abandon these mortal bonds.'</i>\"  she mocks.");
			break;
		//(has any of Marae's gift perks)
		case 16:
			eventBuffer += ("\"<i>Man, Marae really did a number on you, Champ,</i>\" Shouldra comments, referring to your corrupted blessings.  \"<i>I'll have to hand it to you; you really get around.  Much more than I would have been willing to give you credit for.  Not everyone gets to fuck around with a goddess.</i>\"  You aren't sure if this is a compliment.");
			break;
		//(has had children with Izma)
		case 17:
			eventBuffer += ("\"<i>");
			if (int(flags["COC.IZMA_CHILDREN_SHARKGIRLS"]) + int(flags["COC.IZMA_CHILDREN_TIGERSHARKS"]) == 1) eventBuffer += ("That shark daughter of yours is");
			else eventBuffer += ("Those shark daughters of yours are");
			eventBuffer += (" pretty cute you know,</i>\"  Shouldra blurts seemingly from nowhere.  Looks as though she's helping herself to your head.  \"<i>I'd love to get to meet them sometime, Champ.  Put some otherworldly fright in 'em so they grow up right!</i>\"  You doubt Izma would be too onboard with this visit.");
			break;
		//(has Incorporeality perk)
		case 18:
			eventBuffer += ("\"<i>Looks like you really enjoyed that ectoplasm I gave ya, Champ,</i>\" Shouldra laughs, obviously in reference to the ghostly pallor of your skin.  \"<i>I never actually looked too much into what that stuff does.  I just don't have much else to hand out to people.  Anyway, if you want some ghostin' lessons, just let me know!</i>\"  You begin to wonder how a possession works when the possessed is possessed by a possessor that is already possessed by another possessor.\n\nBest to stop wondering.");
			break;
		//---(possessed by Boobgartuan)
		case 19:
			eventBuffer += ("Your [pc.fullChest] fidget ominously, a muffled female voice piping up, \"<i>No cloth, metal, latex, or gel can protect you from me, champion. Give in and caress these cans!</i>\"\n\n\"<i>Okay!</i>\" you say against your will.  Shouldra directs your hands to your titanic tits and massages them with gusto.  Looks like she's actually getting along with your demonically possessed rack.");
			break;
		//(PC knows any spells)
		case 20:
			eventBuffer += ("\"<i>I see you've been dabbling in a little magic of your own, Champ,</i>\" Shouldra chimes in from out of nowhere.  \"<i>You know if you ask nicely, maybe I'll take you on as my apprentice.</i>\"  If you ever decide to put your intelligence to work making cocks ten feet tall, you'll have to take her up on that offer.\n\n\"<i>I can do things besides sex, you know, ass.</i>\"\n\nMind reading would be nice to have, too.");
			break;
		//(PC has anemone dick)
		case 21:
			eventBuffer += ("Your armor undoes itself suddenly, revealing your perky anemone dick to the outside air.  You work to cover it back up when Shouldra's voice picks up inside your head, \"<i>Man, I don't think I've seen too many of these little guys.  Fascinating buggers.  Just don't let them lodged up your cootch, though.  Pain in the ass to deal with then.</i>\"  You didn't realize the quirky ghost was a biologist, too.");
			break;
		//(Computer date is within a week before or after Halloween/or on Halloween whichever's easier)
		case 22:
			eventBuffer += ("Shouldra takes control of your body, the sudden shift scaring you slightly.  She doesn't do anything crazy, though; the ghost girl just stops and stretches, apparently just enjoying being a ghost!  \"<i>I love this time of year, Champ.  Don't ask me why, but I just feel more <b>alive</b>.</i>\"  Ghosts feeling alive?  This is too spooky for you.");
			break;
		default:
	}
}
...
private function shouldraAndWormsYoureGonnaHaveABadTime():void {
	clearOutput();
	shouldraSprite();
	output("Your eyes glow yellow, signaling Shouldra's desire to stretch around a little.  You grant her mastery over your hands as you continue about your business.  The eager phantom decides to push things a little, however, systematically removing your [pc.gear].  A break isn't that big a deal you figure, and you relinquish full control to the giddy ghost.  She directs you out of plain view");
	if (pc.cocks[0].cLength() < 48) output(" and cuts right to the chase, ballooning your [pc.cock] into a rigid, wide, four-foot tall slab of meat");
	output(".  Unable to contain her delight, she hastily hugs your enormous dick firmly against your body and squeezes vigorously, rubbing your face against your [pc.cockHead].  A warm stream of pre oozes out and onto your possessed face.");
	output("\n\nA strange sensation in the pleasant liquid slowly lures the phantom from her shaft-obsessed trance, your eyes slowly opening to discover what's at fault.  One of your worms managed to fall free of your loins and right onto the tip of your nose... much to Shouldra's chagrin.  The spirit slowly identifies the parasite, your body shuddering as she smacks it clear off your [pc.face].  She peers up at your large cockslit to find two more of the suckers lounging about in their makeshift hot tub, enjoying the brisk ");
	if (hours <= 12) output("morning ");
	else if (hours <= 17) output("afternoon ");
	else output("evening ");
	output("air.  Your hands clue the eidolon in to further activity, introducing her to your urethra all the way down to your [pc.balls], every square wriggling inch chock-full of the little buggers, exploring their extended living quarters.");
	output("\n\nWhat follows is an unearthly scream that may have killed any small nearby woodland creatures with its intensity.  It certainly does a number on your hearing, anyway.  Shouldra jumps to your [pc.feet], wagging your monstrous meat every which way as your hands furiously pat away at your head.  A few worms slide free from your flailing penis, but not many.  Your body tenses up, trembling profusely as your pelvis is pushed as far ahead of you as possible.  The typically confident spectre now has you frozen in place, your entire body poised and jittering in fear as you're forced to watch for any more unwelcomed guests.");
	if (flags["COC.SHOULDRA_WORM_SCENE_COUNTER"] > 0) output("\n\n\"<i>H-h-how did I forget about these damn things!</i>\"  the spooked spirit utters through your mouth.  A worm pokes its head up out of your fat cock head, causing Shouldra to scream and violently pivot your hips again, desperately trying to shake more of the vermin loose.  \"<i>I... I can feel all of them... crawling around in-  How do you live like this!</i>\"  Again, you try and calm the panicked spirit, attempting to convince her to at least try and accept your infestation.  More wormy escape attempts cause your pelvis to thrash about; Shouldra not only refuses to touch your blighted phallus, but is actively working to avoid its every swing.  \"<i>NOPE.  NEVER.  These fuckers have GOT to GO!  There's no way in HELL I'm riding shotgun with-</i>\" The ghost has you shout yet again, quickly jumping away from a thick strand of your jism flying back towards you.  Looks like the decision lies with you.");
	else {
...
private function kickOutShouldra4YoWormyBuddies():void {
	...
	if (pc.cocks[0].cLength() < 48) output("  With that little ordeal dealt with, you now are left to decide how best to manage the time until your cock returns to its normal size.");
	output("  Oddly enough, you hope the little buggers appreciate you sticking up for them.");
...
public function shouldraAndExgartumonFightGottaCatchEmAll():void {
	...
	//Unlocks Argue 2
	shouldraSprite();
	output("your bedroll looks mighty comfortable after a hard day's ");
	if (pc.cor() < 50) output("work");
	else output("fucking");
	output(".  Just when you're [pc.gear] and about to tuck in for the night, however, your [pc.cock] goes fully erect!  The throbbing demonic mass is flailing about, knocking into your shit and making a mess.  You clutch onto the bucking bronco in an attempt to prevent any further damage when Exgartuan begins to shout, \"<i>Don't FUCKING touch me, you goddamn cunt!</i>\"");
	...
	output("\n\n");
	if(pc.isBiped()) output("You instead tuck your [pc.cock] down between your [pc.legs] and lay on your stomach, distancing yourself from their bickering.  Neither party pays you much mind as they continue arguing, your third leg still fidgeting despite the awkward placement while Shouldra has moved residency to your back.  You cover your head with a pillow and soon thereafter head off to slumber.");
	else output("The best you can hope to manage is to lay on your side and use your covers as a makeshift fortification between you and your arguing [pc.cock].  Shouldra and Exgartuan pay you no mind despite the odd construction, leaving you to bury your head in your pillows and, eventually, head off to sleep.");
	flags["COC.SHOULDRA_EXGARTUDRAMA"] = 1;
	addNextButton();
}
...
public function exgartumonAndShouldraFightPartII():void {
	...
	output("\nA sudden immense buildup in your [pc.cock] takes you by surprise, easily bursting out of your [pc.gear]!  Your urethra is horribly distended, your entire demonic length rumbling in preparation for something tremendous!  The unexpected pressure forces you to your knees.  Your head closer to your evil dong, you realize that you can make out muffled shouting inside.  This is hardly anything you-");
	...
	flags["COC.SHOULDRA_EXGARTUDRAMA"] = 2;
	addNextButton();
}
...
public function exgartumonAndShouldraFightPartIII():void {
	...
	output("\n\"<i>Hey, Champ, check this out,</i>\" Shouldra has you blurt clear out of the blue.  The poltergeist assumes control over your body, quickly shedding your [pc.gear] and transitioning into some manner of casting.  She's typically been pretty good about not just doing whatever the fuck she feels like with you without at least asking first.");
	output("\n\nYou instinctively try and clench your fists when tight, stinging sensations start coursing through your midsection.  Exgartuan's attention is perked as well, \"<i>What is that fu-AAAAARRRARA!!</i>\"  Your [pc.cock] is thrashing and twitching as the ghost's magic sinks in.  Your various nodules and magenta coloring fade into your member, slowly aiding in the transformation of your <b>enormous new horse cock!</b>");
	...
	flags["COC.SHOULDRA_EXGARTUDRAMA"] = 3;
	addNextButton();
}
...
public function exgartuMonAndShouldraShowdown():void {
	...
	//Time is 5:00
	shouldraSprite();
	output("\nAn unusually early awakening for you is brought upon by your massive morning wood.  You appreciate the warm greeting by your [pc.cock], but the sun is barely even out yet and-");
	output("\n\nOh... no... wait.  This is no humble daybreak greeting between a happy cock and its [pc.master]; Shouldra and Exgartuan are fucking arguing again, causing your member to twitch and thrash as their discordant voices pour out from within it.");
	...
	output("\n\nYour [pc.cock] thrusts to one side, forcing Shouldra right out of your contested cock, taking your sheets along with her as she pushes into the side of your tent.  This bickering is getting stupid now.  These two could probably go on like this forever.  Neither of them seem to have given you even the slightest bit of attention on the matter.  You know, the " + pc.mf("guy","gal") + " ATTACHED to the world's most popular shaft?");
	output("\n\nShouldra untangles herself out of your sheets, tossing them back to the ground in a huff.  You groggily raise to your [pc.feet], spurred on by your raging demonic erection and its vendetta against your cock-hungry, post-mortem playmate.");
	...
	if (silly) output("  It's a man's right to choose what's done with his body.  Not anyone else's!");
	output("  You shout loud enough to get the two to at least shut up and notice you're there.  It's time to end this little battle once and for all, starting with your first - and hopefully last - involvement.");
...
private function keepExgartuanInsteadOfShouldra():void {
	clearOutput();
	shouldraSprite();
	output("In no uncertain terms, you announce to your former paranormal partner that you're siding with the demon on this one.  ");
	if(pc.cor() > 75) output("\"He's just a better teammate to have when it comes to hot dickings.  \"");
	output("You place your hand around your [pc.cock] as Exgartuan as he rubs up against you, approving of your decision.  Shouldra looks on in just complete disgust and confusion.");
...
private function keepShouldraAndKickOutExgartuan():void {
	...
	output("\n\nShouldra's pushing Exgartuan's buttons something fierce.  Unluckily for you, the supposed demon curse is still fully ensconced on your mid-section.  Your [pc.cock] feels like its sucking the life out of you in its rage, engorging itself with blood and pushing you to the most powerful erection you've ever laid eyes on... or had the misfortune to have.  It's actually really taxing on you as the demon wang puffs up in protest, throbbing with each heartbeat of yours.  Not only can you visibly make out veins, but you're afraid the various bumps on your member might be going haywire, too.");
	...
	output("\n\n\"<i>You know, nothing in that pile effected your actual load,</i>\" Shouldra smiles, reaching over from her perch to rub your [pc.balls].  \"<i>How's about we greet the morning sunrise with my brand new cock.  I never liked that grody demonic dong you had earlier.  I mean, just look at this thing.  I made the head nice and...</i>\"");
	...
	//PC has human dick
	pc.shiftCock(pc.biggestCockIndex(), Mutator.guessCockType(pc));
	//Exgartuan departs
	pc.removeStatusEffect("Exgartuan");
	//unlocks one more scene for later that night
	flags["COC.SHOULDRA_EXGARTUDRAMA"] = -0.5;
	addNextButton();
}
...
public function keepShouldraPartIIExgartumonsUndeatH():void {
	...
	output("While slipping into your bedroll to enjoy a peaceful night's sleep, a chill runs down your spine.  You look around to-");
	...
	flags["COC.SHOULDRA_EXGARTUDRAMA"] = 0;
	//[next page]
	addNextButton(keepShouldraPartIIIExgartumonsUndeatH);
}
...
private function keepShouldraPartIIIExgartumonsUndeatH():void {
	...
	output("\n\n\"<i>The look on your face,</i>\" the fabric phantom laughs.  You sigh and at least manage to poke your head out from under your haunted sheets.  Shouldra's head quickly follows you, forming on the outside to greet you.  The frisky ghost tucks you in nice and tight before she begins massaging your [pc.cock] from every angle with her cot haunt arrangement.");
...
private function keepAllTheGhosts():void {
	...
	output("\n\nExgartuan seems to be content with the accomplishment, though; your [pc.cock] is at full mast.  Your wang drags you forward, anxious to drill into the earth to mine for treasure.  But with a glint in Shouldra's eye, the elemental quickly weaves around the penetration attempt, grabs your massive cock with one hand and easily lifts it and you off the ground.");
	...
	output("\n\nYour vision is obscured by creature's tits, your head sinking into the tightly-packed dirt globes.  You only go in further as the fervent couple in your manhood thrust in and out of their makeshift cunt.  The unrelenting pace, free of any preparatory foreplay, is murder on your pelvis");
	if(pc.balls > 0) output("\"; the mighty swings of your [pc.sack] between you and your partner aren't helping matters much either\"");
	output(".  But you're forced to soldier on, unable to either resist the mighty force of your haunted demonic dong or the mammoth grip of the earth elemental.");
	output("\n\nYour head completely swallowed by earthen mounds, you fail to notice the earth elemental slowly falling apart under the sheer force of your fucking.  Though anything important to your rod's endeavour remains flexible, firm, and unyielding, the elemental's exaggerated hourglass form takes its toll on her lower legs.  They soon break apart to return to the ground, sending the giantess to her knees and taking you down along with her.  This of course bears no consequence on your [pc.cock], its mission remains unwavering.");
	...
	output("\n\nAnd enjoy it you do, soft moans easing you through the intense vibrations as your cock explores inner caverns of its own design.  The ramming turns violent with hard, forced thrusts spurred on by your nether regions.  The two minds throw your pelvis one direction and the next, digging your [pc.cock] further and further.  Your entire body plows repeatedly into the elemental, smothering you in mud and dirt with each smack.  ");
	if(pc.balls > 0) output("Ready to unleash their churning payload, your [pc.balls] tighten up something fierce, rumbling in anticipation.  ");
	if(pc.cumQ() < 20) output("The modest load hardly makes a dent in the golem's cavity.");
	else if(pc.cumQ() < 100) output("The above-average load floods the golem's cavity, gushing back around your cock");
	else if (pc.cumQ() < 250) output("The intense load streams even farther within the dirt innards of the earth elemental, expanding her slightly.");
	else if(pc.cumQ() < 1000) output("The extreme load fills the titan vigorously, your pearly seed threatening her composition as it permeates her body.");
	else output("There are no words to properly explain the magnificence of your ejaculation.  Only through Shouldra's magic does the beast maintain the furious blasts from your loins, soiling even every insignificant pocket of air with your seed.");
	
	output("\n\nYour eyes go wide with your release, but your [pc.cock] only works harder, working in tandem with your climax to ravage the poor incantation.  It's starting to hurt with how hard you're being slammed into the creature, but it's nothing compared to the torment the earth elemental is going for.  Maybe it's for the best that the thing only has the simplest of sentience.  You reassure yourself of your assumption when the jugs engrossing the upper half of your body lose their form, tumbling to the ground and allowing for a clear view of the elemental's downfall.  Her glowing eyes are starting to fade out of existence");
	if (pc.cumQ() >= 1000) output(", trails of your [pc.cum] pouring out from them");
	output(".");
	
	output("\n\nThe powerful grip surrounding you quavers and falls as she loses her arms.  And with one last, mighty thrust, your [pc.cock] finally pierces through to the other side of the elemental, snuffing its life and sending a wall of earth crashing down on top of you.  A pile of dirt with an enormous dick sticking out of it would certainly be a sight for some random passerby to come across.  A few minutes worth of digging frees you from the cum-soaked digsite.  That was certainly an experience you have mixed feelings about.");
	
	output("\n\nExgartuan and Shouldra seem content with one another now, though.  The powerful climax managed to knock both of them out.  Seems that fucking an elemental literally back to the earth it was spawned from really did it for them.  Their friendship will hopefully bring you some much wanted peace, but you worry about what strange things will come of their alliance.  It feels as though your [pc.cock] can only endure so much, but those limits will surely be stretched.");
	...
	pc.addStatusValue("Exgartuan", 2, (12 + rand(7)));
	//unlocks follower dialog
	flags["COC.SHOULDRA_EXGARTUDRAMA"] = 4;
	addNextButton();
}

//Intro
public function shouldraBakeryIntro():void {
	Flag("COC.SHOULDRA_BAKERY_TIMES"); // init?
	
	clearOutput();
	shouldraSprite();
	output("You set off towards the bakery, and it's not long before the smell of freshly-baked pastries and sugary candies wafts through the air.  Something stirs in your mind as a familiar ghostly presence makes herself known; seems you're not the only one who noticed the scent of cinnamon.");
	...
	//first time: 
	if (flags["COC.SHOULDRA_BAKERY_TIMES"] == 0) output("You smirk, wondering how exactly a ghost manages to work up a hunger.  Your skepticism is met by an intense stabbing pain in your stomach, forcing you to buckle slightly from the cramping.  It lasts only a moment before it vanishes, however.  \"<i>You feel that, smartass?</i>\" The ghost girl sneers, \"<i>That's what decades of fasting will do to you.");
	else output("You point out that she's already had something at the bakery.  \"<i>Yeah, I did.  And now I'm hungry again.  Deal with it.");
	output("  Now, how about a snack?  Or two?</i>\" Her enthusiasm is clear...  and slightly worrying.");
	clearMenu();
...
private function bailOut():void {
	clearOutput();
	//shouldraSprite();
	output("You quickly turn around and head back the way you came.  There's a moan of disappointment from Shouldra, before she settles down and goes back to doing whatever she usually does.  You try not to think about it.");
...
private function feedShouldraACake():void {
	clearOutput();
	//shouldraSprite();
	output("You decide that there's no use getting cold feet now; you wanted to go the bakery anyway, no harm in letting Shouldra have some fun while you're there.  ");
	//after first time: 
	if (flags["COC.SHOULDRA_BAKERY_TIMES"] > 0) output("Well, nothing <i>permanent</i>, anyway.  ");
	output("You press on, soon arriving at the ramp leading down into the bakery's interior.  It's as busy as ever, with patrons milling about, chatting between bites of pastry.");
...
private function shouldraAndMaddieSittingInATree():void {
	...
	if (pc.tone >= 60) output("well-toned");
	else if (pc.thickness < 50) output("trim");
...
private function goAlongWIthShouldrasEatingSpree():void {
	...
	//if repeat scene: 
	if (flags["COC.SHOULDRA_BAKERY_TIMES"] > 0) output("\"Man, you're not sure you want that kind of impact on your figure again...  \"");
	output("Ah, what the hell.  You were hungry anyway.  You let Shouldra guide the cake into your mouth.  Mmm, not bad; rich, sweet and delicate.  Shouldra chuckles in your mind as she releases her control slightly, letting you lick your fingers clean of any stray crumbs.  \"<i>Well, guess you're pretty hungry yourself!  Alright, Champ, I'll give you some freedom, but just remember you're not the only one with an appetite.</i>\" You wince as your hunger intensifies to the verge of pain; looks like you're eating for two.  Your eyes lock on to the feast before you and something snaps in your mind.  You need this food, all of this food, inside you.  <i>Now</i>.");
	output("\n\nYou finish the torte, pausing only to scrape the platter clean and devour the crumbs before starting on some brownies.  As snack upon snack disappears down your maw, your stomach grows warm and full, feeling mildly bloated as the last brownie passes your lips.  \"<i>Ooh, is your poor lil' tummy feeling a bit full?</i>\" Shouldra snickers.");
	if (!pc.isNude()) {
		output("  \"<i>Let's get it out of this cumbersome outfit.</i>\" An incantation echoes in your mind before your [pc.gear] shimmers and vanishes.  Well, that was unexpected");
		if (pc.exhibitionism() >= 66) output(", though not completely unwelcome");
		output(".  You blush furiously and back into the corner of the (now rather cold) booth");
		if (pc.exhibitionism() >= 66) {
			output(" as your heart races and blood rushes down towards your ");
			if (pc.hasCock()) {
				output("drowsy member");
				if (pc.hasVagina()) output(" and ");
			}
			if (pc.hasVagina()) output("trembling nether-lips");
			if (!pc.hasGenitals()) output("groin");
		}
		output(", before you realize that nobody seems to notice your predicament.  Shouldra reads your thoughts and responds,");
	}
	output(" \"<i>Thought you might appreciate some privacy");
	if (pc.exhibitionism() >= 66) output(", even with that kink of yours");
	output(", Champ.  Here's something extra anyway, just in case.</i>\" One ghostly incantation later, and ");
	if (pc.femininity <= 50) output("a buttoned shirt and pair of belted jeans");
	else output("a tight-fitting tank top and skirt");
	output(" adorn your person.");
	
	if (pc.hasCock()) {
		output("\n\nYou run a hand down your chest, examining the new material.  Silky smooth...  As your hand slides across your stomach, you press in slightly.  You've only made a small dent in the food before you, but there's already a noticeable bulge beneath your belt, and a few slivers of " + pc.skinFurScales() + " are visible between the buttons.  You rub the modest mound, resulting in a subdued gurgling and a content burp; you've gotten full pretty quickly.  Maybe you should just leave the rest of the food and- \"<i>Not so fast, bucko!</i>\" Shouldra fumes, causing you to jump in your seat.  \"<i>You might be full, but <b>I've</b> barely started!</i>\" Your gut churns violently as the ghost girl's inhuman appetite infects your own.  Oh dear...");
		output("You quickly grab something, an eclair, from the table in an effort to ease the pain in your stomach.  The taste is incredible; you don't know if it's the hunger or Shouldra's magic, but this is easily the best eclair you've ever eaten.  You moan low in your throat as you savor the eclair, thick sweet cream exploding in your mouth, chilled chocolatey pastry caressing your tongue like a skilled lover.  Sugar and pastry mix and twirl around your mouth, and you can't help but close your eyes and relax, mind and body comforted by a glucose euphoria.");
		if (silly) output("  This is a <i>fucking good eclair</i>.");
		...
		if (pc.cocks[0].cLength() < 8 || pc.cocks[0].cLength() > 25) output("\"<i>First though, let's change it to something more manageable.</i>\" Arcane sounds float up towards you, causing your shaft to shift and morph until your throbbing rod is around 2 feet long and dripping pre.  \"<i>Mmm, much better!</i>\"  ");
		output("Her eyes close as those sumptuous icing-white lips wrap around the [pc.cockHead] of your aching dick, the cherry tongue canvassing your cockflesh like an artist, until she slowly, oh-so-slowly gulps down inch after gradual inch of your girth.  Her enormous chocolate rump is visible on the other side of the booth, lulling back and forth in contented bliss.");
		...
		if (pc.cumQ() < 200) output("Modest spurts of semen shoot out into Shouldra's awaiting mouth.  She withdraws, swirls it around her tongue, then swallows your load in one gulp.  \"<i>Hmm...  needs cinnamon,</i>\" she jokes, licking her lips.");
		//if (cumMedium = true)
		else if (pc.cumQ() <= 400) output("Several thick spurts of semen shoot out into Shouldra's awaiting mouth.  She withdraws, swilling the sizeable load around her mouth before swallowing it in a few gulps.  \"<i>Not bad...  could use a dash of ginger though,</i>\" she jokes, licking her lips.");
		//if (cumHigh = true) 
		else if (pc.cumQ() <= 1000) output("Your groin roils as a thick jet of [pc.cum] floods Shouldra's mouth, followed by another, then another.  The ghost girl barely has time to swallow each load before the next comes, but she manages not to spill a drop of your virility.  \"<i>Mmm, pretty tasty!</i>\"  She says after wiping her mouth in satisfaction.  \"<i>Hints of pineapple, coconut...  delicious.</i>\"");
		//if (cumVeryHigh = true)
		else if (pc.cumQ() <= 5000) output("Your loins tremble and quiver as an immense load of [pc.cum] bulges along your shaft and explodes in Shouldra's mouth.  A further wave of bulges assault the ghost girl's throat, forcing her to swallow all of your [pc.cumVisc] virile spunk.  Eventually the wave subsides, leaving a satisfied and somewhat bloated spook in its wake.  \"<i>Soo gooood...</i>\" she drawls, her goofy grin smattered with white.");
		else output("A cock-distending wad of potent jizm works its way through your throbbing shaft, erupting from your urethra down the hapless ghost's gullet.  As bulge after obscene bulge forces itself inside Shouldra's stomach, her spongy abdomen balloons outwards, soon reaching the size of an adult human.  Streams of excess [pc.cumNoun] flow down her straining cheeks, and by the time you've stopped cumming the ghostly glutton is lying in a large [pc.cumVisc] puddle of your spunk.  She tries to speak, but all that emerge are a sloppy belch and a few flecks of [pc.cum], and she resorts instead to hysterical giggling, lost in a cum-addled haze.");
		output("  After a moment of rest, Shouldra squeezes out from under the table");
		if (pc.cumQ() > 1000) output(", her soft belly sloshing audibly,");
		output(" and helps you to your feet; a task made seriously annoying by your titanic tummy digging in to the edge of the counter.  The other patrons remain blissfully unaware of the whole act, including your current nudity.  Speaking of which...");
		output("\n\n\"<i>Oh, don't worry, Champ,</i>\" Shouldra says, having returned to your head, \"<i>No permanent damage intended. Here ya go!</i>\"  You feel slightly woozy as your abdomen collapses inwards, soon returning to its original, non-bloated state.  A moment later and you are once again clad in your [pc.gear].  \"<i>Well, enough shenanigans for now, right?  Though you do look pretty cute with a pot belly... Heh, just teasing,</i>\" laughs the ghost, \"<i>Now c'mon, let's blow this joint!</i>\"");
	}
	//[(if hasCock = false) 
	else {
		output("\n\nYou run a hand down your chest, examining the new material.  Silky smooth...  As your hand slides across your stomach, you press in slightly.  You've only made a small dent in the food before you, but there's already a noticeable bulge beneath the hem of your skirt, and a few inches of soft " + pc.skinTone + " skin are visible beneath the top.  You rub the modest mound, resulting in a subdued gurgling and a content burp; you've gotten full pretty quickly.  Maybe you should just leave the rest of the food and- \"<i>Not so fast, bucko!</i>\"  Shouldra fumes, causing you to jump in your seat.  \"<i>You might be full, but </i>I've<i> barely started!</i>\"  Your gut churns violently as the ghost girl's inhuman appetite infects your own.  Oh dear...");
		...
		output("\n\nA guttural moan escapes your icing-caked lips as you sink into a creamy smooth orgasm, like sliding into a hot bath.  ");
		if(pc.isSquirter()) output("\"Hot streams of liquid lust spurt across Maddie's face, drizzling her with your copious fem-spunk.  \"");
		if(pc.isLactating()) output("\"Droplets of [pc.milk] form on your [pc.nipples], soon forming rivers of [pc.milkNoun] that cascade down your fiery-hot flesh.  \"");
		output("After a moment of rest, Shouldra squeezes out from under the table, licking your girl-cum from her lips with a satisfied slurp, and helps you to your feet; a task made seriously annoying by your titanic tummy digging in to the edge of the counter.  The other patrons remain blissfully unaware of the whole act, including your current nudity. Speaking of which...");
	...
	pc.orgasm();
	flags["COC.SHOULDRA_BAKERY_TIMES"]++;
	clearMenu();
	addButton(0, "Next", function():*{ processTime(10 + rand(10)); mainGameMenu(); } );
}
