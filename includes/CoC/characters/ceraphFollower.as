...
private function postUdderChoice(newl:Boolean = false):void
{
	...
	if (cum >= 2000 && cor() >= 66) output(" and chuckle at the drizzle of semen that issues from her butt and mouth");
...
private function stuffSomeNippleCunts():void
{
	...
	output("  Her hands run through your [pc.hair] and pull your [face] into her shoulder.  She holds you tightly, clingingly even.  If you weren't so enraptured by the sensation of your sperm-filled nipples, you might actually care.");
...
private function portalFuckWithFollowerCeraph():void
{
	...
	output("\n\nNow that everything is in position, it's time for the moment of truth.  You push the ring down on your [cockHead " + y + "] until the warm metal frame is snugly secured just above your [pc.sheath].  The tingling you could feel when it was in your hand was a mild pinprick compared to the prickling sensations it shoots through your [cock " + y + "].  They aren't unpleasant, but they are certainly intense, and combined with the tightness of the ring, they keep you nice and hard.");
