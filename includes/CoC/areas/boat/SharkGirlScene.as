...
private function sharkgirlDickFuck():void {
	...
	//Non-nagaz
		...
		//[if herm] 
		if(pc.hasVagina()) output("While sucking you off, her hand steadily snakes its way between your legs. Without warning, she shoves three fingers into your " + pc.vaginaDescript(x) + ", pushing in and stretching the moist passage out.\n\n", false);
		...
		//[if herm]
		if(pc.hasVagina()) output("  The sensation is incredible, and you find yourself massaging your " + pc.biggestBreastDescript() + " and tweaking your " + pc.nippleDescript(x) + "s in an attempt to bring your pleasure to even greater heights.", false);
		output("\n\n", false);
