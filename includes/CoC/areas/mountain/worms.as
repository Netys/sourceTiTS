...
//public function nightTimeInfestation():void {
	...
	//output("\n\nWait!  You snap awake from your fantasy to the sensation of hundreds of worms swarming [pc.eachCock].  Your urethra");
	...
	//output(", one after another!  No!  You reach for your [pc.cockBiggest] to somehow try and stop the infestation, but it's a futile gesture.  The worm pile on your [legs] is as big as the rest of you.  Worse still, you doubt you can pull out the ones that have already crawled inside.");
	//
	...
	//}
	//output("  You can feel narrow, tapered heads pushing at where you've pressed your urethra closed, and they try to force their way under again and again while more of their brethren pile in behind.  You stay resolute in your efforts to prevent the coming infection, pinching so hard it's painful and crying out as a result.  The pressure on your [pc.cockBiggest] wars with the way your body is reacting to the other sensations assaulting it.  Your [pc.cockBiggest] spasms powerfully when a big, fat worm perches on your [pc.cockHeadBiggest], slithering all around it, leaving behind a trail of slimy gunk and sending accompanying tingles of delight through your rigid pole.");
	//
