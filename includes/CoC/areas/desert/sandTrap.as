import classes.Characters.CoC.CoCSandTrap;
...
public function encounterASandTarp():void {
	...
	clearMenu();
	//spriteSelect(97);
	if(flags["COC.SANDTRAP_LOSS_REPEATS"] >= 2 && pc.eyeType == GLOBAL.TYPE_BEE && pc.eyeColor == "black" && pc.wingType == GLOBAL.TYPE_DRAGONFLY) {
		sandTrapBadEnd();
		return;
	}
	
	IncrementFlag("COC.TIMES_ENCOUNTERED_SAND_TRAPS");
	if(flags["COC.TIMES_ENCOUNTERED_SAND_TRAPS"] == 1) {
		//femininity <= 65: 
		if(pc.femininity <= 65) {
			output("You are exploring the endlessly undulating landscape of the desert when you hear an agonized cry for help over the nearest dune.  You quickly scramble up it and are confronted by the sight of a small, flat lake of exceptionally fine sand, overlooked on each side by tall dunes.  Trapped in the middle of it is a young woman with black hair, up to her armpits in the sand.  \"<i>Oh, thank the Gods!</i>\" she cries, spotting you.  \"<i>I'm sinking, please help me!</i>\"  The word 'quicksand' flashes through your mind like fire and you take a nervous step back, attempting to quickly evaluate the situation.");
			if(pc.IQ() > 65) output("  <b>Something about this scene puts you on edge.  How come you've never encountered quicksand in this desert before, with no water and its steady, stubborn, but not violent winds?  There's something odd about the woman, too - although she can't be a sand witch with that hair, you can't quite make her features out clearly through the heat haze.</b>");
			output("  You think you could just about reach her with your hand if you were careful.  If you're going to save her, it has to be now; even in the short time you've been here she has sunk down to her collarbone.  She stares at you with plaintive despair.");
		}
		else {
			output("You are exploring the endlessly undulating landscape of the desert when you hear an agonised cry for help over the nearest dune.  You quickly scramble up it and are confronted by the sight of a small, flat lake of exceptionally fine sand, overlooked on each side by tall dunes.  Trapped in the middle of it is a young man with black hair, up to his armpits in the sand.  \"<i>Oh, thank the Gods!</i>\" he cries, spotting you.  \"<i>I'm sinking, please help me!</i>\"  The word 'quicksand' flashes through your mind like fire and you take a nervous step back, attempting to quickly evaluate the situation.  ");
			...
			output("  You think you could just about reach him with your hand if you were careful.  If you're going to save him, it has to be now; even in the short time you've been here he has sunk down to his collarbone.  He stares at you with plaintive despair.");
		}
		...
		if (pc.RQ() / 10 + rand(20) >= 16) {
			...
			output("\n\n\"<i>You've got quick [pc.feet], little ant!</i>\" it giggles.  It lowers its brow and leers up at you with smouldering black eyes, its hands slowly and sensuously trailing patterns in the sand.  \"<i>I bet you're good at lots of other things, too.  Why doesn't the brave little ant come down here and show me?</i>\"  If you're going to fight this creature, you will have to step into its treacherous hollow to get in range, which is surely its intention - if you try attack it from where you are, it will just hide itself.  On the other hand, it would be easy to just ignore its taunts and walk away.");
			//Fight]/[Leave]
...
private function prepareSandtrap():void {
	CombatManager.newGroundCombat();
	CombatManager.setFriendlyCharacters(pc);
	CombatManager.setHostileCharacters(new CoCSandTrap());
	CombatManager.victoryScene(pcBeatsATrap);
	CombatManager.lossScene(sandtrapmentLoss);
	CombatManager.displayLocation("SANDTRAP");
}
...
private function saveTheSandTarps():void {
	...
	//(femininity <= 65): 
	if(pc.femininity <= 65) {
		output("You carefully kneel at the edge of the quicksand and stretch your hand out towards the stricken woman, commanding her to grab hold.   With effort she pulls an arm clear of the treacherous powder and, straining, reaches out to grab the very tips of your fingers... before, with a triumphant sneer, pulling as hard as she can.  Thrown off-balance, you fall face first into the quicksand.  Coughing, you right yourself and struggle desperately to get back up the side, but you have no leverage, and your thrashing causes you to sink waist deep into what feels like dry, impossibly heavy water.");
	...
	//(else fem > 65): 
		...
		output("\n\nA rumbling, hissing sound fills your ears and the dunes surrounding you lift out of sight as all the sand in the hollow begins to run downwards, taking you with it.  You fight against it desperately, but you cannot swim up a landslide and within moments you find yourself buried up to your neck at the bottom of a huge, conical depression, eyes level with the naked abdomen of your captor.  You cough, spit and blink sand away and stare helplessly up at it.  The creature has a long, slim human upper half with four arms and a pair of flat breasts; its twenty slender fingers stroke your face, brush you off and massage your [pc.chest] as it allows you to take it in.  With its glamour gone you can see clearly the six eyed creature is in fact female... or is it?  Its long face is soft around the edges with a cute, pointed chin which is very pretty - or very handsome.  Every time the creature moves its face its gender seems to shift.  Unnerved, you look downwards, and wish you hadn't.  Although its lower half is obscured below the sand, you can see that below its waist the creature's body balloons outwards into what must be a massive, sand-colored insect thorax.  You feel something brush against you and you instinctively attempt to flinch, but you can't.  The sand feels packed against you, and straining every muscle you have to free your limbs gets you nowhere.  Gently, the creature slides its fingers behind your neck and makes you look into its black eyes.");
		output("\n\n\"<i>You made it all too easy for me, little ant,</i>\" it says pityingly.  \"<i>Did no one warn you about sandtraps?</i>\"  Slowly it sinks downwards, and whilst it fondles your face you feel its other set of hands cup your [pc.butt].  \"<i>Never mind,</i>\" the insect monster sighs into your forehead in its fluttery voice.  \"<i>I'll teach you everything there is to know.</i>\"");
	}
...
private function dontSaveTheTarps():void {
	...
	clearMenu();
	//spriteSelect(97);
	output("You carefully step backwards from the quicksand, not taking your eyes off the stricken ");
	if(pc.femininity <= 65) output("woman");
	else output("man");
	output(".  \"<i>Please!</i>\" ");
	if(pc.femininity <= 65) output("she");
	else output("he");
	output(" cries, neck sinking into the drift.  \"<i>Don't let me die like this... oh, very well.  Have it YOUR way!</i>\"  The ");
	if(pc.femininity <= 65) output("woman");
	else output("man"); 
	output(" suddenly thrusts upwards and plunges a fist into the fluid sand surrounding ");
	if(pc.femininity <= 65) output("her");
	else output("him");
	output(".  The dune you are standing on caves inwards, turning into a shifting slide to the morass below you.  You stumble and hop backwards as fast as you can, managing to stay just ahead of the ");
	if(pc.femininity <= 65) output("woman");
	else output("man");
	output("'s spell.  In front of you, sand collapses downwards into a great conical depression, at the epicentre of which is your supposed rescuee.  With ");
	if(pc.femininity <= 65) output("her");
	else output("his");
	output(" midriff exposed and glamour gone, the creature looks quite different; six eyes as black as its hair look at you hungrily from its beautiful androgynous face, whilst four slender arms trail patterns in the sand around its willowy, flat-chested midsection.  It wriggles its body tauntingly at you, making the sand beneath it move ponderously.  You glimpse insect chitin beneath its flat humanoid belly; the buried half of this creature must be monstrous.");
...
public function sandtrapmentLoss():void {
	if(flags["COC.SANDTRAP_LOSS_REPEATS"] >= 2 && pc.eyeType == GLOBAL.TYPE_BEE && pc.eyeColor == "black" && pc.wingType == GLOBAL.TYPE_DRAGONFLY) {
		loseLastFightWithSandTrap();
		return;
	}
	IncrementFlag("COC.SANDTRAP_LOSS_REPEATS");
	clearOutput();
	clearMenu();
	//spriteSelect(97);
	if((enemy as CoCSandTrap).SandTrapLevel() == 1) output("You are sunk to your belly in the depthless sand at the bottom of the pit, and are still falling fast.  The sun above you is blotted out by a shape which leans downwards towards you, smiling triumphantly.  Desperately, you try to keep your arms free so you can swing a blow at it, but with consummate ease, the sandtrap grabs your wrists with one set of hands while pushing you downwards with the others.  Within moments you are up to your armpits in the stuff, staring helplessly up at the strange androgynous creature which has you entirely at its mercy.");
	//PC lust loss: 
	else output("You feel as radiant and molten as the sun above you... you just want to sink into the warm sand surrounding you forever.  Why are you struggling against it again?  You can't remember; with a sigh, you fall backwards onto the soft powder and allow yourself to be carried right down to the bottom.  The sandtrap chuckles softly as it envelopes you in its waiting arms.  \"<i>Good " + pc.mf("boy","girl") + "...</i>\"");

	if(pc.hasCock()) addButton(0, "Next", dickwieldersLoseToSandTarps);
	else if(pc.hasVagina()) addButton(0, "Next", chicksLoseToSandTarp);
	else addButton(0, "Next", genderlessLoss);
}
...
public function pcBeatsATrap():void {
	...
	clearMenu();
	//spriteSelect(97);
	flags["COC.SANDTRAP_LOSS_REPEATS"] = 0;
	//PC HP victory: 
	if(enemy.HP() <= 1) output("The sandtrap groans and collapses forwards into the dirt.  With the creature no longer controlling it, the sand underneath you feels a great deal more stable... climbing out won't be too difficult.");
	//PC lust victory: 
	else output("The sand around you stops sinking.  Overpowered with lust, the sandtrap moans and gives up control over itself and its pit to desperately run one set of hands over its flat chest whilst the other pushes into the sand to masturbate... whatever it has down there.  With your foe in this state, climbing out won't be so difficult now.");
	...
	if(pc.lust() >= 33) {
		...
		if (pc.hasCock() && pc.PQ() >= 60) addButton(0, "UseYourCock", stickWangInSandgina);
		//\"<i>Ride</i>\" (Z)
		if (pc.hasVagina()) addButton(1, "RideVaginal", rideDatSandTarpLikeIts1999);
		//\"<i>Hands</i>\" (Z)
		if (pc.hasGenitals()) addButton(2, "Handjob", useSandTarpsHands);
		//Requirements: Player is naga with tail and fangs, has met desert naga as naga at least once
		if (pc.isNaga() && pc.hasGenitals() && pc.tongueType == GLOBAL.TYPE_SNAKE && flags["COC.MET_NAGA_EVER_AS_NAGA"] == 1) addButton(3, "Naga3Some", nagaThreesomeWithSandTrap);
	}
}
...
private function dickwieldersLoseToSandTarps():void {
	...
	if(!pc.isTaur()) output("armpits");
	else output("forelegs");
	output(".  You try and turn your head to see what it is doing but it gently but insistently pushes your face into the yielding sand.  \"<i>You arrrrhe a fine little drone.  I wwill thank you for yourrh hard work... with the fruits of ssame hard work.</i>\" What does it mean by...?");
	...
	output("  The creature pushes your head down, making soothing shushing noises as it feeds more of its bulbous length into your ass.");
	if(pc.analCapacity() < 40) output("  Although the oil which coats your thoughts and reflexes with sensual supplication makes things easier, the feeling is still incredibly intense, and you grit your teeth as something round travels down the creature's ovipositor and stretches your tight hole wide.");
	else output("  Your accommodating ass feels like it was made for this purpose, and with the creature's oil soothing your thoughts and reflexes you savor the creature taking you like this as if it were your quim.  You moan as something round travels down the creature's ovipositor and into your wet ass, the sensation making [pc.eachCock] hard again.");
	
	output("\n\nThe sandtrap continues to make its soothing, humming sounds and caresses your [pc.chest] and [pc.hair] whilst it holds you firmly in its sandy grasp, sinking egg after egg into your [pc.butt].  It is a process which seems to go on for minutes on end, and the sensation of having your ass bred like this starts to drive you inexorably towards another peak.  You groan as the slick pressure in your bowels makes you cum, your cock");
...
private function chicksLoseToSandTarp():void {
	...
	clearMenu();
	//spriteSelect(97);
	output("The sandtrap holds your hands whilst it pushes you further down with its other set of arms, until only your head is above the sand.  Below the surface you try to weakly move your limbs, try to work yourself out of this situation, but it is impossible; the sand feels impossibly heavy and is packed against you.  The sandtrap seems to have no such difficulty.  It sinks gracefully downwards until its face is almost level with yours.  You feel something wet touch your thigh and you try to flinch, but aside from flexing your muscles you cannot move.");
	...
	if(enemy.fertilizedEggs >= 0) output("  \"<i>A cute little wwworker hasz fallen into my home.  Wwwell, that isz ok.  Fortunately for hwyou, I already have some eggsz ready.  Hhyou will get to be a queen! Iszn't that exciting?</i>\"");
	else output("  \"<i>A cute little wwworker hasz fallen into my home, but I have no fertile eggsz to givve it.  Wwwell, that isz ok.  Hwwe can still have fun, can't we?</i>\"");
...
private function genderlessLoss():void {
	...
	if(enemy.fertilizedEggs >= 0) output("\"<i>Not a worker OR a drone! Wwwell, that isz ok.  Even ants who hhhave nothing can be someone for somebody.  And hhyou can be mommy for my childrrhen!</i>\"");
	else output("\"<i>Not a worker OR a drone! Wwwell, that isz ok.  Hwwe can still have fun, can't we?</i>\"");
	...
	if(pc.analCapacity() < 30) output("Although the oil which coats your thoughts and reflexes with sensual supplication makes things easier, the feeling is still incredibly intense, and you grit your teeth as something round travels down the creature's ovipositor and stretches your tight ass wide.");
	else output("Your accommodating ass feels like it was made for this purpose, and with the creature's oil soothing your thoughts and reflexes you savor the creature taking your [pc.asshole] like this as if it were a quim.  You moan as something round travels down the creature's ovipositor and into your wet ass.");
	output("  Slowly the creature begins to pick up its rhythm again, sliding in and out of your butt as it breeds you.");
	
	output("\n\nThe sandtrap continues to make its soothing, humming sounds and caresses your [pc.chest] and [pc.hair] whilst it holds you firmly in its sandy grasp as it fucks you, sinking egg after egg into your [pc.butt].  It is a process which seems to go on for minutes on end.  The creature's ovipositor rubbing you like this drives you inexorably towards your peak.  You moan and your eyes roll as the slick pressure in your bowels makes you cum, your ass flexing helplessly against the creature's strange genitals.  The oil-induced serenity and the sexual marathon the sandtrap has put you through are too much and, even with the creature still relentlessly pumping away at you, you pass out.");
...
private function useSandTarpsHands():void {
	...
	if (pc.hasCock() && !pc.hasVagina()) {
		...
		output("\n\nOne pair of the creature's hands slowly brush up your inner thighs whilst the other two feel around your [pc.gear], clumsily loosening clasps and belts as it finds them.  One hand locates [pc.oneCock] and, after pausing for a split second, slides its fingers around your shaft and begins to slowly rub up and down.  You sigh as you quickly harden in the creature's smooth, dry, enveloping grasp.  You look into the sandtrap's face as it works; blushing, it looks down from your gaze and concentrates upon what it is doing.  It begins to pump you faster and you hiss slightly at the abrasion this causes.  The sandtrap makes a throaty sound.  Curiously you look down in time to see it bring its other pair of hands up to its mouth and deposit a great dollop of clear ooze into its cupped palms.  Your disgust turns to delight as it swaps its hands and begins to massage its oil into your length, the warm lubricant allowing the creatures' fingers to glide around your shaft and head like they were made of silk.  Tentatively the creature uses its other hands to cup your [pc.butt] and really gets to work on you.");
		//Cock less than 6 inches: 
		if(pc.cocks[0].cLength() < 6) {
			// balls:
			if(pc.balls == 0) output("\n\nThe sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your [pc.cock] to stimulate you even further.");
			else output("\n\nThe sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your [pc.cock] to incite you even further, whilst it uses its free hand to gently cup your [pc.balls].");
			output("  Your small size doesn't seem to bother it; if anything, judging from the red rising in its thin cheeks and its shortening breath, the girliness of your cock actually seems to excite it.  It pauses and, whilst you are both panting lightly, it slowly and gently circles your head with its index finger whilst it still holds the entirety of your cock with the rest of its hand.");
		}
		//Cock 6-16 inches: 
		else if(pc.cocks[0].cLength() < 16) {
			//[no balls:
			if(pc.balls == 0) output("\n\nThe sandtrap glides its hand up and down your [pc.cock], picking up a warm smooth rhythm.");
			//Balls:
			else output("\n\nThe sandtrap glides its hand up and down your [pc.cock], picking up a warm smooth rhythm as it gently cups your [pc.balls] with its free hand.]  It slows down intermittently to move its palm around your length, letting every inch of your dick feel the tips of its delicate fingers.");
		}
		//Cock more than 16 inches: 
		else output("\n\nThe sandtrap quickly comes to the realisation it needs both hands for this.  Still cupping your behind, it moves one oily hand up the top end of your massive shaft, while the other works the other half.  You sigh with deep satisfaction, enjoying the all-too-rare sensation of having every inch of your [pc.cock] immersed in pleasure.  The creature screws its face up and looks away in distaste at the size of your straining dick, which is in danger of poking it in the nose.  As you enjoy the warm, slippery sensation inundating you, you find you couldn't care less what it thinks.");
		//number of cock fork
		//One cock: 
		if(pc.cockTotal() == 1) {
			output("  The sandtrap pumps you faster and faster until its slippery hands are a blur of motion.  It clutches onto your butt cheeks so tightly you hazily realize the indents of its slender digits will be with you for hours afterwards.");
		...
		//Two cocks: 
			...
			output("  As the sandtrap begins to pump you faster, your disregarded [pc.cock 1] bobs in hard, eager concert with your [pc.cock].  You gasp as the trap slows down momentarily to grasp your second sex.  It is clumsy at first as it moves its lubricated palms in tandem, then with increasing confidence as it finds a position and rhythm that suits it, until it is jerking you off furiously, clutching your butt cheeks so tightly you hazily realize the indents of its slender digits will be with you for hours afterwards.");
			output("\n\nThe warm, oily double sensation is unbearably good and although you try to hold on to savor it as long as possible, it isn't long before you reach a toe-curling peak and, with a wordless bark, spurt out line after line of jizz.  The trap flinches slightly when your first cumshots hit it in the face and chest, but then goes back to gently rubbing you, guiding you up and down your warm, slippery orgasm.");
		}
		//Three cocks: 
		else if(pc.cockTotal() == 3) {
			output("\n\nAs the sandtrap begins to pump you faster, your two other, disregarded cocks bob in hard, eager concert with your [pc.cock].  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as  one of its hands clutching your ass releases and snakes back around to take hold of your [pc.cock 2].  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking all three of your cocks in rhythm.");
			if(pc.balls > 0) output("  It grins up at you shyly and, with its final hand, cups your [pc.balls].  ]You laugh with an almost hysterical edge to the sky at how mindboggling getting a triple handjob feels, and the trap giggles slightly as well despite itself.");
	...
	//Female: 
		...
		if(pc.tone < 60) output("  It picks up the pace gradually and soon it is doubly frigging you as fast as its fingers will allow, its other hands sinking deep into your soft, pillowy behind as it clutches onto you.");
		else output("  It picks up the pace gradually and soon it is doubly frigging you as fast as its fingers will allow, its other hands clutching onto your tight, muscled behind so tightly you hazily realize the indents of its slender digits will be with you for hours afterwards.");
	...
	//Herm: 
		...
		output("\n\nOne pair of the creature's hands slowly brush up your inner thighs whilst the other two feel around your \"<i>armor</i>\", clumsily loosening clasps and belts as it finds them.  One hand finds your [pc.cock] and, after pausing for a split second, slides its fingers around your shaft and begins to slowly rub up and down.  You sigh as you quickly harden in the creature's smooth, dry, enveloping grasp.  You look into the sandtrap's face as it works; blushing, it looks down from your gaze and concentrates upon what it is doing.  It begins to pump you faster and you hiss slightly at the abrasion this causes.  At this the sandtrap makes a throaty sound.  Curiously you look down in time to see it bring its other pair of hands up to its mouth and deposit a great dollop of clear ooze into its cupped palms.  Your disgust turns to delight as it swaps its hands and begins to massage its oil into your length, the warm lubricant allowing the creatures' fingers to glide around your shaft and head like they were made of silk.  As it moves its first hand up and down, it tentatively moves its second further between your legs.  It finds your [pc.vagina] and, after pausing for a split second, slides its slender fingers into your moistness.  Although it is clumsy at first, the oil which coats its digits make them glide over your shaft and labia as if they were entirely frictionless.  It quickly gains confidence and begins to gently frig you as it slides its warm, slippery grasp up and down your [pc.cock], circling your [pc.clit] whilst occasionally dipping into your dripping hole.  You sigh and begin to lose yourself in the wet, silky sensation.");
		//Cock less than 6 inches:  
		if(pc.cocks[0].cLength() < 6) {
			//[no balls: 
			if(pc.balls == 0) output("\n\nThe sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your [pc.cock] to stimulate you even further.");
			else output("\n\nThe sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your [pc.cock] to incite you even further, whilst it uses its free hand to gently cup your [pc.balls].");
			output("  Your small size doesn't seem to bother it; if anything, judging from the red rising in its thin cheeks and its shortening breath, the girliness of your cock actually seems to excite it.  It pauses and, while you are both panting lightly, it slowly and gently circles your head with its index finger, still holding the entirety of your cock with the rest of its hand.");
		}
		//Cock 6-16 inches: 
		else if(pc.cocks[0].cLength() < 16) {
			if(pc.balls == 0) output("\n\nThe sandtrap glides its hand up and down your [pc.cock], picking up a warm smooth rhythm.");
			else output("\n\nThe sandtrap glides its hand up and down your [pc.cock], picking up a warm smooth rhythm as it gently cups your [pc.balls] with its free hand.]  It slows down intermittently to move its fingers around your length, letting every inch of your dick feel the tips of its delicate fingers.");
		}
		else {
		...
		//More than three cocks: 
			...
			output("\n\nAs the sandtrap begins to pump you faster, your many other, disregarded cocks begin to harden in eager concert with your [pc.cock].  You gasp as the trap slows down momentarily to reach both of its hands clutching your ass back around to take hold of your " + pc.cockDescript(1) + " and " + pc.cockDescript(2) + ".  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking three of your cocks whilst fingering you in rhythm.  You laugh into the sky with an almost hysterical edge at how mindbogglingly good getting a quadruple handjob feels, and the trap giggles slightly as well despite itself.  Hazily you wonder if it is too much to wish that this creature, with its excellent wrist action, had just one or two more hands to its name.");
			output("\n\nThe warm, oily quadrupled sensation is unbearably good and although you try to hold on to savor it as long as possible, it isn't long before you reach a toe-curling peak and, with a harsh moan, spurt out line after line of jizz whilst gushing femcum coat its hands and your thighs.  The trap flinches slightly when your first shots hit it in the face and chest, but then goes back to gently rubbing you as you ride your glorious orgasm out, spurting like a cum sprinkler in front of it.");
		}
	}
	//All sexes go to: 
	output("\n\nYou sigh with immense satisfaction and step back from the sandtrap.  Taking into account what an excellent job it did you opt not to rub its face in what you have made it do, particularly as you have managed to get quite a bit of your fluids on it anyway.  It watches you, still flushed and mouth slightly ajar, as you leisurely pull your [pc.gear] back on.");
...
private function rideDatSandTarpLikeIts1999():void {
	...
	if(pc.hasCock()) output("  [pc.EachCock] flexes in delicious concert with your quim, spurting jizz onto the trap's chest and face.");
	output("\n\nIn an amplified post-coital euphoria, you slide off the sandtrap, almost falling straight over- you have been at it so long you've lost sensation in your [pc.legs].  You slowly redress and then, before you take your leave, kneel next to the sandtrap's head.  It is still lying with its arms spread-eagled upon the slope, its abused, wilted oil prong slowly retracting, looking semi-comatose.  Smiling, you stroke its brow until it looks up and focuses on you.");
...
private function stickWangInSandgina():void {
	...
	output("\n\nYou take a moment to look your strange conquest over.  Even up close you can't tell from its thin, fey beauty whether it is male or female.  Although it is affecting to look angry at you, its sculpted cheeks are quite flushed and there is a definite undercurrent of desire in its eyes; you suspect your display of strength and dominance appeals to it on some perverse, animalistic level.  Still smiling victoriously, you bend your face into it, deliberately invading its personal space, silently demonstrating who is in charge here.  It can't hold your gaze and, blushing, looks downwards.  This submissive demureness sends heat rushing towards your [pc.cocksLight]; the desire to fuck builds in you, to plough, to sink your cock into this strange, eerily beautiful creature, to establish once and for all who is giving and who is receiving around here... the only question is, how?  Its slim, androgyne upper body is devoid of obvious sexual features.  Your eyes roam steadily downwards.  Where its insect half meets its human half, where its cock should be, it instead has a genital slit; from this is emerging a long, black prong, dripping with clear oil.  Your show of dominance is turning this creature on, and it is powerless to disguise it.  It looks up at you with timid hopefulness... but you are in no mood for that.  There is a definite air of femininity to this creature, a pheromone scent which speaks directly to your [pc.cock], makes you hard");
	if(pc.balls > 0) output(", makes your [pc.balls] swell in readiness,");
	output(" and fills you with a deep, red urge; you grit your teeth in frustration at its essentially male upper half.  Its female half must be what is buried beneath the sand.  <i>Well,</i> says your dick.  <i>You've come this far...</i>");
...
private function nagaThreesomeWithSandTrap():void {
	...
	IncrementFlag("COC.SANDTRAP_NAGA_3SOME");
	...
	//Female: 
		...
		output("\n\nThe naga is soon deep within the sandtrap's oil fuge and she slows her thrusting down as it relaxes her and amplifies what she can feel, smiling euphorically as she slowly rotates on the creature's leaking pseudo-cock.  You pace yourself in sympathy; having already reached one ecstatic high you're more than happy to simply sit back and enjoy the sandtrap's worshipful ministrations, tending to every corner of your [pc.vagina].  You've also had enough oil rubbed into you to feel quite dreamy yourself; the sand, the sun and even your own vagina seem bigger and more encompassing than they were before.");
		...
		if(pc.cumQ() > 1000) output("  The long, sensuous tongue bath has pushed your body into overdrive and the waterfall you unleash is even more uncontrollable than the last; you wonder dizzily if you haven't just lost control of your bladder.  The hypnotised sandtrap gladly drinks what you give it, but it's far too much and soon it is coughing your girlcum back up, through its nose and back onto your still contracting [pc.vagina].");
	}
...
private function sandTrapBadEnd():void {
	...
	if(pc.hasCock()) output("[pc.EachCock] hardens and your thin frame feels aflame, barely understood impulses deep within you begging you to walk down and submit to the Sandtrap's will.  ");
	//Female: 
	else if(pc.hasVagina()) output("Your [pc.vagina] moistens and your thin frame feels aflame, barely understood impulses deep within you begging you to walk down and submit to the Sandtrap's will.  ");
	output("You inhale hard and try to clear your head, forcing yourself not to sleepwalk downwards into the Sandtrap's waiting embrace.  The creature doesn't seem to mind your hesitation; it smiles softly and confidently, waiting for you with the infinite patience of its kind.  You need to make a choice here fast, before your burning body makes it for you.");
	//Fight/Desztiny/Leave
	addButton(0, "Fight", sandTrapBadEndFight);
	addButton(1, "Desztiny", desztinyInTrap);
...
private function sandTrapBadEndFight():void {
	...
	clearMenu();
	//spriteSelect(97);
	output("You shake yourself out of your fog, clench your [pc.mainWeapon] and grit your teeth.  You are your own person, dammit, and you will show this creature just what that means!  The Sandtrap slowly lowers its arms and looks at you with almost parental disappointment as you march into its pit with the obvious intention of beating the crap out of it.  \"<i>You want to dance again, Flytrap?</i>\" it sighs.  \"<i>I would prefer that you look at yourself and accept what you are, but I will force you to accept it if that is what you wish.</i>\"");
...
private function leaveSandTrapBadEnd():void {
	...
	clearMenu();
	//spriteSelect(97);
	output("With some effort you break your stare with the Sandtrap, turn away and step back towards camp, resolving to leave this disturbing scenario with its disturbing thoughts behind.");
...
//Desztiny:
private function desztinyInTrap():void {
	clearOutput();
	clearMenu();
	//spriteSelect(97);
	output("The Sandtrap is right.  What your body and subconscious are telling you is so right.  At your acceptance of what the creature is saying warmth floods through your body; your mind bubbles as blood rushes towards your skin, making you feel incredibly sensitive, incredibly sexual.  ");
	//Male: 
	if(pc.hasCock()) output("Your [pc.cock] strains upwards and you moan; feeling as sensitive as you do, you are both desperate to be touched and desperate not to be.  ");
	//Female:
	else if(pc.hasVagina()) output("You feel but barely hear the drip of moisture on the sand, both your [pc.asshole] and [pc.vagina] beading with oily need.  ");
	output("It seems incredible, as you stumble slowly downwards, feeling every grain of sand underneath your receptive [pc.feet], that barely seconds ago you were even considering not doing this.  It dully occurs to you that there was a reason for that, that you had a purpose.  What is your purpose? You feel like you are shedding whatever that was like an old skin as you walk downwards, discarding an old, directionless life, becoming something newer and raw and purposeful.  You practically throw yourself into the waiting embrace of the Sandtrap, moaning softly as you press your hands against its supple body and feel its quartet of hands slowly explore your back, your nape, your thin wings, your [pc.butt].  You feel like you've come home.");
	output("\n\n\"<i>Good " + pc.mf("boy","girl") + ",</i>\" says the Sandtrap, giggling slightly as it caresses you.  \"<i>Of course, that word doesn't mean anything to you anymore.</i>\"  You blearily look into its thin, beautiful face to ask what it means by that, and the creature takes the opportunity to plunge its tongue into your unresisting mouth.");
...
private function sandTrapBadEndFinale():void {
	//spriteSelect(97);
	output("\n\nIts lips move a slippery friction against yours as it twines its tongue around yours and begins to work glands deep in its gourd, trickling oil into your mouth.  It holds the back of your head kindly yet firmly as it does this, as if it were feeding you, but there is no need for it to apply any pressure at all.  You are nothing but a vessel for it, accepting what it is doing to you without question; you know nothing but the texture of oil and the creature's tongue pushing into you.  Your willingness is rewarded by making the Sandtrap's fluids flow swifter; it smiles against your face before gushing oil into your mouth in a torrent.  At the very edge of your awareness, you feel the sand parting around your [pc.feet], of the Sandtrap pushing you slowly downwards, of the delicious feeling of an infinity of warm particles against your “thighs”; but this is as nothing to the warm ooze sliding down your throat, intensifying your sensitivity, making you gasp and pull away and gush fluids of your own against the Sandtrap, before being pushed back into its dripping mouth with that insistent, loving pressure.  You drink, and drink, and drink, transfixed by a kiss which is more like suckling at a teat...");
	...
	if(pc.hasGenitals()) {
		output(", feeling your ");
		if(pc.hasCock()) output("cock harden");
		else output("vagina dribble");
		
	}
	output(".  Yes.  You remember your quest.");
