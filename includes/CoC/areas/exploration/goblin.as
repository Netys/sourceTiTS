...
private function fightGoblin():void {
	...
	CombatManager.victoryScene(CoCGoblinPCVictory);
	CombatManager.lossScene(CoCGoblinPCLoss);
...
public function CoCGoblinPCLoss():void
{
	if (!pc.hasGenitals()) {
...
public function goblinRapesPlayer():void
{
	...
	if (pc.isBimbo()) {
		...
		if (pc.hasVagina()) {
			...
			pc.cuntChange(0, Math.min(pc.vaginalCapacity(), 1000));
			output("\n\n");
	...
	output(" form.  Your breath is knocked from your body as she drops all her weight onto your middle, making her ass and well-rounded tits jiggle enticingly.   She reaches up to twist her nipple-studs, grinding the sopping wetness of her crotch up and down your [pc.belly].\n\n");
	...
	if (pc.hasCock() && (!pc.hasVagina() || rand(2) == 0)) {
		...
		if (x == -1) {
			...
			output(".  The goblin looks back over her shoulder, narrows her eyes, and pulls back to say, \"<i>Don't even think about holding back, " + pc.mf("stud", "slut") + ".</i>\"\n\n");
			...
			output("Her fingers and words have the desired effect, drawing out a tremendously pleasurable orgasm.  Your [pc.hips] rock and buck against her lithe body, forcing her to cling on to your spasming form as globules of [pc.cum] force their way up your massive urethra.  You can feel them explode into the tiny girl's sopping tunnel, immediately soaking into her womb.");
			...
			if (pc.cumQ() >= 250) output("  Her belly distorts visibly as her uterus is packed full of [pc.cum], making her look heavily pregnant already.  She coos in delight at the sight of her swollen abdomen.");
			...
			else output("was better than I could have dreamed.  I'm going to find you again, " + pc.mf("stud", "slut"));
			output("!</i>\"\n\n");
		...
		//[DICK FITS]
			...
			output("\"<i>Drink your medicine for me " + pc.mf("stud", "slut") + ", I need to make sure you've got a full load for me,</i>\" she orders, stretching to press the flask to your [pc.lips].  ");
			if (pc.slut() < 50) output("You shake your head, trying to get away from the sweet-smelling drug, but she tilts it up, pouring most of it into your throat.");
			else output("You lick your [pc.lips] and open your mouth, happily taking in the cherry-flavored drug.");
			...
			output("Your dick obeys happily, thickening slightly as your abdominal muscles clench with the force of your orgasm.  The goblin's pupils shrink and her eyes roll back as the first torrent of [pc.cumNoun] splatters against her cervix.  She quivers when the pressure builds up and begins to fill her womb.  You clench again, this time pressing against her as the drug's effects begin wearing off.  Her belly stretches out slightly from all the [pc.cumNoun] packed inside her, but you know you aren't done.   She drools, her tongue hanging lewdly from her mouth as you pump load after load into her fertile womb, but like all good things, it does come to an end.\n\n");
			output("The goblin regains consciousness, and flops off of you, grabbing her belly and smiling blissfully, before staggering up to her feet.  She thanks you, \"<i>Mmmm, good job " + pc.mf("stud", "slut") + ".  I'll have to let my daughters know how to find you once they're born.  I think you've got what it takes for me to start my own tribe!</i>\"  Patting your still-dripping member, the pregnant goblin leans down and gives you a wet kiss with her glossy lips.  You smile contentedly and close your eyes, barely realizing her lipstick was drugged before you pass out.\n\n");
			enemy.loadInCunt(pc);
			processTime(120 + rand(30));
			pc.orgasm();
			CombatManager.genericLoss();
	...
	//[FEMALEZ]
		...
		if (pc.slut() < 33) output("You shake your head violently, clearly indicating 'No', but when you open your mouth to vocalize your complaint, your lips are swiftly plugged with bulging sex-toy.");
		else if (pc.slut() < 66) output("You open your mouth to stammer out your concerns, but she plugs the hole with the floppy artificial dong, turning your speech into surprised muffles.");
		else output("You lick your [pc.lips] coyly then open your mouth into a welcoming 'O'.  The sex-toy slips straight into the hole, muffling the sounds of your happiness with the arrangement.");
		output("  It 'plumps' up somehow - perhaps in reaction to your spit - forcing your jaw open and pinning your [pc.tongue] to the bottom of your mouth.  A trickle of fluid escapes its tip, nearly gagging you before your throat reflexively drinks it down.  What did you just swallow?\n\n");
...
//[WIN RAEPZ]
public function CoCGoblinPCVictory():void
{
	//spriteSelect(24);
	clearOutput();
	//[HP Intro]
...
private function gobboButtSecks():void
{
	...
	output("As you pick up your [pc.gear] and begin to get dressed, you glance at the goblin. Her hands began to dig in her now stretched out anus, desperately trying to gather up the [pc.cumNoun] you deposited in her. Smirking, you walk away nonchalantly, quite pleased with yourself.\n\n");
...
private function gobboGetsRapedFem():void
{
	...
	if (pc.isTaur()) {
		...
		output("You pick up the goblin, holding her tightly against your side with your [pc.arm]. You tear a piece of supple leather off of her slutty garments and use it to bind her arms behind her back, just to be sure she can't do anything. She looks up at you, her eyes wide and frightened at the thought of being at the mercy of a much larger creature. In spite of it all, she seems more than a little turned on, if the juices staining your flank are any indication. You look down at her and remark, \"<i>So the little skank has a submissive streak huh?</i>\"\n\n");
	...
	//Goblin victory rape, female naga:
		...
		output("You wrap yourself tightly around your struggling prey, in the process removing her slutty 'clothes'. The incapacitated goblin whimpers plaintively at you and you respond by giving her cunt a smack with your [pc.hand]. Pulling your hand away, you're surprised at how wet it is. You wipe it dry on her face and bring your head down to her ear.\n\n");

		//[Corrupt characters:
		if (pc.cor() > 60) {
			output("You hiss something incoherent to the terrified woman, who starts to quiver in your grip. Laughing, your [pc.fingers] slide into her mouth and she begins to suck on them in an attempt to appease you. Her tiny tongue feels wonderful; clearly she's very experienced at this.  ");
		...
		//[Non-corrupt characters:
			...
			output("You ask her if she's sorry for trying to poison you as your [pc.fingers] slide around her face. She nods vehemently at you, too constricted or afraid to answer. You smile pleasantly at her and feel her body relax a little in your grip.  Your fingers slide into her mouth and she sucks on them eagerly, clearly not wanting to anger you. Her tongue is talented and you enjoy the experience for a little bit until you decide you've toyed with her enough.\n\n");
		...
		output("You hear a muffled yell of \"<i>YOU GOT IT BOSS!</i>\" as she starts licking and gently chewing at you. The feeling is wonderful and you can't help but wonder what was in the vial, but the thought is wiped from your mind as you cum, spraying [pc.girlCum] all over her.\n\n");
		...
		output("You pick up the goblin, sitting her onto your [pc.knee] and restraining both her arms behind her back with your left hand.  You tear a piece of supple leather off of her slutty garments and use it to bind her arms there.  She looks up at you, her eyes wide and frightened at the thought of being at the mercy of a " + (pc.tallness > enemy.tallness ? "larger" : "stronger") + " creature.  In spite of it all, she seems more than a little turned on, if the juices staining your [pc.knee] are any indication.  You look down at her and remark, \"<i>So the little skank has a submissive streak huh?</i>\"\n\n");
		output("She blushes red and the flow of feminine fluid thickens as she nods.  You know she'll probably enjoy whatever sexual act you could perform with her, so you may as well surprise her.  A cruel idea forms in the back of your mind – getting revenge for her attempts to drug you.  You easily rip the pouches from her belt and pull out a few random bottles.  The goblin, understanding your intent, begins struggling to free herself, but you easily restrain the smaller woman and force the drugs into her mouth, one after the another.  When she tries to spit them out, you massage her throat, triggering her instinct to swallow.\n\n");
		output("By the third bottle she's given up on struggling and is instead trying to grind her cunt into your [pc.knee].  Her mouth is open wide and her entire face is flushed reddish-purple with desire.  You finish force-feeding her the remaining bottles and shove her, catching her ankles to hold her over your [pc.leg] with her ass in the air.  The scent of her arousal and the vapors from all the drugs and aphrodisiacs give you a bit of a 'contact high', at least in the sense that your [pc.vagina] ");
		...
		output("*<b>THWACK</b>!* Your [pc.hand] smacks her nicely rounded ass.  You pull back, feeling drops of wetness thanks to her prominent pussy-lips.  The little bitch's cunt is so inflamed with need that she's practically squirting from a simple spank.  You swat her again, watching her entire body tense and feeling her fluids splatter you.\n\n");
		...
		output(".  ");
		if (pc.milkQ() >= 1000) output("[pc.Milk] explodes from your [pc.nipples], soaking the petite slut.  ");
		else if (pc.milkQ() > 500) output("Streams of [pc.milk] soak the slut's hair, running down her face like [pc.milkColor] tears.  ");
		else if (pc.milkQ() > 0) output("[pc.Milk] dribbles from your [pc.nipples], falling into the little slut's hair.  ");
		...
		output("You casually collect your [pc.gear], ignoring the pants and moans from the blissed-out goblin, and prepare to leave.   Taking one last look over your shoulder, you realize her fluids have made a puddle bigger than her.  She'll probably have a hell of a hangover when she wakes up.  You ");
		if (pc.cor() > 50) output("smirk");
		else output("sigh");
		output(" and saunter off, feeling ");
		if (pc.cor() < 50) output("a bit guilty about overdoing it.");
...
private function rapeAGoblinCorruptTooBig():void
{
	...
	if (pc.biggestTitSize() >= 1) {
		...
		if (pc.isLactating()) {
			...
			if (pc.milkQ() < 500) outputText("weep streams of [pc.milkNoun] onto her features");
			else output("plaster her with gouts of [pc.milkNoun]");
		}
	}
	output(". Her hair is matted with");
	if (pc.isLactating()) outputText(" [pc.milkNoun] and");
	...
	if (pc.hasVagina()) {
		...
		if (pc.cockTotal() > 2) output("cocks drench her, ");
	...
	output("Your [pc.cock " + x + "] is pressed so firmly against her skin that you can see your [pc.cumNoun] working its way up and out of your shaft and bloating your goblin toy with only the first shot. ");
	...
	output("Finally you blow your last wad into this latest piece of ass, shoving her off of your [pc.cock " + x + "] and letting her fall to the ground. The impact sends torrents of [pc.cumNoun] sluicing out of her.\n\n");
...
private function manRapesGoblinTooBig():void
{
	...
	if (pc.hasKnot(x)) output(" hooking the heels of her feet just behind your knot");
	output(".\n\n");
...
private function gobboGetsRapedMaleFits():void
{
	...
	if (pc.cockVolume(x) > enemy.vaginalCapacity() * .8) {
		...
		else if (pc.hasCockFlag(x, GLOBAL.FLAG_FLARED)) output("feeling painfully tight around your flare");
		output(". With each and every step she slides down further, stretching her to capacity, until she sits almost completely impaled on you, grabbing your [pc.chest] to help support herself.  A steady pulse of motion massages you in time with the green girl's breathing.  You realize just how much of her body must be devoted to accommodating monstrous members, no wonder goblins are so fragile in a fight!\n\n");
		...
		if (pc.balls > 0) output("Your [pc.balls] tighten, releasing the [pc.cumNoun] of your orgasm.  ");
		...
		if (pc.cumQ() >= 100) output("  Your enhanced body easily stuffs her full of [pc.cumNoun], pudging her belly out slightly, your seed staying embedded in her womb with nowhere to escape, her cunt plugged tightly with your [pc.cock " + x + "].");
		if (pc.cumQ() >= 500) output("  The orgasm is so potent that by the time you wind down, she looks to be sporting a pregnancy the size of a medicine ball.  Your [pc.cumNoun] is trapped inside her, unable to find any gap between her walls and your [pc.cock " + x + "].");
		else if (pc.cumQ() >= 250) output("  The orgasm is so potent that by the time you wind down, she looks heavily pregnant.  Your [pc.cumNoun] is unable to find any gap between her walls and your [pc.cock " + x + "].");
		output("\n\n");
		output("You pant and stop, pulling the stuffed goblin off you and setting her on the ground, smiling in satisfaction as your [pc.cum] ");
		...
		if (pc.slut() > 50) outputText("Chuckling");
	...
	//(FITS – Get ridden)
		...
		output(".  With each and every step you take, she slides down further, until she sits fully impaled on you, grabbing your [pc.chest] to help support herself.   A steady pulse of motion massages you in time with the green girl's breathing, making you realize just how much of her body must be devoted to accommodating monstrous members.\n\n");
		...
		output("The howl of a powerful orgasm fills your ears as your cumming sets off the little green cock-sleeve.  One of her hands lets go, and starts rubbing her belly while she kisses and licks your belly-button.");
		if (pc.cumQ() >= 250) {
			output("  Your enhanced body easily stuffs her full of [pc.cumNoun], pudging her belly out slightly and dripping down your ");
			if (pc.balls > 0) outputText("[pc.balls].");
			else output("[pc.legs].");
		}
		if (pc.cumQ() >= 500) output("  The orgasm is so potent that by the time you wind down, she looks heavily pregnant and your [pc.cum] squirts out of any gap it can find between her walls and your [pc.cock " + x + "].");
		output("\n\n");
		output("You pant and stop, pulling the stuffed goblin off you and setting her on the ground, smiling in satisfaction as your [pc.cum] ");
		if (pc.cumQ() >= 250) output("pours out in a river");
		else output("leaks");
		...
		if (pc.slut() > 50) output("Chuckling");
		else output("Shuddering");
		output(", you make your way back to camp, satisfied.\n\n");
	}
...
private function gatsGoblinBoners():void
{
	...
	output("Eventually you begin to feel yourself coming to a climax, your movements getting faster and faster as you build up to your release.  The goblin below you has already lost herself to the pleasure of your [pc.cock " + x + "], her eyes rolled upwards and her tongue drooling out of her mouth while her slutty face rubs against the ground you're currently pounding her on.  With a final thrust, your hips lurch forward as you paint her insides with your [pc.cumVisc] [pc.cumNoun], relishing in the feeling of your ejaculate filling her up to the brim and plugging her entrance");
	if (y != -1) outputText("s");
	output(".  You slowly release yourself from her tight body, finishing off by covering her curved back and pert rump with the rest of your [pc.cum].\n\n");

	output("You pick yourself back up, jerking yourself slowly as [pc.cumNoun] dribbles from your [pc.cock " + x + "] onto the collapsed body of the goblin.  It'll be awhile before she comes back to consciousness, but you're certain she'll have a better appreciation for sex when she does.\n\n");
