...
private function fightGreenSlime():void {
	...
	CombatManager.victoryScene(greenSlimeIsBeaten);
	CombatManager.lossScene(lossToGreenSlimeShameOnYou);
...
{
	//pc.slimeFeed();
	output("You find yourself unable to tear your eyes away from the creature as it undulates almost hypnotically in front of you, the heat in your crotch rising.  The rigid protrusion at its middle visibly pulses and throbs, and with a small grin you step closer to the ooze and strip off your clothing.\n\n", true);
	...
	{
		output("As you rub the creature's shaft you toy with the idea of inserting the thing into your " + pc.vaginaDescript(0) + ", biting your lip slightly and sliding forward a bit to rub yourself against the slime's " + enemy.cockDescript(0) + ".  You moan a bit and lose yourself for a moment, caught between desire ");
		...
		if(pc.vaginalCapacity() <= 18) output("  On top of that, you are unsure if the thick, foot and a half long appendage would even fit inside of you.");
	...
	if(pc.cockTotal() > 0) {
		...
		else if(pc.cocks[0].cLength() >= 36) output("Your own erect " + pc.cockDescript(0) + " rubs against the creature's as you work, getting in the way somewhat.  ");
		//Single dick contemplation
		if(pc.cockTotal() == 1) output("You feel your " + pc.cockDescript(0) + " begin to throb and entertain the idea of trying to penetrate it somehow.  You turn a bit and look around the creature for an orifice, but find nothing.  After a few frustrated moments of searching you give up and decide to handle things yourself.");
	...
	if(pc.tallness < 82)
	{
		...
		if (pc.hasCock() && !pc.hasVagina() || (pc.isHerm() && rand(2) == 0))
		{
			...
			{
				if(pc.cocks.length > 0) output("Eventually your own arousal becomes unbearable and you reach down to work your one of your [pc.cocksLight], massaging the monster's swollen, throbbing head with your other hand.  You gasp slightly as soon as you wrap your hand around your " + pc.cockDescript(1) + ", the creature's fluid making you exceptionally sensitive.  You moan in spite of yourself and start to thrust your hips a bit against your fist, feeling both yourself and the creature begin to throb harder and harder.  Before long you can hold out no longer, and feel your body racked by an orgasmic spasm, squeezing tightly with both hands as you blow your [pc.cocksLight] cover the creature with cum.  ");
				//Herms - vegemita vaga-cum.
				if(pc.vaginas.length > 0) output("Your " + pc.vaginaDescript(0) + " quivers and shares in the sensation as you grind yourself against the slime.  ");
				//Create cumz
			...
			else 
			{
				...
				{
					output("Eventually your own arousal becomes unbearable and you reach down to work your own " + pc.cockDescript(0) + " as well, massaging the monster's swollen, throbbing head with your other hand.  You gasp slightly as soon as you wrap your hand around your " + pc.cockDescript(0) + ", the creature's fluid making you exceptionally sensitive.  You moan in spite of yourself and start to thrust your hips a bit against your fist, feeling both yourself and the creature begin to throb harder and harder.  Before long you can hold out no longer, and feel your body racked by an orgasmic spasm, squeezing tightly with both hands as you blow your load onto the creature.  ");
					//Herm orgasm text
					if(pc.vaginas.length > 0)
					{
						output("Your " + pc.vaginaDescript(0) + " quivers and shares in the sensation as you grind yourself against the slime.  ");
					}
					output("The creature reaches its peak as well, and a thick, powerful gout of more green fluid shoots from the slime's cock and into your waiting palm.  You shudder as your orgasm seems to drag on for longer than usual, and notice that the slime's body regains some of its definition for a moment before its cock quickly recedes back into its body.");
				}
				//FUGGIN' 'UGE PRICKS!
				...
				{
					output("Eventually your own arousal becomes unbearable and you reach down to grope at yourself as well, working the monster's swollen, throbbing head with one of your hands.  Unable to grip it properly you moan a little and hold yourself down against the creature's skin, moving your hips back and forth to get off.  You begin to moan louder as the same greenish secretion that coats your hands begins to cover your " + pc.cockDescript(0) + " as well, making it throb even harder than before.  Before long you gasp and double over as you orgasm, hips shaking as you come all over the creature.  ");
					//Herm orgasm text
					if(pc.vaginas.length > 0)
					{
						output("Your " + pc.vaginaDescript(0) + " quivers and shares in the sensation as you grind yourself against the slime.  ");
					}
					output("Instinctively you hold onto the creature's own shaft for support as you do and with a final mighty pulse it also comes, spraying its thin green fluid in a tall gout into the air.  You feel it splash onto your back and " + pc.hairDescript() + " as you gasp for breath, before almost falling over as the beast's erection rapidly recedes into its own body.");
				}
			}
			//Newline PG
			output("\n\n");
		...
		else if (pc.hasGenitals())
		{
			...
			output("Eventually your own arousal becomes unbearable and you let one of your hands slide down the creature's erection and body and up your leg, purring softly as a slight warm sensation spreads everywhere you get the green fluid the creature has been so readily leaking.  You let your hand crawl between your legs and gasp slightly as you run a hand over the lips of your " + pc.vaginaDescript(0) + ", savoring the sensation before going to work on yourself.  ");
			//Big clitties
			if(pc.clitLength >= 2) output("You moan and lean back slightly as you grip your " + pc.clitDescript() + " between your thumb and forefinger, biting your lip at the intense sensations as you rub your thumb over your " + pc.clitDescript() + " and shuddering in anticipation and delight.  ");
			//Small clitties
			else output("You moan and lean back slightly as you start to flick your " + pc.clitDescript() + ", the slime's fluid providing excellent lubrication and a luxurious warming feeling as you make small circles around your nub.  ");
			...
			{
				output("You gasp a little as the slime's massive arms reach up from behind you to cup your " + pc.allBreastsDescript() + ", and the soft material ");
				//Tig ol' bitties
			...
			if (pc.cockTotal() > 0)
			{
				...
				{
					output("You feel your " + pc.cockDescript(0) + " surge to full size as the slime works you over.  It begins to throb and ache for release, a need made only more pressing by your desire to have it fondled.  ");
					//Play with it if your boobs aren't being manhandled
					if(pc.biggestTitSize() == 0) output("You delicately grasp the head of your " + pc.cockDescript(0) + ", your hand slick with the fluids of yourself and of the creature.  The combination of the creature's movements and your own quickly overwhelms you.");
				}
			}
			//New paragraph for orgazms.
			output("\n\n");
			//Female cum!
			output("Finally, you feel a tsunami of pleasure begin to wash over you as you orgasm, and as your entire body shakes you unconsciously try to squeeze the creature between your legs.  It pulls back slightly and with a final mighty pulse, a green fluid explodes from the tip of its " + enemy.cockDescript(0) + ", splashing over your entire body.  Everywhere it touches seems to catch fire with pleasure and your already reeling mind almost collapses, and you let yourself fall back against the slime's body as wave after wave of pleasure flows through you.  ", false);
			//Herm bonus cum!
			if (pc.cockTotal() > 0)
			{
				//Multidicked herms
				if (pc.cockTotal() > 1)	output("You let out a strangled gasp as your body, already straining from exertion, shudders again as your " + pc.cocksDescript() + " explodes into orgasm, showering both you and the creature in jizz.  ");
				//Single cocked herms
				else output("You let out a strangled gasp as your body, already straining from exertion, shudders again as your " + pc.cockDescript(0) + " explodes into orgasm, sending a jet of your warm jizz into the air.  ");
			}
	...
	{
		output("A light green fluid begins to coat your hand as you stroke the slime's cock, making your fingers feel warm and sending shivers of arousal through your entire body.  ",false);
		//Males/Herms
		if(pc.hasCock() && !pc.hasVagina() || (pc.isHerm() && rand(2) == 0))
		{
			//Multicock foreplay
			...
			{
				output("Eventually your own arousal becomes unbearable and you reach down to work your own " + pc.cockDescript(0) + " as well, continuing to run your other hand up and down the creature's length.  You gasp slightly as soon as you wrap your hand around your " + pc.cockDescript(0) + ", the creature's fluid making you exceptionally sensitive.  You moan softly in spite of yourself and begin to thrust your hips a bit against your fist, stroking yourself and the creature from crest to root.  The creature's erection gains definition as it starts pulsing harder and faster, turning into ");
				//Compare cocks
				if(pc.cocks[0].cType == GLOBAL.TYPE_HUMAN) output("a near exact replica of your own " + pc.cockDescript(0) + "!  ");
			...
			if(pc.vaginas.length > 0)
			{
				output("The intense sensations ripple through your entire body, and your " + pc.vaginaDescript(0) + "grows wet with arousal.  You push against the creature and rhythmically slide back and forth, its soft, moist body conforming to your folds and creating a wonderfully arousing sensation.");
				output("\n\nIt isn't long before you can no longer hold yourself back and with a groan, you explode, showering the creature with your seed as your " + pc.cocksDescript() + " and " + pc.vaginaDescript(0) + " simultaneously explode into orgasm.  The ooze's penis also seems to swell and a torrent of the green fluid gushes from the tip, creating a large, slippery pool that coats your bottom half and forms a small pool on the ground around you before soaking into the earth.  As you catch your breath the creature's cock begins to lose definition and then recedes as the thing pulls itself back into a blob and slides out from under you, quietly escaping into the nearby water as you watch.  As you get up, you notice a still partly solid blob of green gel on the ground, and pick it up.");     
			}
			//Pure male orgasm
		...
		else if(pc.hasVagina() || pc.isHerm())
		{
			...
			if(pc.breastRows.length > 0 && pc.biggestTitSize() > 0)
			{
				output(pc.allBreastsDescript() + ", and you begin to grope yourself as you grip the creature's shaft and stroke it from crown to root.  As the pulsing of the beast's mass becomes more pronounced so does it's appearance, and it takes on the distinct look of a human penis.  Grinning you pull it towards you a bit and rapidly stroke the shaft with one hand while working the cock's head with the other, making the slime buck slightly, pulsing within your hands.  Without warning, its wide arms reach up, one reaching across your breasts while the other drapes across your thighs, the hand going for your " + pc.vaginaDescript(0) + ".  ", false);
				//Cant cover all of tig ol' bitties
				if(pc.biggestTitSize() > 8) output("Its hand expands, struggling to cover all of your " + pc.allBreastsDescript() + ", ", false);
				//Middling ta-tas get covered
				else if(pc.biggestTitSize() > 3) output("Its hand expands and gently covers your " + pc.allBreastsDescript() + ", ", false);
				//Small tits?  Pwned.
				else output("Its hand easily smothers your " + pc.allBreastsDescript() + ", ", false);
				output("and you stop for a moment until the slime tweaks one of your " + pc.nippleDescript(0) + ", prompting you to begin rubbing it again.  The hand on your breasts expertly massages them with what feels like dozens of fingers as the other gently runs a finger over your gash.  Looking down, you realize that the slime doesn't appear to be moving at all - it is shifting its own mass to massage you, creating a feeling like nothing you've ever experienced!  ");
			...
			//Non titty foreplay
			else output("rapidly moistening " + pc.vaginaDescript(0) + ", and you begin to slide a finger along your gash as you grip the creature's shaft and stroke it from crown to root.  As the pulsing of the beast's mass becomes more pronounced so does its appearance, and it takes on the distinct look of a human penis.  Grinning you pull it towards you a bit and rapidly stroke the shaft with one hand while working the cock's head with the other, making the slime buck slightly, pulsing within your hands.  Without warning, one of its wide arms reaches up, draping across your thighs, the hand going straight for your " + pc.vaginaDescript(0) + ".\n");
			...
			if(pc.cockTotal() > 0)
			{
				...
				{
					output("You begin to moan as the creature rubs the " + pc.vaginaDescript(0) + " beneath your " + pc.cocksDescript() + ", working you with incredible skill, but sadly ignoring your needy ");
					//multi!
...
private function maleRapesOoze():void {
	...
	if(rand(2) == 0)
	{
		...
		else output("Shrugging, you decide to go with the closest thing available and walk towards its head, pulling out your " + pc.cockDescript(0) + " as you do so.  You kneel over the thing's head and stroke your penis lightly to ensure it is fully ready,  ");
		//Balls ftw
		if(pc.balls > 1) output("anointing the slime's face with your " + pc.sackDescript() + " as you do.  ");
		//Ball-less bitches
		else output("probing at the 'mouth' of the creature with your free hand.  ");
		//Continue the setup...
		output("You pull back for a moment and aim your penis downward, resting the [pc.cockHead] on the inside of its mouth and pushing.  You feel the material give and push harder, the membrane material that covers the slime's exterior stubbornly refusing to give.  Finally, after some frustration, you grab the creature by what would be its neck and try to pull it back to your pelvis, thrusting forward at the same time.  It finally gives, and you see your " + pc.cockDescript(0) + " surge into its mouth", false);
		...
		if(pc.cocks[0].cLength() >= 48) output(" and all the way through to its hips,");
		...
		if(pc.vaginas.length > 0) output("  Your " + pc.vaginaDescript(0) + " begins to grow wet as you repeatedly force yourself into the creature's throat.  You take a single deep stroke and bottom out into the creature, grinding your moist femininity against the soft, sensual material of the creature's face.");
		//New PG for cumming!
		output("\n\n");
		output("Before long you find yourself shouting as you pump your seed into the creature, watching as the semen is caught by unseen currents and dispersed into its body.");
		//vaginal orgasm text
		if(pc.vaginas.length > 0) output("  This is quickly followed by a quivering between your nether-lips as your " + pc.vaginaDescript(0) + " quivers in orgasm shortly afterwards.");
		output("  You pull your " + pc.cockDescript(0) + " out of the thing's face slowly, relishing the sensation, producing an audible *pop* when your tip finally exits the creature.  A satisfied smirk crosses your face as the defeated beast's erection shrinks back into itself before sliding off, back into the nearby water.\n\n");
	}
	//anal rape text
	else
	{
		...
		if(pc.cockTotal() > 1)
		{
		   	output("You shrug at the lack of obvious orifices and decide to go for the most common one, choosing the ", false);
			if(pc.cockTotal() == 2) output("larger", false);
			else output("largest", false);
			output(" of your[pc.cocksLight] as you grab the slime and roughly try to turn it over.  Surprisingly it maintains its cohesion and flops onto its side, its erection flopping wetly onto the ground.  ", false);
		}
		//Single dicks
		else output("You shrug at the lack of obvious orifices and decide to go for the most common one, pulling out your " + pc.cockDescript(0) + " as you grab the slime and roughly try to turn it over.  Surprisingly it maintains its cohesion and flops onto its side, its erection flopping wetly onto the ground.  ", false);
		output("  You position your member around where you think the asshole would be and push, smiling as the membrane moves aside and you penetrate into a tight, deep hole.  ", false);
		if(pc.cocks[0].cLength() >= 24) output("By the time you finally bottom out, your " + pc.cockDescript(0) + " is nearly halfway through its torso.", false);
		else if(pc.cocks[0].cLength() >= 48) output("By the time you finally bottom out, your " + pc.cockDescript(0) + " reaches nearly into the slime's neck.", false);
		else if(pc.cocks[0].cLength() >= 60) output("Your penis keeps going deeper and deeper, through the chest, neck, and head, before finally stretching the slime as far as it needs to go to accommodate the full length of your " + pc.cockDescript(0) + ".", false);
		output("  With a satisfied smile you begin pumping, slowly at first before picking up speed.  The slime's anus feels better than anything you've ever had before, apparently coming with its own lubrication but still being tight, hugging your cock like a custom-fit fuck toy.  ", false);
		//vaginal arousal text
		if(pc.vaginas.length > 0) output("Your " + pc.vaginaDescript(0) + " grows wet as you work the thing's hole, every slap of your hips against the thing's ass sending a pang of pleasure through your nethers.  ", false);
		output("After only a few minutes you realize that you can't hold out for much longer, as whatever is inside the creature seems to be making you extra sensitive.  Deciding to make the most of it, you double your speed and grit your teeth, enjoying the slime for all it's worth before ", false);
		if(pc.cockTotal() > 1) output("your [pc.cocksLight] explodes into orgasm, your load filling the space inside the creature and spraying in thick streams across its back.", false);
		else output("exploding inside it, your load filling the space around your cock with a white, milky fluid.", false);
		//vaginal orgasm text
		if(pc.vaginas.length > 0) output("  As you pump your jizz into the creature an almost electrical shock runs through your body, starting from your " + pc.vaginaDescript(0) + " and radiating outwards.", false);

		output("  The thing seems to clamp down on you even tighter as you pull out, and you relish the sensation.  Its tight ass leaves your " + pc.cockDescript(0) + " almost perfectly clean afterward, a glob of white still stuck inside the creature as it changes back into its original, amorphous state.  The cloud disperses as the slime slinks off.\n\n", false);
	}
	pc.orgasm();
	dynStats("sen", 3);
}
...
private function femaleRapesOoze():void {
	...
	{
		output(" your " + pc.vaginaDescript(0) + " growing wet and your " + pc.cockDescript(0) + " growing firm as you imagine it inside you.  ", false);
	}
	else
	{
		output(" growing wet as you imagine it inside of you.  ", false);
	}
	// !!NOTE
	...
	else
	{
		...
		output("<<ERROR: breast size check returned invalid number -" + String(pc.biggestTitSize()) + "- at green slime' player win + vagina + high lust;>>", false);
	}*/
	output("Before long you cannot take the temptation anymore and lift your hind end into the air, moaning softly as you rub the tip of its cock against your " + pc.vaginaDescript(0) + ".", false);
	//defloration hymen
	...
	{	
		...
		{
			output("  You smile as you ram yourself onto the creature, finally removing your virginity.  You quickly start moving and give a pleased gasp as the creature's fluids coat your interior with a cool, soothing fluid.  ", false);
		}
	}
	else if(pc.vaginalCapacity() >= 18)
	{
		output("  You enthusiastically lower yourself onto the slime's cock, letting out a small gasp of surprise as it slides inside of you.  The creature quickly understands your intentions and reaches up with its hands, beginning to pump you furiously.  ", false);
	}
	else
	{
		output("  You hesitate at the sheer size of the slime's cock and the creature, sensing your hesitation, reaches up with its strong arms and grips your ass, forcefully pushing you onto itself.  ", false);
	}
	output("The thing's cock, though rigid, somehow manages to squish and expand wherever needed to conform perfectly to your insides, adapting to your " + pc.vaginaDescript(0) + " with ease as you ride it.", false);
	//penis arousal text
	if(pc.cockTotal() > 0)
	{
		if(pc.cockTotal() == 1)
		{
			output("  Your " + pc.cockDescript(0) + " grows hard as you are penetrated, and with the creature handling the movement you reach down to jack yourself off.", false);
		}
		else
		{
			//might be kind of interesting to include text that identifies the cocks you use, but is possibly pointless.
			output("  Your cock grows hard as you are penetrated, and with the creature handling the movement you reach down, jerking off a different cock with each hand.", false);
		}
	}
	output("\n\n", false);
	output("The slime pumps you hard, eliciting moans of arousal as you lean forward, finally giving in to instinct.  You find that it can easily support your weight as you lean on the thing's chest, using it as leverage as you buck your hips against it.  After a while the slime begins to react almost perfectly to your moaning and panting, changing its pace and size to incredible effect.  You feel exceptionally wet through the entire process, the creature's lubricant mixing with your own.  It has an aphrodisiac effect, intensifying your sensation and making your " + pc.vaginaDescript(0) + " feel hot as you fuck it.  ", false);
	output("Before long you collapse entirely, resting your entire weight on the creature as it pulls your " + pc.hipDescript() + " tightly against its own.  You let out a loud gasp as the thing begins to stir itself around inside of you, vigorously massaging your insides with its cock.  Before long this pushes you over the edge, and you clutch at the slime, pressing yourself against it as hard as you can.  ", false);
	//penis orgasm text
	if(pc.cockTotal() > 0)
	{
		if(pc.cockTotal() > 1)
		{
			output("Your [pc.cocksLight] explode into simultaneous orgasm, releasing ", false);
			output(num2Text(pc.cocks.length), false);
			output(" thick streams of semen onto you and the creature, your mind blanking at the massive relief.  You vaguely notice your ejaculate sinking into the creature's body and getting absorbed as you give yourself to pleasure.  ", false);
		}
		else
		{
			output("Your " + pc.cockDescript(0) + " explodes into orgasm and releases thick streams of semen onto both you and the creature, your mind blanking at the release.  You vaguely notice your ejaculate sinking into the creature's body and getting absorbed as you give yourself to pleasure.  ", false);
		}
	}
	output("You feel a rush of liquid flood your insides, ", false);
	// !! NOTE
...
private function oozeButtRapesYou():void 
{
	...
	if(pc.analCapacity() < 18 || pc.ass.looseness() == 0)
	{
		...
		if(cor() <= 50) output("You feel a bit of fear as you tremble under the creature's weight, worried about the damage that its massive size might do to your ass.  ", false);
		else if(cor() < 100) output("In spite of your worries about the creature's size, you can't help but feel a little bit excited at the idea of having this beast take you from behind.  ", false);
		//and something special for the total whorebags that have somehow not already wrecked their asses.
		else output("You almost lick your lips in anticipation and push your hips back greedily, eager to feel the monster's cock stretch your asshole wide.  ", false);
  	}
	...
	output("Before long you find yourself moaning under the beast's attack, pleasure washing through your nethers in spite of yourself as it pumps your ass.  ", false);
	//cock arousal
	if(pc.cockTotal() > 0) output("You feel pangs of pleasure run through your body as its member repeatedly strokes your prostate from the inside, stimulating it.  ", false);
	output("Its dick shifts slightly, continually growing and shrinking in tiny amounts in a continual, heavy throb.  ", false);
	//masturbation begin 
	//Cawkz!
	if(pc.cockTotal() > 0)
	{
		//Single
		if(pc.cockTotal() == 1) output("You quickly grow erect under the creature's embrace as it pistons into your ass, and before long you stand at full attention.  You weakly rub yourself with one hand as it pumps you, and quickly approach orgasm.  ", false);
		//Multi!
		else output("Your " + pc.cocksDescript() + " quickly grows erect under the creature's embrace as it pistons into your ass, and before long you stand at full attention.  You weakly rub at a different cock with each hand as it pumps you, and quickly approach an orgasm.  ", false);
	}
	//Vaginas!
 	if(pc.vaginas.length > 0) output("Your " + pc.vaginaDescript(0) + " grows wet as the creature continues to assault you, and your cleft begins to ache for a soft touch.  As if sensing your thoughts the creature obligingly wraps a hand around and under you and begins alternating between sliding along your gash and stroking your " + pc.clitDescript() + ".", false);
 	//New PG
	output("\n\n", false);
	...
	if(pc.vaginas.length > 0) 
	{
		...
		if(pc.cockTotal() > 0) output("The creature finally plunges a pair of fingers into your " + pc.vaginaDescript(0) + ", and between this and the additional pressure against your prostate you finally come, harder than you ever have before.  Thick ropes of jizm spray onto the ground as the feeling wracks your body.  ", false);
		//vaginal-only orgasm
		else output("The creature finally plunges a pair of fingers into your " + pc.vaginaDescript(0) + ", the sudden shock finally pushing you to orgasm.  ", false);
	}
	//mangasm
	else if(pc.cockTotal() > 0) output("The additional pressure against your prostate finally pushes you over the edge and you come hard, spraying your load against the ground.  Thick ropes of jizm spray onto the ground as the feeling wracks your body.  ", false) 
...
private function oozeRapesYouOrally():void
{
	...
	if(cor() < 20) output("you blush as ", false);
	...
	if(cor() >= 70)
	{
		...
		if(pc.cockTotal() > 0)
		{
			...
			else output("You feel your [pc.cocksLight] begin to harden just slightly as you work the creature, a surge of arousal flowing through your body.", false);
		}
		if(pc.vaginas.length > 0) {
			output("Your " + pc.vaginaDescript(0) + " ", false)
			if(pc.cockTotal() > 0) output("also ", false);
			output("grows wet as you work the creature, a surge of arousal flowing through your body.  You rub your thighs together and moan into the creatures cock, desperate to be touched by something.", false);
			...
			if(pc.cockTotal() < 1 || pc.lust() <= 40) output("You try to reach for yourself to masturbate, but find yourself unable to reach around the slime's massive bulk.", false);
		}
		...
		output("With a final strong thrust the thing rams your face against its hips and you feel a surge of fluid flow down its member and explode into your stomach.  It releases several spurts of fluid into your gullet before it begins to draw out, dribbling fluid into your throat.  It pauses as it pulls its cock head into your mouth and releases a final blast of fluid, which you quickly swallow as it pulls out.  It releases a few final spurts onto your face as it begins to withdraw, and you lick your lips and begin to rub the fluid into your skin.  ", false);
		if(pc.lust() > 40) {
			output("The creature withdraws as you begin to masturbate, furiously working yourself to a quick, but powerful, orgasm.  By the time you recover, it is long gone.", false);
			pc.orgasm();
		}
		else output("The creature withdraws while you're distracted, leaving no traces of its presence save for what it left on your body.", false);
		//pc.refillHunger(35);
	}
	//standard
	else if(cor() >= 20)
	{
		...
		output("The beast moves off of you and you roll over onto your hands and knees, coughing and spitting up green fluid as you recover your senses.  When you finish you look around for the creature but find no traces of it except the fluid on the ground and a slight taste of mint in your mouth.", false);
		//pc.refillHunger(15);
	}
	//resistant
	else
	{
		output("You close your mouth tightly as the penis rubs against your face, the soft, moist skin leaving a trace of green fluid around your mouth.  You try to turn away and the thing forms a third arm from its chest, pressing it over your mouth.  ", false);
		if(pc.IQ() > pc.PQ()) output("You force yourself to keep your mouth shut in spite of the lack of air, holding out for as long as you can.  Eventually you become light headed, and pass out.  When you wake up there is no trace of the creature, save for the fluid covering your mouth, chest, and the ground around you.", false);
		else {
...
private function oozeRapesYouVaginally():void
{
	...
	if(cor() <= 20)
	{
		...
		//Middle coochie
		else if(pc.vaginalCapacity() < 18) output("The thing slowly presses against you to penetrate and you grab at the grass beneath you, almost entirely certain that it won't fit.  You bite your bottom lip to hold in a moan as the cock slides into your " + pc.vaginaDescript(0) + ", its girth squeezing down to comfortably slide into you.  You let out a pleasant sigh as it penetrates deeper into your body, filling the contours of your interior perfectly until it finally bottoms out.  What remains of its length seems to slide back into the creature's body as it pulls your hips against its trunk.  ", false);
		//Ginormo coochie
		else if (pc.vaginalCapacity() <= 30) output("The thing slowly presses against you to penetrate and you grab at the grass beneath you.  A soft moan escapes your lips as the cock slides into your " + pc.vaginaDescript(0) + ", its girth changing slightly to fit you almost perfectly, stretching you just the right amount.  Your moan grows louder as it penetrates deeper into your body, filling the contours of your interior perfectly until your hips finally touch its trunk.  There's a short pause and you gasp as the slime's member then grows inside you, lengthening to fill your " + pc.vaginaDescript(0) + " perfectly.  ", false);
		//MEGA coochie
		else output("The thing slowly presses against you to penetrate and you grab at the grass beneath you.  A soft moan escapes your lips as the cock slides into your " + pc.vaginaDescript(0) + ", its girth changing slightly to fit you almost perfectly, stretching you just the right amount.  Your moan grows louder as it penetrates deeper into your body, filling the contours of your interior perfectly until your hips finally touch its trunk.  There's a short pause and you gasp as the slime's member then grows inside you, lengthening until it nearly fills your " + pc.vaginaDescript(0) + ".  ", false);
		pc.cuntChange(0,enemy.cockVolume(0),true,false,true);
		output("You arch your back slightly as the slime begins moving, slowly pumping your " + pc.vaginaDescript(0) + ".  As it picks up speed a small amount of the thing's greenish fluid builds up around your lower mouth, making your skin tingle and filling you with an unusual arousal.\n\n", false);
		//Cocks
		if(pc.cockTotal() > 0)
		{
			//Multi biiiiitches
			if(pc.cockTotal() > 1)
			{
				output("Your " + pc.cocksDescript() + " rapidly grows erect under this assault and begins to throb.  Having now released yourself to instinct you reach to jerk off, ", false);
				if(pc.cockTotal() > 2) output("switching between cocks as you rapidly stroke yourself in time with the creature's movements.  ", false);
				else output("rapidly stroking one cock with each hand, working yourself in time with the creature's movements.  ", false);
			}
			//Single dick
			else output("Your " + pc.cockDescript(0) + " rapidly grows erect under this assault and begins to throb.  Having now released yourself to instinct you reach to jerk off, rapidly stroking your " + pc.cockDescript(0) + " in time with the creature's movements.  ", false);
		}
		...
		{
			//Multi
			if(pc.cockTotal() > 1) output("Your " + pc.cocksDescript() + " climaxes as well, sending rope after rope of hot, thick cum onto your face and chest.", false);
			//Single
			else output("Your member climaxes as well, and you pull a hand to cover your eyes and face as your jism explodes onto yourself.  Your other hand slides to the base of your " + pc.cockDescript(0) + " and squeezes as you coat your chest in semen.", false);
		}
		pc.orgasm();
		dynStats("sen", 4);
	}
	...
	{
		output("This fear quickly disappears as a large, human cock grows from the creature's trunk, and is replaced by excitement as you realize what it is planning.  The slime wraps its arms around your legs and squeezes them around its cock.  You moan softly as it moves back and forth several times, sliding its member between your thighs and along your " + pc.vaginaDescript(0) + ".  Its skin feels wonderfully soft and velvety, slightly moist, and leaves a thin trace of green fluid behind.\n\n", false);
		...
		//TIGHT
		else if(pc.vaginalCapacity() < 18) output("It finally begins to penetrate you and you grab at the grass beneath you, excited and anxious for it to try and squeeze itself into you.  You bite your bottom lip hold in a moan loudly as the cock slides into your " + pc.vaginaDescript(0) + ", its girth squeezing down to comfortably slide into you.  You let out a pleasant sigh as it penetrates deeper into your body, filling the contours of your interior perfectly until it finally bottoms out.  What remains of its length seems to slide back into the creatures body as it pulls your hips against it's trunk.  ", false);
		//Loose
		else
		{
			output("It finally begins to penetrate and you grab at the grass beneath you, delighted that its cock seems large enough to fill you", false);
			//SLUT!
			if(pc.vaginalCapacity() >= 30) output(" at least partly", false);
			output(".  A deep, throaty moan escapes your lips as the cock slides into your " + pc.vaginaDescript(0) + ", its girth changing slightly to fit you perfectly, stretching you just the right amount.  Your moans grow even louder as it penetrates deeper into your body, filling the contours of your interior perfectly until your hips finally touch its trunk.  There's a short pause and you let out a delighted gasp as the slime's member then grows inside you, lengthening to fill your " + pc.vaginaDescript(0), false);
			if(pc.vaginalCapacity() >= 30) output(" almost perfectly.\n", false);
			else output(" perfectly.\n", false);
		}
		output("You arch your back in pleasure as the slime begins moving, slowly pumping your wet " + pc.vaginaDescript(0) + ".  It picks up speed and a small amount of the thing's greenish fluid builds up around your lower mouth, making your skin tingle and filling you with an unusually strong arousal.", false);
		//Herm text goes here
		if(pc.cockTotal() > 0)
		{
			//Multi herms
		...
		{
			//multi
			if(pc.cockTotal() > 1) output("Your " + pc.cocksDescript() + " climaxes as well, and you open your mouth as you spray rope after rope of hot, thick jism onto your face and chest.  You relish its salty taste, continuing to stroke yourself even as you come.  ", false);
			//single cock
			else output("Your own member finally reaches its climax as well, and you open your mouth as jism explodes onto your face and chest.  Your hands slide to the base of your " + pc.cockDescript(0) + " and squeeze as you release thick ropes of ejaculate onto yourself, coating your face and chest as you relish its salty taste.  ", false);
		}
...
//
	...
	////[if female or Herm- 
	//else output("Your hands fly to your " + pc.vaginaDescript(0) + " and frantically plunge your fingers in and out of it.  You wish the slime would engulf it as well.  ", false);
	//
...
//
	...
	////[if female- 
	//else if((pc.hasVagina() && !pc.hasCock())) output("rapidly entering it in and out of your " + pc.vaginaDescript(0) + " by way of your fingers.  The cool feel of it contrasts enough to send you over the edge relatively quickly, and you release your juices into it.  You flick it off your fingers ", false);
	////[if herm- 
	//else if(pc.isHerm()) output("feverishly jacking yourself off with it while rapidly entering it in and out of your " + pc.vaginaDescript(0) + " by way of your fingers.  The cool feel of it contrasts enough to send you over the edge relatively quickly.  You release your cum into it while it absorbs the juices from your " + pc.vaginaDescript(0) + ".  You drop some of its bulk ", false);
	////[if genderless- 
...
public function lossToGreenSlimeShameOnYou2():void
{
...
public function greenSlimeIsBeaten():void
{
	clearOutput();
	clearMenu();
...
public function lossToGreenSlimeShameOnYou():void
{
	//if (pcCameWorms) {
		//outputText("\n\nThe slime doesn't even seem to notice.\n\n");
	//}
	doNext(lossToGreenSlimeShameOnYou2);
}