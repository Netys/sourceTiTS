...
public function showDominika(nude:Boolean = false):void {
	userInterface.showName("\nDOMINIKA");
}

public function get dominika():PregnancyPlaceholder // since there are no TFs... screw making actual character
{
...
private function timesFellatrixSucked():Number {
	return int(flags["COC.DOMINIKA_TIMES_HYPNO_BJ"]) + int(flags["COC.DOMINIKA_TIMES_MULTICOCK_SLOBBERED"]) + int(flags["COC.DOMINIKA_SUCK_KNOTTED"]) + int(flags["COC.DOMINIKA_SUCK_OTHER"]) + int(flags["COC.DOMINIKA_SUCK_TOO_BIG"]) + int(flags["COC.DOMINIKA_CUNNILINGUS"]) + int(flags["COC.DOMINIKA_SUCK_EQUINE"]);
}

public function fellatrixBarApproach():void {
	showDominika();
	clearOutput();
	//output(images.showImage("dominika-first-meeting-at-bar"));
	//Get the emporerors new groove (sword)
	//Req's d2 finished
	if (fellatrixSucked() && flags["COC.DOMINIKA_MET"] > 0 && pc.hasKeyItem("Zetaz's Map") && flags["COC.DOMINIKAS_SWORD_GIVEN"] == undefined) {
		dominikaSpellblade();
		return;
	}
	...
	if (pc.bovineScore() >= 3 && pc.faceType == GLOBAL.TYPE_BOVINE && pc.isMasculine()) {
		output("You approach the woman, delivering what you consider a polite greeting. Icily she turns to you, raises an eyebrow, and in a low husky voice snarls \"<i>Don't bother. I'm not interested in being your bimbo.</i>\" She turns away from you, and ignores any further attempts to start a conversation.\n\n");

		output("A tavern maid with shaggy dreadlocks and a long tongue she can barely fit in her mouth waves you over. \"<i>Don't wowwy 'bout Dominika,</i>\" she says through her lisp, \"<i>The's a liddle wacist against, you know, your type. Thays you're only interethted in wape. Motht of uth aren't like dat.</i>\"\n\n");

		output("You nod slightly, glancing back at Dominika, then shrug.");
		//TO THE BAR
		processTime(3);
		clearMenu();
	...
	//Second encounter]
	else if (flags["COC.DOMINIKA_MET"] == 1) {
		output("You make your way over to Dominika's table again, saying hello once more. The two of you talk about your exploits for a time, before you ask her what she has been up to. \"<i>Research, mostly,</i>\" she explains. \"<i>I try to document what this land has, in the hopes that it may be useful to someone one day. I do consider myself somewhat of a learned woman which... seems to be something of a rarity here, so there are few qualified to do the job.</i>\"\n\n");

		output("Intrigued, you ask her to elaborate on what she's learned. \"<i>Well, goodness, that could take a while,</i>\" she laughs. \"<i>Mm. Free tip though. Stay away from minotaur cum. That stuff will get you. There's a merchant out there who has some of my work, if you can find him. Other than that I mean, teaching requires a more intimate setting than 'the Wet Bitch'.</i>\" She rolls her eyes slightly at the name. \"<i>I'd be surprised if there's a single college on this entire continent though. Ah well.</i>\"\n\n");

		output("\"<i>Although...</i>\" she seems to think about something, glancing over at you for a few seconds. After a pause, she adds \"<i>If you'd like, my place is just a few blocks down, I could... impart some knowledge on you there.</i>\"\n\n");
	...
	//[Follow-up Introduction]
		...
		output("You make your way over to Dominika's table and strike up conversation with the modestly dressed woman. Her eyes give away her smile and the two of you discuss your exploits. She doesn't attempt to hide the casual way she ogles you during the conversation, and after a brief while, she invites you back to her place.");
...
private function turnDownDominikasKnowledge():void {
	showDominika();
	clearOutput();
	output("\"<i>Fair enough,</i>\" Dominika nods. \"<i>Let me know if you change your mind.</i>\" The two of you make small talk for a while longer, before you decide to get back to work and excuse yourself.\n\n");
	processTime(7);
	clearMenu();
	addButton(0, "Next", barTelAdre);
}
...
private function acceptDominikasKnowledge():void {
	...
	flags["COC.DOMINIKA_MET"]++;
	if (flags["COC.DOMINIKA_MET"] == 2) {
		output("Dominika smiles with her eyes again. She leaves some payment on the table, then escorts you out into the desert city. \"<i>It's not far,</i>\" she says, \"<i>We'll be there in just a few minutes.</i>\"\n\n");

		output("True to her word, she ducks into an alley just a few blocks down, climbing a ladder leading up to a balcony. \"<i>This city has been co-opted a bit haphazardly,</i>\" she observes as she leads you up, \"<i>So apologies for the irregular front door.</i>\" Glancing up as you climb, you see her pale bare legs, and a glint of metal between them. She helps you onto the balcony, turning and opening the door to her home.\n\n");

		output("Inside you see a number of books left piled on desks and shelves, as well as maps and diagrams of such a variety you don't even recognize most of them. Dominika lights some oil lamps and briefly reorganizes some fallen books before beginning to disrobe. She unwinds the turban around her head and from the back you see brilliant blonde hair reveal itself, most of it tied into a compact bun. Her top lowers from her shoulders – the skirt around her legs appears to be a separate piece - revealing the pale skin you expected and a surprise beyond that. Her back is covered in tattoos, eccentric circles marked with unknown runes and symbols. Though you do not recognize them you can sense that their placement is intentional even though little space remains. The tattoo runs down her arms to the elbow and over her shoulders, and as she turns you see that it runs over her collarbone and completely covers one half of her front, breast and all. The other half is curiously uncovered.\n\n");

		output("Despite the revelation of her multiple intricate tattoos, your eyes find themselves drawn elsewhere. Nearly pitch black, her lips shine with moisture and sit plump and full on her face. It says a great deal about their prominence that between them and the fact that she stands topless before you, you stare at her face!\n\n");
	}
	else {
		output("Dominika smiles with her eyes again. She leaves some payment on the table, then escorts you out into the desert city. The familiar sights along the journey to her abode rush by, nearly forgotten as you ply her with questions and eagerly anticipate ");
		if (!fellatrixSucked()) output("learning more arcane lore.");
		else output("getting to feel those black lips on your skin once again.");
		output("  You let her lead the way inside, and oogle her pale bare legs as she climbs up before you follow.\n\n");

		output("The inside of her place is unchanged; it's full of books, tomes, and parchments scattered over numerous desks and shelves.  With her tutelage you're able to recognize some of them, but you doubt you'll ever have her encyclopedic knowledge.  ");
		if (pc.intelligence() >= 40) output("Not due to lack of intellect, but due to lack of time.  You're all too aware of your mental skill.  ");
		output("Dominika unwinds her turban and lets her hair fall free.  She even undoes her top, revealing the curves of her breasts and her strange tattoos.  Despite the revelation of her multiple intricate tattoos, your eyes find themselves drawn elsewhere once again. Nearly pitch black, her lips shine with moisture and sit plump and full on her face. It says a great deal about their prominence that between them and the fact that she stands topless before you, you stare at her face!\n\n");
	}
	...
	if (int(flags["COC.UNKNOWN_FLAG_NUMBER_00155"]) <= timeAsStamp) {
		...
		if (spellCount() >= 6) {
			if (flags["COC.UNKNOWN_FLAG_NUMBER_00154"] == undefined) {
				IncrementFlag("COC.UNKNOWN_FLAG_NUMBER_00154");
				output("You blink, then casually mention that you actually know quite a bit about magic. Dominika listens to you explain your skill in white and black magic, then coughs awkwardly and glances to the side. \"<i>O-oh,</i>\" she says, \"<i>Well. Uhm. I guess we can talk about magical theory, maybe?</i>\"\n\n");
			}
			else output("You blink, then casually mention that you actually know quite a bit about magic. Dominika smiles, curling those glistening black lips into an even more erotic shape as she replies, \"<i>Oh I know sweety.  Why don't we discuss the theory behind it all?</i>\"\n\n");
			output("Magical theory is not very interesting, but you do feel smarter for discussing it.");
			//(Player receives Intelligence.)
			pc.slowStatGain("i", 1 + rand(4));
		}
		//[If player knows some spells]
		else if (spellCount() > 0) {
			output("You take a step backwards in surprise, but your experience with magic makes you realize that she's not doing anything dangerous. You explain that you've learned a bit of sorcery from books, and she nods thoughtfully. \"<i>I see,</i>\" she muses, stroking her chin. \"<i>I think I may be able to show you a thing or two. Let's see here...</i>\"\n\n");
		...
		//[If player knows no spells]
			...
			output("You nearly fall on your " + pc.buttDescript() + " in surprise, fumbling to defend yourself from an attack, but Dominika laughs helplessly and tries to collect herself. \"<i>Oh goodness, oh I'm sorry, I'm sorry, this isn't anything. This is just flashy lights and constellation circles. This isn't going to hurt you, I'm sorry.</i>\" She walks over to you and extends a hand, helping you get to your feet and hugging you.\n\n");

			output("\"<i>So sorry, again,</i>\" she says, those black lips curving into a big smile. \"<i>I guess I'll take that to mean 'not much', so, here. Let me show you some things.</i>\"\n\n");
	...
	clearMenu();
	addButton(0, "Next", fellatrixSexWarmup);
}
...
private function fellatrixSexWarmup():void {
	...
	clearOutput();
	//Cooldown ongoing!
	if (flags["COC.UNKNOWN_FLAG_NUMBER_00155"] > timeAsStamp) {
		output("Dominika glances out the window nervously and says, \"<i>I don't think you're ready to learn more yet – your mind still needs time to absorb the knowledge from our last meeting.</i>\"  Her tongue slowly slides over the glistening black surface of her lower lip and her voice becomes a little more husky as she offers, \"<i>Why don't we talk about something else?</i>\"\n\n");
	}
	//No cooldown, knowledge get epilogue
	else {
		output("Dominika glances out the window. \"<i>That, I think, is more than enough for now.</i>\" She rubs her hands together, letting the room return to more normal lighting. Looking back at you she pauses, thinking to herself, then speaks again. \"<i>Now, there is something that you could do for me.</i>\"\n\n");
	}

	output("She walks towards you, resting her hands on your collarbone.  ");
	//(If breasts)
	if (pc.biggestTitSize() >= 1) output("They briefly run down to the top of your " + pc.breastDescript(0) + " before returning to your collar.  ");
	//First time
	if (flags["COC.DOMINIKA_MET"] == 2)	output("\"<i>I have not been unaffected by this land. I have certain... dietary needs.</i>\" She coughs slightly, glancing aside and looking as though she's doing her very best not to blush.\n\n");
	//Repeat
	else output("\"<i>You know what I need,</i>\" She coughs slightly, glancing aside and looking as though she's doing her very best not to blush.\n\n");

	output("Breathing in, she turns back to you and smiles. \"<i>Would it be all right with you if I put my mouth on your genitals");
	if (fellatrixSucked()) output(" again");
	output("?</i>\"\n\n");
...
private function declineFellatrixOral():void {
	...
	//No BJs yet.
	if (!fellatrixSucked()) {
		output("She raises her eyebrow and looks around. \"<i>...Really?</i>\" she asks after a few seconds. \"<i>Like, I mean... you're going to turn down a free blowjob?</i>\"\n\n");
		
		if (!pc.isCrotchExposed()) {
			output("She pauses. \"<i>Or cunnilingus, I mean, I haven't looked between your legs yet. You know what this place is like.</i>\"\n\nYou suppose it might not hurt.  Do you want to receive some oral?");
		}
		
		applyDamage(new TypeCollection( { tease : 10 } ), dominika, pc);
		clearMenu();
		addButton(0, "Accept", acceptFellatrixOral);
		addButton(1, "Decline", declineFellatrixOralHARDCORE);
	}
	else {
		//[Say \"<i>No</i>\" to oral AFTER having said \"<i>Yes</i>\" first encounter]
		output("A twinge of annoyance flicks across Dominika's features. She takes in a calming breath. In that action you find your feet abruptly feeling unsteady, as though the world is slowly being pulled out from beneath you. Catching yourself you glance up at her lips, seeming to entropy with an infinite yawning darkness that engulfs the world. Through that gaze you find yourself stable, but find it difficult to look away.\n\n");

		output("\"<i>Don't you think you'd like some?</i>\" she asks, each word carefully enunciated and punctuated. You stare at the curve of her lips for every second of the sentence.\n\n");

		output("What were you thinking?  A little oral sounds great.");

		//(Only \"<i>Yes</i>\" is available)
		clearMenu();
		addButton(0, "Yes", acceptFellatrixOral);
		addDisabledButton(1, "No", "No", "You can't turn down this offer!");
		if (pc.willpower() >= 35 && !pc.hasPerk("Easy") && !pc.isBimbo() && !pc.isBro() && (pc.hasPerk("Enlightened") || pc.isPsionic() || isNineTails(pc) || pc.getHPResistances().hasFlag(DamageFlag.NULLIFYING) || pc.getHPResistances().psionic.resistanceValue >= 50)) 
			addButton(1, "No", declineFellatrixOralSUPERHARDCORE, undefined, "No", "You are strong enough to resist temptation, but she would not like this.");
	}
}
...
private function declineFellatrixOralHARDCORE():void {
	showDominika(true);
	clearOutput();
	output("\"<i>Really?</i>\" she asks again. \"<i>But, I mean... fucking look at these!</i>\" She purses her dark lips, running her tongue over them to emphasize how they glisten in the light. \"<i>Don't tell me you don't think these would feel fucking rad on you.</i>\"\n\nIt's VERY tempting.  Maybe one little round of fellatio?");
	applyDamage(new TypeCollection( { tease : 10 + pc.libido() / 10 } ), dominika, pc);
	
	processTime(1);
	clearMenu();
	addButton(0, "Accept", acceptFellatrixOral);
	addButton(1, "Decline!", declineFellatrixOralSUPERHARDCORE, undefined, "No", "You are strong enough to resist temptation, but she would not like this.");
}
...
private function declineFellatrixOralSUPERHARDCORE():void {
	showDominika(true);
	clearOutput();
	output("Dominika stares at you incredulously, then turns away. \"<i>Fine. Just go then. You know where the door is.</i>\" She walks away into another room, closing the door behind her.\n\n");

	output("You let yourself out.");
...
private function acceptFellatrixOral():void {
	showDominika(true);
	clearOutput();
	//output(images.showImage("dominika-oral-sex"));
	//[Random one-shot after Player has done a Scylla scene]
	//Mind control at 6th suck
	if (timesFellatrixSucked() >= 6 && timesFellatrixSucked() - 4 >= flags["COC.DOMINIKA_LAST_HYPNO_SUCK_COUNT"]) {
		dominikaBlowjobs();
		return;
	}
	//After 3+ blowjobs
	if (timesFellatrixSucked() >= 3 && int(flags["COC.DOMINIKA_AGREEMENT"]) == 0) {
		if (flags["COC.NUMBER_OF_TIMES_MET_SCYLLA"] > 0) {
			output("The familiar slick and slurping brutality is enacted by Dominika's mouth upon you. Those lips engulf you, devour you, inhale you, and in the haze of pleasure you love every single moment. They shine in your mind, glamorized, an immaculate altar to which you can only cum, and cum, and cum, and...\n\n");

			output("As you regain your composure, gasping on her bed, your mind wanders. The idle conversation that passes between you two is casual – Dominika is noncommittal for much of it, busy wiping off her chest. Glancing over you see her tongue slip over her lips in a final cleansing and shiver. As you stare at the pillows you have grown intimate with, a thought occurs to you. Dominika is not the first traveller you have met with such a hunger, but she seems more than any other to be in control of it. It's possible that she could know something that would be helpful to Scylla. You ask her if she's ever met the nun.\n\n");

			output("\"<i>Pardon?</i>\" Dominika asks, having not really been paying attention. You repeat yourself, trying to explain the spunk-hungry canoness in ways that clearly communicate her identity. It seems to work, as Dominika's bored confusion turns gradually to neutral indifference. \"<i>Ah, her.</i>\" She speaks dismissively at first, resting cloth over her shoulders to drape over her chest and searching through a drawer. \"<i>I am aware of her, yes.</i>\" Pulling out a mirror she starts to adjust her hair. In the past this dismissal might have meant it was time for you to leave, but after a few moments she pauses and turns.\n\n");

			output("\"<i>You know, you should be careful who you associate with,</i>\" she says. \"<i>Tel'Adre is... a city of many cowards. Weaklings and malleable fools abound within these walls.</i>\" This particular reaction is not what you expected, and you can only blink in surprise. \"<i>They hide from the world around them, hoping that indolence and apathy will allow them to survive the encroaching demons,</i>\" she continues, \"<i>Hoping that someone will step up and help them when they have done nothing to earn it. They long for their problems to be solved with the push of a button.</i>\"\n\n");

			output("The sorceress crosses back over to the bed, sitting down beside you. \"<i>Someone like you, though, presses on regardless of hardship, no? You are ill content to lay down and take what this land would force upon you.</i>\" She regards you for a few seconds, before glancing back out the window. \"<i>I long to escape from these naive walls, but the Covenant keeps me chained here, hiding my tools from me. They wish to weaken me to be like any other slave of the city, content to lie down and take the pricks of the world.</i>\"\n\n");

			output("She takes a deep breath, turning back towards you. \"<i>I would burn this city to the ground if it would result in my freedom from this land, able to return to the spires of my home at last. But surely, as a champion of Ingnam, you understand? To see your family, your friends once again?</i>\"\n\n");

			output("She seems to be looking at you for affirmation.");
			processTime(7);
			clearMenu();
	...
	var x:Number = pc.cockThatFits(15, "length");
	if (x < 0) x = 0;
	//[If \"<i>Yes</i>\" and vagina]
	if (pc.hasVagina() && (!pc.hasCock() || rand(2) == 0)) {
		if (flags["COC.DOMINIKA_CUNNILINGUS"] == undefined) {
			output("Dominika's dark lips curve up in a wicked grin and she leads you by the hand to another room. Within is a bed that looks to be more comfortable than any piece of furniture you've seen since leaving your village. You are more than happy to sit upon it when she gestures. The pale mage removes the bottom of your [pc.gear] and claps her hands together in a giggling laugh when she sees your vagina. \"<i>Oh my goodness!</i>\" she grins, \"<i>You actually have a cute little vagina! That's SO HARD TO FIND here!</i>\" Climbing onto the bed with you she gives a surprising embrace, planting her ebony lips on your cheek. \"<i>Here, lay back,</i>\" she insists, leaning on your shoulders to have you lay down.\n\n");
			output("She straddles your belly, looking down at you with a mischievous grin. Curiously you feel metal rubbing against your bare skin, much like you saw between her legs earlier. Is she wearing a chastity belt? The tattooed teacher leans down and drags her darkened lips sensually over your own, sucking on your lower lip. The connection of flesh is almost electric in its stimulation – you quickly have to admit to yourself that her lips feel pretty damn good. Her tongue flicks out over the curves on your face and though you try to catch it her body is already sliding down your own. Her bare breasts tease your flesh as her nipples bump and catch against your skin.\n\n");
			output("Those succulent soft lips slip along your belly, teasing you with their moisture. Her hands run along your thighs and guide them further apart as she goes. Your bare slit feels her breasts slide along it as she comes ever closer to the promised cunnilingus. One last push on both your thighs spreads your legs yet further, and as she lifts her head to look at your body you cannot help but feel prostrated before her on display. Your eyes wander down to the lips that have traced her path down your body. It was not intentional – they were simply the first thing to catch your eye, even though she was gazing back at you. Their fullness arouses you even more now that you have felt their touch.\n\n");
			output("\"<i>Now then,</i>\" she purrs, and then descends. You feel her tongue first. There is a gentility in the touch, as it slips slowly over you. A groan forces its way out of you, more from relaxation than pleasure. The tensions from the endless combat and always encroaching lust of the realm slip away beneath her talented touch. Your hands reach down to stroke through her hair, but Dominika bats them away. \"<i>Now now,</i>\" she purrs, her breath and voice hot over you. \"<i>Just relax. Let me.</i>\" The way her lips curve when she speaks excites you again, even as you blush at the realization you focused on them once more.\n\n");
			output("Her lower lip brushes against your " + pc.clitDescript() + ", and another groan leaves your throat. You hadn't expected a touch there so soon, but it sends pleasure all through your body and your breath immediately starts to come quicker. That lip slips down as she opens her mouth, and her topmost pillow remains pressed to your " + pc.clitDescript() + ", continuing to offer more stimulation. She grinds her plump puckers slowly along the outer folds of your " + pc.vaginaDescript(0) + ", letting you feel the obsidian flesh press to and stimulate you, filling you with the sensation of a succulent sex organ on your own.\n\n");
			output("Nails dig into your thighs abruptly as she tightens her grip. Hungrily she opens her mouth wider and pushes her tongue into your " + pc.vaginaDescript(0) + ", wriggling it about. She pushes against your walls curiously and experimentally, aggressively seeking out your pleasure. With a strangled gasp you cannot help but rock your hips forward, pressing closer to her warm and seductive mouth.  A familiar lustful heat rises through your body as her tongue brings out the same reaction in you as the thickest phalluses. You gasp out praise for her oral ministrations, whimpering while she swallows down your nectar. Once more you reach down to stroke through Dominika's hair, but once more she pushes your hands away.\n\n");
			output("She rises from your " + pc.vaginaDescript(0) + ", irritation on her face. \"<i>Lay. Down.</i>\" Her words come out firmly, the ebony lips enunciating each word. You find it impossible not to look at them as she speaks now, staring at their slow movement to form each sound. \"<i>Let me feed.</i>\" Echoing in your mind, you groan happily. The way those dark lips curve as she speaks, the way they curl and press together... You want them on you. You want them pressing over every inch of your sensitive flesh, pulling at the skin on your neck, rubbing along your own lips. Their dark beauty is intoxicating. Your fingers rub along the bed, gripping the covers tightly as you moan and press your hips forward, offering up your " + pc.vaginaDescript(0) + ".\n\n");
			output("Her mouth and those lips descend on you again, pulling lightly at your labia and scandalizing your flesh with their contact. She opens wide and practically swallows your " + pc.vaginaDescript(0) + ", covering all of it with her maw and breathing hotly into it. Her tongue pushes in and rapidly returns to its ministrations, grinding spit and your juices in a circle. Practically lapping at you like a cat drinking from a bowl she can be heard slurping on you and your pussy. Indeed, she seems to purr into you, vibrating her tongue within. Those lips quiver slightly against you in the motion.\n\n");
			output("The slippery warm appendage presses up, beginning to search for your spot. When you give a stifled, excited gasp and raise your hips she knows why. With a passion bordering on possessive aggression her tongue works you over, forcing you to buck and writhe against those immaculate black pillows. You want to shout out and cry in pleasure, but it is too pleasurable to do even that. Your breath comes out faster and higher as you are unable to contain yourself. The dam breaks and you nearly gush in orgasm.\n\n");
			output("You lose track of how long you ride out the wave of maddening pleasure. You can feel her lips on your crotch, feel yourself coming into her engulfing mouth, but this seems as though an eternity is passing. Sheer bliss swallows you and you feel wildly happy cumming into her mouth again and again, rocking your hips in joy.  Simply knowing that those dark lips are pressed up against your " + pc.vaginaDescript(0) + " is enough to make your pleasure exceed what you imagined, lost in the deepest haze of orgasm. You might stay like this against her mouth forever if it feels this good.\n\n");
			output("Finally you feel her slide up along your body, and those warm, wet lips kiss your own. You relax slowly, gasping and opening your eyes. Dominika smiles at you, gently running a hand over your belly and then brushing your cheek. \"<i>Ssh, easy. That was delicious, darling.</i>\" She kisses your cheek. \"<i>Everything I could have hoped for.</i>\" You voice your appreciation, but can't help but ask why she wanted to eat you out. \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need sustenance. Still though, even if I wanted to...</i>\"\n\n");
			output("She takes your hand and presses it to her crotch where you feel the unyielding strength of metal. She lowers her skirt slightly and you see the beginnings of a carefully crafted chastity belt. \"<i>It's alright though,</i>\" she smiles, kissing your cheek, \"<i>I enjoyed myself plenty.</i>\" She then gives an almost wicked grin, a fake expression of innocence dancing across her eyes. \"<i>Just take an hour before you try sitting on anyone else, is my advice.</i>\"\n\n");
			output("After a bit of small talk, she glances out the window, and suggests you get back to your adventuring. She kisses you once more as you go, and you taste those sinful lips on your own as you return to your camp.\n\n");
		}
		//Repeat
		else {
			output("Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to descend upon your " + pc.vaginaDescript(0) + ". She lays you on the bed again, removing the bottom of your [pc.gear] and laying beneath you. Gliding her hands over your thighs she aggressively begins lapping at your " + pc.vaginaDescript(0) + " with her tongue, coating it in spit. \"<i>Mmm, I hope you squirt a river,</i>\" she purrs, giving your " + pc.clitDescript() + " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your " + pc.vaginaDescript(0) + " before engulfing the delicate flesh.\n\n");
			output("She forces your legs open and holds your hands at your side so that she can have free reign over your exposed cunt, hardly submissive even as she takes you in her mouth. Her lips twist from side to side as she rubs her mouth lewdly over your flesh. Spit drips between your legs, and deep satisfied slurping noises arise from the bobbing blonde hair before you. Her mouth is warm and breathy against you, but her plump lips press to your skin like a seal, letting you know that you can only leave her mouth when she is ready. The friction is electric, and you drool nectar into her mouth. All of it is slurped down into her waiting throat.\n\n");
			output("Her tongue aggressively shoves itself into you once more, slapping against the walls of your " + pc.vaginaDescript(0) + " as though trying to break them down. You can practically feel your juices splattering across your cunt and then slurped up by her in the frenzy she approaches you with. Your world becomes consumed by raw sensation as effortlessly as your own " + pc.vaginaDescript(0) + " is consumed by her ravenous maw, losing yourself in the pleasure granted you by those plump fuckable puckers. ");
			if (pc.totalCocks() == 0) output("A part of you even wishes that you had a cock so you could shove through them!\n\n");
			else output("A part of you even wishes that she had chosen your cock so you could shove it through them!\n\n");
			output("You don't speak, cannot speak as she sucks and gulps at your flesh. You can only offer up strangled gasps and shuddered squeals to her actions, prostrated like a servant before her, gripping the covers and mattress beneath you. Your " + pc.vaginaDescript(0) + " is hers, to impose whatever demands she wishes, and the insatiable suckling upon you makes her demands clear. Her tongue twists about in you and against you, mocking your fingers with how much better it seems to know your pleasure.\n\n");
			output("You cannot resist for long after she takes over your spot once again, grinding against it and forcing you to arc your back. Pleasure surrounds you as effortlessly as her lips surround your " + pc.clitDescript() + ", and you find yourself cumming hard against her. She drinks everything you give her, sucking on your " + pc.vaginaDescript(0) + " to ensure as little as possible escapes. You feel as though the orgasm could last forever, but settle slowly as she gently kisses your lips, stroking along your belly.\n\n");
		...
		IncrementFlag("COC.DOMINIKA_CUNNILINGUS");
	}
	//MULTICAWWWWK
	else if (pc.cockTotal() >= 2 && rand(2) == 0) {
		//[If \"<i>Yes</i>\" and multi-cock]
		if (flags["COC.DOMINIKA_TIMES_MULTICOCK_SLOBBERED"] == undefined) {
			output("She licks her teeth rather than her lips, reminding you in some ways of a predator observing prey.  You scarcely have time to contemplate this before she tugs you into the next room.  If the exceedingly comfortable-looking bed is any indication this would be where she sleeps.  Dominika insists upon you sitting on it and you find it to be exactly as comfortable as it looks, if not more so.  \"<i>I knew it was an offer you'd accept,</i>\" she coos.  \"<i>So few are worth my attentions, but you... you caught my eye, champion.</i>\"  She approaches you with a seductive slink in her step, grabbing hold of your [pc.gear] and tugging away the bottom.  Her eyes light up with mischievous anticipation as she sees what waits beneath it.\n\n");

			output("\"<i>My my my, you must have been looking forward to this, you brought me a bouquet,</i>\" she teases.  Curling her palm around your " + pc.cockDescript(0) + ", Dominika tosses you a smug smile.  \"<i>Although I hope I'm not disappointing you if I call it more of a buffet.</i>\"  While continuing to tease your " + pc.cockDescript(0) + " with gentle friction, her other hand roams along your crotch.  The gentle fingers tease between your [pc.cocksLight], taking the time to familiarize themselves with the texture of your flesh.  The grin spread across her deep lips does not lessen as her skin tastes yours.  \"<i>I'm always curious about the circumstances that lead to this point,</i>\" Dominika admits as her fingertips play about your head.  \"<i>Was it an addiction to Incubus Draft? A spell gone wrong? You certainly didn't come here equipped like this. But then...</i>\"  She leans in, flicking her tongue across the tip of your " + pc.cockDescript(0) + ". \"<i>It's not particularly important, is it?</i>\"\n\n");

			output("She leans in close to continue, her breasts rubbing across your [pc.cocksLight] as a result.  \"<i>We're not after life stories, or deep introspection here,</i>\" she whispers slowly, her breath flowing heatedly over your " + pc.cockDescript(0) + ".  \"<i>You want me to do things to your body. It's that simple. And I...</i>\" Her black lower lip drags itself over your head, its full curve teasing your cumslit as it passes by.  \"<i>I want this.</i>\"  Fingernails trail over your skin as she runs the verbal foreplay across your " + pc.cockDescript(0) + ", carried in her breath.  Her tongue flicks across your slit, taunting it while her hands roam freely over you.  In the relaxation her pleasure provides, you reach forward to rest your hand on her head, only to be abruptly reprimanded by a slap to your wrist.  \"<i>No,</i>\" she hisses smugly, letting her lips drag against the side of your " + pc.cockDescript(0) + " as she speaks.  Their softness quickens your breath, and you focus on the words she speaks to keep your head.  \"<i>I'm not interested in letting you set the pace, dear.  This is mine to play with.</i>\"\n\n");

			output("She shifts in deeper, slurping lightly on the side of your base.  Her chin rubs against your " + pc.cockDescript(1) + " as she teases your primary wang, letting her skin taunt everything in your lap from your thighs to your pricks with her proximity.  The plumpness of her breasts makes for a suitable cockrest as her ebony puckers glide over the straining flesh of your " + pc.cockDescript(0) + ".  They shift and move with her, pressing into your thigh as she swaps sides and sucks on the meat of your shaft.  Her dark lips feel better than you had imagined.  Their fullness belied a delicate touch that now, in the moment of finally experiencing them, borders on ecstasy.  You let your hands fall to the side to support yourself as Dominika works over your lap, accepting her terms if it means she labors over you like this.  The continued teasing over the side of your " + pc.cockDescript(0) + " makes you eager to actually enter her mouth, but the casual way she claims dominion over your lap so that she can blow you is too enjoyable to interrupt.\n\n");

			output("Fortunately, you don't have to wait long. As her midnight cocksuckers drag up your " + pc.cockDescript(0) + " once more, they curl around your head.  Finally your dick finds the warmth and clinging flesh of a hole. A groan forces itself past your lips and you can feel Dominika's dark puckers smirk.  They twist from side to side around your shaft, her breasts shifting and knocking against your [pc.cocksLight] and catching some of the sweat from your crotch on them. Her fingers play wantonly where they please, at times squeezing and rubbing into your thighs, at others caressing randomly across your flesh.  Your " + pc.cockDescript(1) + " soon comes to know their touch quite intimately.  Despite all this – despite much of your [pc.cocksLight] simply sitting out in the air, pressing against the tattooed woman for warmth – your mind is drawn to the sensations of her mouth, and the sensations of those  deep, dark lips.  You only lust for them more as they drag along you.  Every little twist, every gulp that pushes them in another direction sends a tensing shiver down your " + pc.cockDescript(0) + ".  Your breath catches in your throat, gasping when you feel the inside of her cheek grind against your prick.\n\n");

			output("The tensing, slurping pleasure forces you to pull your gaze away eventually, closing your eyes as everything unfocuses in favor of experiencing raw sensation.  The thought of those dark suckers is more than enough to fixate on.  Their succulent fullness is perfectly imagined in your mind, and thinking about them only gets you hotter and harder.  This in turn only spreads the black, flawless cocksuckers around your " + pc.cockDescript(0) + " wider, the thought of which is nearly too much just by itself.  Imagining Dominika's pitch dark lips forced into a wide O by your prick feels so natural, and so right.  You spread your legs further apart to thrust your [pc.cocksLight] out even more, prostrating yourself before those delicious and devilish dickslurpers.  The eagerness with which they grip, twist, and spread the thick saliva that clings to every inch that her mouth has descended upon provides you some of the strongest pleasure you've felt since... really, with your mind so absorbed in the lewd and loud cocksucking, you can't remember feeling better.\n\n");

			output("Dominika only goes further on you, letting your " + pc.cockDescript(1) + " push over her shoulder and past her hair.  It sits out in the air but the obscene warmth wrapping around your " + pc.cockDescript(0) + " keeps you from caring.  Even having just one of your dicks in her dripping maw, attended to by her covetous tongue, is enough.  You think just having her work your head would satisfy you – though you hardly object to those dark lips pulling you further in!  Half your prick sits inside her hungry mouth, your cockhead grinding at the back of her throat.  The dominance she claims over your lap ensures you need not ask her to keep going – her gulping throat keeps pulling, taking all of your " + pc.cockDescript(0) + " into it.  Deep swallowing slurps drag along the length of your " + pc.cockDescript(0) + " as though it was being milked for those black puckers.  Perhaps it was.\n\n");

			output("The cabalist seems ill content to simply rest in your lap, and resumes her ravenous and whorish bobbing.  She does not shy from taking great big gulps of your prick, sliding so far up your shaft that her depraved 'O' lips stop right beneath your head, and then diving back down to impale her face and clutch you within her throat once more.  Again and again she performs this lewd facefucking upon you, coating your " + pc.cockDescript(0) + " and her chin in spit yet remaining fully in control.  The urge to cum continues to rise in you, eager to feed and please those perfect fat cocksuckers and show them that your prick is worth it.  As she continues to repeat the dominant suction it becomes harder to resist this urge, and as the pleasure continues to rise, your cock straining and bursting to release, you ask yourself why you are resisting it at all.  The first blast of cum splatters into Dominika's throat, and nearly whimpering in pleasure you thrust forward.  Nothing is important but cumming, dumping the thick loads that have yearned to escape out into whatever is before your [pc.cocksLight].  You feel the cabalist gather them up to press against her warm body, not out into space.  Some of your jizz runs down your " + pc.cockDescript(1) + ", dripping off her chin. It's hard to focus.  You just want to ride this wave of pleasure further, continue to jerk and spasm as your lap releases its load.  More and more you cum as those dark lips squeeze you, those fat flawless cocksuckers that so desperately need your cum.  You give everything, and you just keep thrusting.\n\n");

			output("Softly her lips press against yours, and you start to relax.  Glancing down your [pc.cocksLight] has long since finished, and Dominika stands before you smirking.  She collects some of the spunk splattered across her chest on a finger and sucks it clean between those deep lips.  It's hard to recall all of what you just went through, but you feel incredible.  Just the sensation of the air on your sensitive prick makes you whimper a little.  \"<i>Healthy, hearty,</i>\" she teases, \"<i>You pass expectations, I'd say. A shame I could not get to every inch of you before you blew, but... well, I'm used to it.</i>\"  You voice your appreciation, but can't help but ask why she wanted to blow you.  \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need to eat.  Still though, even if I wanted to...</i>\"\n\n");
			...
			output("After a bit of small talk – and some cleaning of her chest and shoulders -  she glances out the window, and suggests you get back to your adventuring.  She kisses you once more as you go, and you taste the ebony curves on your lips as you return to the streets of Tel'Adre.");
		}
		//[Follow up Multi]
		else {
			output("You barely have time to nod your assent before Dominika drags you into the other room with a grin, nearly throwing you to the bed and licking her lips.  \"<i>C'mon then you cumfactory,</i>\" she smirks, tossing aside the bottom of your [pc.gear] carelessly.  Her fingers trail at your thighs as she looks down at your [pc.cocksLight] with an unsubtle hunger.  \"<i>Show me just how much you like what I do.</i>\"  Her hand curls around your " + pc.cockDescript(1) + ", jerking it recklessly and lewdly.  You're hardly about to not get erect at her half-naked form and the administrations to your crotch – much less the sight of those deep, delicious lips – so the command feels a little silly.  You really stop caring about how silly it is as soon as her mouth slides over your " + pc.cockDescript(1) + ".  She sucks casually on the prick, roaming over the base with one hand while the other taunts the head of your " + pc.cockDescript(0) + ".  Though you try to relax, a small amount of tension still sits in you, brought about by the knowledge of just how recklessly Dominika can assault your prick with her succulent full puckers.\n\n");

			output("It's clear that it won't take long for her to reach that point.  Though she soon squeezes your cocks together and lashes her tongue across them, you can see her eyes settling on your " + pc.cockDescript(0) + ", hungry for the fattest one.  Those dark cocksuckers kiss every cumslit wetly in turn, but wrap around the foremost of your pricks soon after.  They slide and shift messily around, the cabalist unafraid to spit and drool over your " + pc.cockDescript(0) + " as she works it over.  Every movement the soft flesh makes excites you.  Your prick presses into the roof of her mouth, into her cheeks, pressing down her tongue.  It roams about the wet maw not freely, but where she demands it go.  The wet warmth pulling at your prick ensures you don't mind at all.  Her tongue nearly flays your prick in her ravenous domination, grinding so intimately into you they might have been joined as one.  Saliva drips down your prick from her squeezing ebony kiss, only allowing her to move slicker and quicker about you.  The plump 'O'-shaped puckers dominate your thoughts as easily as they dominate your lap, nearly sealing around your " + pc.cockDescript(0) + " and ensuring that you will not leave her mouth until she is ready for you to.  The control she exhibits is wildly arousing and you happily drool pre-cum into her gulping mouth.  She swallows it up at the same time as she pulls you into her throat, claiming your prick even more.\n\n");

			output("All the while the rest of your [pc.cocksLight] find themselves in the grip of her delicate hands. Their softness speaks to the life of a magic-user. It seems as though the hardest she may have worked in her life was the rough pumping she gave your " + pc.cockDescript(1) + ".  She is unrelenting in her treatment, ensuring you stay constantly stimulated even at the risk of overdoing it.  Dominika doesn't seem to care how much you groan, or gasp, or whimper at the pleasure and wet friction she gives you.  She cares only about making you cum.  Without those full black lips to focus on it feels as though she might make you pass out, but you can cling to the thought of them as tightly as they cling to you.  They engulf you, swallowing and sucking messily eternally.\n\n");

			output("She drags you recklessly to the edge.  You know you will fall over it, and when you do you will pump load after load of sticky spunk out of your [pc.cocksLight] drenching whatever has a grip on you or sits in front of you.  Dominika dominates this position, and her dripping maw's constant assault on your lap demands so much of your attention it becomes easy to forget that anything else exists.  You twitch and clench, pushing up and forwards until her face is hilted on you.  In that moment of slutty unity you can no longer resist her throat's demands.  Bulging out her swallowing hole, even your sense of self becomes momentarily replaced by nothing more than the need to cum and dump your jizm.  Maybe the two of you are a single entity, devouring and producing cum eternally.  You don't know. You just cum.  You don't stop cumming.  You pump and you thrust and you moan in unbroken pleasure.  The sensation seems eternal until a kiss on your cheek breaks the reverie, leaving you to fall backwards gasping.\n\n");

			output("\"<i>As always, delicious,</i>\" Dominika smiles, relaxing with you in the afterglow of her meal.  She caresses you until you regain your strength, and then politely helps you re-dress and sends you on your way, giving you a kiss to remember her.  Those black lips linger in your mind as you walk the streets of Tel'Adre.");
		}
		IncrementFlag("COC.DOMINIKA_TIMES_MULTICOCK_SLOBBERED");
	}
	//[If \"<i>Yes</i>\" and penis small enough to suck]
	else if (pc.cocks[x].cLength() <= 15) {
		//Dogcock suck
		if (pc.cocks[x].cType == GLOBAL.TYPE_CANINE || pc.cocks[x].cType == GLOBAL.TYPE_VULPINE) {
			// - first time dogsuck
			if (flags["COC.DOMINIKA_SUCK_KNOTTED"] == undefined) {
				output("A confident chuckle comes from Dominika's throat as she takes your hand and leads you to another room. \"<i>Come then, sit down,</i>\" she smiles, patting the surprisingly luxurious bed within. \"<i>Make yourself comfortable, dear, as you'll not be standing up.</i>\" You quirk her head, but the nearly carnivorous way she licks those dark lips suggests that her 'certain dietary needs' are ones she pursues with some passion, and sitting down seems like a good idea. She in turn paces calmly around to face you, resting her hand on your shoulder as she does. A single, appraising glance is given you before she kneels and removes the bottom portion of your [pc.gear].\n\n");

				output("You were not prepared for the brief laugh that escapes her inky lips. \"<i>Ah, sorry, sorry,</i>\" she quickly explains, though she still smirks, \"<i>Just... mmm, fan of spicy food, I take it?</i>\" She brushes her hands over your " + pc.cockDescript(x) + " and briefly rubs your knot with two fingers. \"<i>As long as you give me my food we shouldn't have any problems.</i>\" Those dark lips turn once more into a grin both confident and wicked. Leaning forward, her plump lower lip rests against the shaft of your " + pc.cockDescript(x) + " before dragging slowly upwards, leaving behind a trail of subtle saliva. Her top lip curls over your tip as she arrives, giving the first small suck of your meat – one that feels incredible. The heat and warmth of her mouth is only teased at but you desire far more, to say little of the soft sensation from her curving pillows. The single action is capped off by her tongue flicking across your very tip, leaving behind the warm trail of her spit.\n\n");

				output("A sense of strange regret comes as she lifts her mouth from you, but you know she's not going anywhere. Her fingers curl around you, almost undulating slowly as she makes them crawl down your " + pc.cockDescript(x) + ". She watches your pleasured grunting with amusement, though her eyes continually flicker back down to the shaft in hand. \"<i>I hope you're not used to company licking your crotch,</i>\" she teases, leaning in and dragging her slippery tongue over the meeting of crotch and shaft. The side of her lips rub against your knot in turn, the contact as electric as it was before. Already you can feel yourself ready to swell up fuller and fuller, to lock yourself in her and flood her with the thick spunk waiting to be free, but your resolve restrains you for now. You are eager to see what else she – and those ebony pillows of hers – enacts upon you. Her tongue swirls around you, your " + pc.cockDescript(x) + " gliding about her forehead and her cheeks as a result of the motion. The contact of the flesh helps soothe the lust you feel looking at the plump curves upon her face.\n\n");

				output("Eager to see those lusts slaked, you reach forward, moving to at the very least caress her hair and encourage what she's doing, but her hands come firmly to your wrists. \"<i>Down, boy,</i>\" she smirks up at you, \"<i>Do you think you're going to be setting this pace? No, no no no.</i>\" With a grip firm enough to inform you that she will not accept no for an answer she sets your hands to your side. You like the way her lips smile when you acquiesce to her insistence. \"<i>This is my toy to play with, not yours. I'm in control here.</i>\" The slow way she punctuates each word and the shapes her lips make as she does so tantalize you. The moment her lips make those shapes around your " + pc.cockDescript(x) + " and start to grind, you realize that the feeling of those ebony curves forming around you is not nearly enough. Still, the heated breath emanating from between them and the brief brushes they give as they pass on by keep the blood stiff within your shaft, eager and awaiting what more she desires.\n\n");
				output("Her tongue returns to the base of your " + pc.cockDescript(x) + ", this time circling around your knot. Coming eventually to the bottom of it, her tongue begins another slow ascent, smearing the warmth of her mouth all along the already slick underside of your prick. A little torment plays out within you, wondering whether this was even better than the first lick, but the thought of those lips about to act upon you overwhelms all other frivolous imaginings. Every little bit that the tongue travels up you is one step closer to their ebony grip engulfing you.\n\n");

				output("Saliva flicks across your tip as she finishes the slow lick. The lewd schlorp that follows makes you spasm, thighs twitching as you jerk forward. A strangled gasp is ripped from your throat, the abrupt penetration of the sorceress' mouth catching you unprepared even in your obsession with her maw in your mind.  She fills her mouth with you, wetly slipping around your " + pc.cockDescript(x) + ", shoving your tip into her cheeks. It grinds against the soft and heated flesh within until she can no longer fit the swelling shaft between teeth and cheek. Her tongue then becomes the focus of the slow grind, rubbing itself from side to side along the underbelly of your " + pc.cockDescript(x) + " as Dominika's warm mouth begins to bob about your length. The movement of those sinful lips is palpable, your prick able to track each movement of the full flesh as they slide along it. Never did you expect so much pleasant friction from so slick a substance! Though her mouth seems to effortlessly slip along you the drag of her flesh feels almost as though those plump lips could pull you off the bed.\n\n");

				output("The ache of your desire feels so palpable you want to strangle it. You long to reach forward and take the occultist's head, to shove her down and let your knot lock her to your crotch and to dump endless depravity into her stomach. Every time you think of it you are reminded of the firm instructions she gave you not to, and the thought of disregarding those lips stresses you to uncomfortable levels. Your " + pc.cockDescript(x) + " feels as though it is straining against the bondage of its very flesh as she grows more frenzied, wanting to burst out in infinite size and overwhelming jizz. You want more, and you want it from Dominika.\n\n");

				output("Almost as though she was teasing your desire, her fingers close around your knot. Though the soft skin is pleasurable to the touch, they clench tightly, rubbing the spit dripping down your " + pc.cockDescript(x) + " against the engorged skin. Above the knot, her face bounces harder and harder, the act more akin to a juicy cunt bouncing in your lap than the mouth shoving itself onto your dick. You're fucking her – or rather, she's fucking you, mounting you with her mouth the way a more traditional slut might have straddled your lap. Your knot swells into her fingers, the lust and the passion of the moment causing it to give up on pushing past those flawless ebony pillows that slip faster and faster over your " + pc.cockDescript(x) + ". Lost in the passionate throes of animal rutting with a sloppy drooling maw, you close your eyes as your orgasm approaches.\n\n");

				output("Darkness fills your vision when you do – the darkness of those deep, sinful lips. You can focus on nothing else, imagining the lewd O they make around you. You picture her face, her jaw stretched out, those black pouty curves bidding you enter. Bidding you feed them. Hips twitching and rocking of their own accord you can no longer hold back. As though a dam had burst, spunk floods the passage of your " + pc.cockDescript(x) + " and shoots into the swallowing throat of the tattooed magistrix. You slam your hips forward as though shoving yourself into the biggest-bootied bitch-whore you've met, and it feels like those plump plush pillows are providing even more cushioning. The spasms that rock your body threaten to give you whiplash, the raw unadulterated pleasure you feel here in this mouth, mind-blowing. Nothing exists in your mind but cum, and those lips, those perfect, immaculate, godly, dripping...\n\n");

				output("Softly her lips press against yours, and you start to relax. Glancing down, your " + pc.cockDescript(x) + " has long since finished (though the knot remains thick), and Dominika sits beside you smirking. She gently massages your head as you recover from the fellatio, groaning slightly. It's hard to remember those last few moments, though you feel incredible. Just the sensation of the air on your sensitive prick makes you whimper a little. \"<i>I think I gave him a bit of a workout,</i>\" she teases, \"<i>It's always good to remind a dick that a good mouth can do oh so much to it.</i>\" You voice your appreciation, but can't help but ask why she wanted to blow you. \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need to eat. Still though, even if I wanted to...</i>\"\n\n");

				output("She takes your hand and presses it to her crotch where you feel the unyielding strength of metal. She lowers her skirt slightly and you see the beginnings of a carefully crafted chastity belt. \"<i>It's alright though,</i>\" she smiles, kissing your cheek, \"<i>I enjoyed myself plenty.</i>\" She then gives an almost wicked grin, a fake expression of innocence dancing across her eyes. \"<i>Just take an hour before you try putting that in anyone else, is my advice.</i>\"\n\n");

				output("After a bit of small talk, she glances out the window, and suggests you get back to your adventuring. She kisses you once more as you go, and you taste the ebony curves on your lips as you return to the streets of Tel'Adre.");
			}
			else {
				output("You arrive at the second-story apartment and Dominika unceremoniously drags you into the other room. \"<i>C'mon, bitch,</i>\" she says playfully, licking those deep lips.  She sits you on the bed and pulls your [pc.gear] away from you, kneeling down. \"<i>I trust you've built up a good meal?</i>\" She rapidly starts pumping your " + pc.cockDescript(x) + " with her hands, spitting on it for lube. Her fingertips shift down and start pressing tauntingly into your knot while her mouth comes down, bringing with it those gorgeous fat lips. The way they move is intoxicating, slipping about your shaft before sliding over the tip of your prick. Seeing the lewd O begin to form and grow larger only helps you get harder.\n\n");

				output("Her hands are rough with you, forcing you to spread your legs so that your " + pc.cockDescript(x) + " stands upright and exposed. You know she doesn't want your hands in the way, and you obey her desires. She's in control here, and with the way she makes your meat feel, you wouldn't want it any other way. If she wants you to be her blown bitch, so be it. Her lips twist from side to side as she pushes your tip into her mouth, making her cheeks bulge and dragging you against the roof of her mouth. Spit drips down your " + pc.cockDescript(x) + ", and deep satisfied gulping noises arise from between your legs. Every inch of her mouth is warm and soft, but her plump lips close around you like a seal, letting you know that you can leave her mouth only when she is ready. The friction elicits full-body trembling, and you drool pre-cum into her mouth. All of it is slurped down into her waiting throat, and soon your prick follows as she begins to deepthroat you.\n\n");

				output("Like your last visit, she facefucks herself on you, treating her mouth the way you've come to expect – acting as her only and favorite sex organ. Ravenous and depraved noises arise from your lap, the fellatrix finding intense pleasure in sucking on your " + pc.cockDescript(x) + ". You can barely focus on it however, as your world increasingly consists of the raw sensation. Thinking on those plump, gorgeous lips helps keep your mind from floating away into bliss too soon. Her throat squeezes you possessively, tighter than a cunt and hotter than a forge. That wonderful tongue contorts itself around you, more worshipper than body part. Those fat black cocksuckers cling to you as though you'd run away without them. Even without looking, you can imagine them forming a succulent, seductive O, a single trail of saliva between them in the waiting cunt...\n\n");

				output("Your knot presses past her lips, the ravenous maw feeding on your lap demanding all you can give her. You are all too happy to give it up. Even now you remember the ache from not pushing your swollen knot into her mouth the first time you met her. Her fingers dig into your thighs as she rapidly bounces on just this small portion of your " + pc.cockDescript(x) + ", her throat gulping deeply around everything inserted in it. Her hair bounces so wildly it threatens to burst out of her bun. The swelling of your knot tells you what you already know – it will not be long before you paint Dominika's throat in your sticky fucksludge. Eventually your bucking hips seize and tremble as the first [pc.cumVisc] load flings itself into her waiting maw. Her mouth buries itself into your lap as she drinks of your spunk, swallowing everything you give her and not letting a single drop through her plump, moist lips. Your knot feels like it might be as large as your head, so blissful and overwhelming the sensations below are. You cum until you can't cum anymore, and even then your orgasm persists until she delicately kisses your lips.\n\n");

				output("\"<i>As always, delicious,</i>\" she smiles, relaxing with you in the afterglow of her meal. She caresses you until you regain your strength, and then politely helps you re-dress and sends you on your way, giving you a kiss to remember her. Those black lips linger in your mind as you walk the streets of Tel'Adre.");
			}
			IncrementFlag("COC.DOMINIKA_SUCK_KNOTTED");
		}
		//Horsecock suck
		else if (pc.cocks[x].cType == GLOBAL.TYPE_EQUINE) {
			// - first time horsesuck
			if (flags["COC.DOMINIKA_SUCK_EQUINE"] == undefined) {
				output("The smile that spreads across her face might have looked sinister on someone else. She takes your hand and guides you to the other room, licking her lips. Within rests an extraordinarily comfortable-looking bed, featuring a level of finery you had nearly forgotten existed. The cabalist leads you to it, and helps you sit down. \"<i>Yeah,</i>\" she smirks, \"<i>I figured you might say yes.</i>\" She reaches down to remove the bottom of your [pc.gear], before chuckling lightly at the sight of your " + pc.cockDescript(x) + ". \"<i>Oh yeah?</i>\" she says, \"<i>Do they call you the Icathian Stallion?</i>\"\n\n");

				output("You blink in confusion at her. \"<i>...You know, like... it's a nickname from... you know what, never mind.</i>\" She waves her hand dismissively and smiles. \"<i>I'm sure no matter how uninformed you are, you still blow a load.</i>\" Her hands reach down to slowly rub against the stiffening " + pc.cockDescript(x) + ", eager to have its fun with the topless arcanist standing before it. There's a comfortable softness to her thumb as it plays over your flared tip. She settles down to kneel before you, continuing to stroke your " + pc.cockDescript(x) + " and entice it into a much fuller form. Even just this close you can begin to feel her breath emanating from between those luscious, deeply-coloured lips. The warmth of the sensation is seductive, carrying promises of what is yet to come. Your " + pc.cockDescript(x) + " practically leans towards her in anticipation.\n\n");

				output("A single finger traces along the rim of the excited " + pc.cockDescript(x) + ". Pulsing and hungry you grunt a little as a portion of pre-cum begins to form, slipping down from the cumslit. Your tattooed companion leans forward, catching it with her tongue before it slides down your shaft, and snapping it back into her mouth. A light smile tugs at the edge of her dark lips in turn. \"<i>Glad to see you're of some use,</i>\" she muses. Her fingers slip away from your head and stroke along the length of your prick instead, not wanting to get in the way of her intent. Once more her tongue touches the flat head of your " + pc.cockDescript(x) + ", dragging up from the bottom and across your cumhole before flicking calmly off the top.  Then her lips touch you.\n\n");

				output("You nearly melt. You've had blowjobs before. You've kissed lips, put your fingers on them, had them brush across your cheek. You know what lips feel like. The ones resting on the top of your " + pc.cockDescript(x) + " have a softness, a plumpness, and a fullness to them you can barely process. Immediately you take a breath and then let out a groan. You feel rather than hear her chuckle against your dick, each motion of those dark pillows rubbing across you as they pull in a slight smile. Stammering out some degree of praise (though with how distracted you have abruptly grown you're not sure that you even formed a coherent sentence) you grind your " + pc.cockDescript(x) + " forward in hopes of pushing past the simple kiss that graces your top. Those pursed lips remain steadfast in their act and press lightly to your cumslit, before widening slightly and flicking her tongue against it.\n\n");

				output("Moaning once again, your hands come forward to stroke through her hair and encourage her, but you are abruptly surprised by the slapping of your wrists. \"<i>Down,</i>\" Dominika says to you, her fingers returning to stroking your base once your hands return to the bed. \"<i>This is mine to play with, not yours.</i>\" You respond the most well-spoken way you can at the moment, namely by panting slightly. Still, the thought of letting those dark lips act upon you is appealing. You can't come up with any compelling reasons to disobey her desires. Apparently satisfied with your passive inaction, Dominika returns her attentions to your " + pc.cockDescript(x) + ", dragging those lush, gorgeous lips over your head and letting all of the sensitive flesh feel and grow enamored with them.\n\n");

				output("To your regret, they soon slip away. To your delight, they move to the side of your " + pc.cockDescript(x) + ", dragging her mouth up and down the side of your prick while her palm curls around your flattened crown. She opens up her warm maw enough that her tongue can press against your engorged shaft but not so much that it covers the fat bottom lip that slides deliciously along you. You think of all the times you've had to jerk yourself off at camp and wish that you had at least had just this much more to aid you. Even without entering her, the glossy slide of her inky, pillowy cocksuckers elicits uncontrollable and desperate throbbing from your " + pc.cockDescript(x) + ", alive with a need it only just developed. More pre-cum rises out of your prick, practically bubbling in its eagerness to be devoured.\n\n");

				output("Dominika fulfills its desire. Her flawless lips slide back up along the shaft, dragging themselves with a tauntingly slow speed up to the perverse summit of the " + pc.cockDescript(x) + " she climbs. Her lower lip stops at the bottom of your flared head but the top presses onwards. She takes the leaked pre-cum into her awaiting mouth and more, her lip rising until she engulfs the tip of your prick. You enter her mouth  with a wet, messy noise. Spit drips down your shaft. Those lush, flawless midnight lips that you had so adored grinding against your side close around you, and it is better than you hoped. The wet warmth, the pinching suction, and the overwhelming softness make you shudder, and all the while her tongue lashes dominantly across your " + pc.cockDescript(x) + ".\n\n");

				output("You find yourself obsessing over those lips, picturing them in your mind when you are forced to lean back and blur your vision in your pleasure. You stare at nothing in particular – at the walls, the ceilings, the shifting blonde bun – and as you do you imagine them, pulling at your dick and sucking it into her mouth, their ebony flawless fatness curved in an obscene O. You can imagine them engulfing and pulling on your " + pc.cockDescript(x) + " so vividly, and their image is so perfectly formed and dominant in your mind that it is hard to think about anything else. It is as though those gorgeous dark lips are sucking directly on your mind – but then, given how much the needs of your " + pc.cockDescript(x) + " dominate your every action, perhaps they are.\n\n");

				output("She bobs deeper, moving her head rougher. You enter her throat a few times before it becomes a far more frequent and rapid occurrence. It's difficult to remember that you're simply sitting down on the cabalist's bed, as the aggressive facefuck greatly resembles an uncontrolled rut. The act is all hers, assertively controlling your crotch with her mouth and using you for her own needs, recklessly slurping and coating your " + pc.cockDescript(x) + " in her spit. She less fellates your prick than mounts it, treating her mouth as a slut's hungry cunt and aggressively claiming your crotch as a dildo for her needs. In the back of your mind you remember, though. It's not the sex she wants from you. It's your cum.\n\n");

				output("This thought proves catalyst enough for the last vestiges of control over your " + pc.cockDescript(x) + " to vanish. Your mouth gapes in a deep and struggling moan, your body shaking as you lean back and let loose. The heat of your cum surges up the length of your " + pc.cockDescript(x) + " and into Dominika's sucking, swallowing maw. Your prick becomes a delivery device for your thick spooge squeezed into submission by her fat, gorgeous, black, full, plush... you can barely process them. They're formed in your mind with such impossible perfection and desire. You long for them, ache for them, your entire body bucking and twisting with a desire to please the lips that curl around your base, engulfing your " + pc.cockDescript(x) + " and using you, feasting on you. More, you have to cum more, you have to keep giving her everything you have. You're not even certain if you are cumming anymore, your mind locked in the brain-wiping haze of orgasm...\n\n");

				output("Softly her lips press against yours, and you start to relax. Glancing down, your " + pc.cockDescript(x) + " has long since finished, and Dominika sits beside you smirking. She gently massages your sensitive shaft as you recover from the fellatio, groaning slightly. It's hard to remember those last few moments, though you feel incredible. Just the sensation of the air on your sensitive prick makes you whimper a little. \"<i>That's a good stallion,</i>\" she teases, \"<i>It's always good to remind a dick that a good mouth can do oh so much to it.</i>\" You voice your appreciation, but can't help but ask why she wanted to blow you. \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need to eat. Still though, even if I wanted to...</i>\"\n\n");
			...
			//Reppppppeat
				...
				output("Nearly dragged into Dominika's bedroom, she pushes you to the bed so unceremoniously you fall onto your back. \"<i>Come on then,</i>\" she purrs aggressively as she moves towards you, licking those darkly-painted lips, \"<i>Show me you're more than an infertile mule.</i>\" She climbs up on the bed and puts a foot to your chest as you try to sit up, giggling and grinning at the controlling position before shifting down to her side. She tugs the bottom portion of your [pc.gear] away to reveal your " + pc.cockDescript(x) + ", jerking her hand along it as she glances back at you. \"<i>Keep producing the sticky glue I need and I won't have to turn you into it,</i>\" she sneers smugly. Her thumb grinds against your cumslit before pulling down and squeezing your base, replaced by her tongue and those fat, dark lips. They grind messily along the sides of your flared tip, accompanied by a casual spitting before wrapping around your meat, pulling it into her mouth.\n\n");

				output("One hand slides along your belly, gripping lightly onto your skin while casually applying some force down to your body. She clearly enjoys holding you down as she fellates you. Her dominant assertiveness is an omnipresent reminder of how she views the sexual exchange, and you obey her wishes by simply laying back and pushing your " + pc.cockDescript(x) + " out, offering it to her. She takes it. Her plump and luscious cockpillows grind into various portions of your prick in twisting and changing ways, shifting your head messily around inside of her mouth. Her tongue grinds against near every inch of it while pushing it into the roof of her mouth as well as her saliva-coated cheeks. The spit spilling from her mouth drips from your shaft to her bed, and in a moment of rare and silly clarity you wonder how often she has to change her sheets. The thought passes quickly, engulfed by the familiar desire of her fat, O-spread lips. They dominate your thoughts as easily as they dominate your lap, nearly sealing around your " + pc.cockDescript(x) + " and ensuring that you will not leave her mouth until she is ready for you to. The control she exhibits is wildly arousing and you happily drool pre-cum into her gulping mouth. She swallows it up at the same time as she pulls you into her throat, claiming your prick even more.\n\n");

				output("As is her way she face-fucks herself upon you, aggressively using her face as a simulacrum of the sex organ locked in chastity. Ravenous and depraved sounds rise up from your lap, the hallmarks of her lewd cock inhalations. You're not sure you have the focus to look down and watch her act, as the sensations grow more and more overwhelming. The thought of those full, gorgeous lips keeps you as grounded as you can be. Their image keeps you from breaking as her throat squeezes you tighter than a fleshlight and burns warmer than the most heated cunt. As though a supplicant before its god, her tongue bathes you in worship. All the while those lips close around you, locked tighter than her belt, keeping you with her until you give her her desires. The image of them opening up into a wide O, saliva strings dangling in that heated mouthcunt... it intoxicates you, leaving you melting for more.\n\n");

				output("Those fat full lips bounce into your base and you practically yell your moan, so delighted are you at being fully trapped within her suckling maw. Your hips buck greedily and her head meets them, sliding over you and vibrating you in her throat. The shuddering ache inside your cock – to an extent inside your being – warns you what you already knew: you will dump your load in Dominika's throat. Eventually your bucking hips seize and tremble as the first sticky load flings itself into her waiting maw. Her mouth buries itself into your lap as she drinks of your spunk, swallowing everything you give her and not letting a single drop through her plump, moist lips. Your cock feels like it has no end, a consumed part of her throat, a single entity of orgasm and feeding united in singular purpose. You cum until you can't cum anymore, and even then your orgasm persists until she delicately kisses your lips.\n\n");

				output("\"<i>As always, delicious,</i>\" she smiles, relaxing with you in the afterglow of her meal. She caresses you until you regain your strength, and then politely helps you re-dress and sends you on your way, giving you a kiss to remember her. Those black lips linger in your mind as you walk the streets of Tel'Adre.");
			}
			IncrementFlag("COC.DOMINIKA_SUCK_EQUINE");
		}
		//Human/fallback wang
		else {
			// - first time wangsuck
			if (flags["COC.DOMINIKA_SUCK_OTHER"] == undefined) {
				output("Dominika smiles, taking your hand and leading you to another room. Within is a surprisingly rich-looking bed, and she encourages you to sit down. \"<i>Thank you,</i>\" she says, and immediately follows it up with a truly wicked grin. \"<i>Now to make you realize you should be thanking me.</i>\"\n\n");
				output("She removes the bottom of your [pc.gear] and kneels in front of you. Taking your " + pc.cockDescript(x) + " into her hands, her fingers begin a slow and steady massage along the length. She leans down and brings her lips to a soft kiss right on the tip of your " + pc.cockDescript(x) + ". The glistening moisture you saw on them before feels almost unnatural, as though her lips are oiled up – but given what you've experienced in this land, such an idea does not startle you in the slightest. Her equally slick tongue slips out to press against the underside of your head and then flicks up, leaving saliva behind. The gentle touch of her palm presses against the spit and begins to spread it around. She swirls it slowly around your sensitive tip, enticing your erection further.  The ball of her thumb in particular works into the curve of your head, sliding against where it meets your shaft.\n\n");
				//(if player has balls)
				if (pc.balls > 0) output("Meanwhile her mouth slips down your dick, planting a few kisses along the way before reaching your " + pc.sackDescript() + ". Her dark lips press against each of your [pc.balls] in turn, granting each her moist smooch. She exhales warmly over them, teasing the cumfactories with a grin. Her mouth slips partially over one, her tongue slipping around the soft flesh. She is gentle and delicate in her administrations, and you feel comfortable about your " + pc.sackDescript() + " sitting in her warm mouth – though you would prefer she wrap those plump lips around something else. Your head continues to be stimulated by her soft palm, and now adds pre-cum to the saliva she slowly spreads. A grunt makes her smirk, lifting from your " + pc.sackDescript() + " and sliding her lips slowly up your dick.\n\n");
				output("\"<i>You like this, mm?</i>\" she asks, emphasizing her question with a gentle squeeze of her hand. \"<i>To think of the path I've walked,</i>\" she muses, \"<i>Once a capable cabalist, and now I'm a better fellatrix.  Still – as long as you enjoy your work.</i>\" She leans forward and quickly slurps up a drop of pre, gulping it down visibly. The trail of spit on your shaft hides any evidence that it was ever there, leaving only her smug grin as a tribute to its existence. Still holding your prick in her hand she ducks lower, using her tongue to take long deep slurps of your " + pc.cockDescript(x) + ". Teasing swirls flick across your base and her jaw rubs into the space between your thighs.  Dripping dragged paths of saliva are tracked along either side of your length, before she returns to your head.\n\n");
				output("The rush of pleasure could have staggered you if you were standing. One moment your " + pc.cockDescript(x) + " was pressing into those soft black lips and moments later they had slipped around your head. She squeezes firmly with them and her tongue twists and contorts around your bulb, prostrating itself like an adherent before a god. Entering her mouth had been almost effortless. Her lips slipped apart like they were made to, while clinging to your girth like life support. A wet gulping noise accompanied a tight squeeze, her head beginning to shift around your " + pc.cockDescript(x) + " in a careful and deliberate polishing.\n\n");
				output("Her hands travel along your length and roam along your thighs, squeezing them and slipping over your flesh. She seems to revel in the sensations of sucking on you, her eyes closed and her head bobbing rhythmically. The warm heat of her mouth slips along your " + pc.cockDescript(x) + ", her slick lips managing to generate more than enough friction, and more than you expected. Her flesh hugs to your " + pc.cockDescript(x) + " as tight as any cunt you've encountered so far, and as she begins to move her head more and more excitedly it becomes easy to forget. Only the wriggling tongue constantly rubbing and slipping along your meat and the palpable pucker of her perfect lips inform you of the fuckhole she's using to get you off.  It's difficult for your mind to not fixate on the black curves working you over. They seem as though they could truly be more comfortable, more soft and slick and smooth to slide into than anything else you've ever entered.\n\n");
				output("Her hands press to your thighs and push them apart slightly, and the reason why becomes quickly clear. She knocks your " + pc.cockDescript(x) + " against the back of her  throat a few times before jamming you in, beginning to throatfuck herself on you. You gasp eagerly and move your hands up to her hair, but almost brutally she comes up and grabs your wrists, forcing you to place them on either side as she brutalizes her face on you. Spit practically flies off her chin and your shaft, dripping onto the bed and the floor. She fucks her mouth on you recklessly, acting like she was jamming a dildo into her cunt in a desperate frenzy to get off, but instead you feel her nose slamming into your crotch.  Those ebony slick suckers taunt you with how frictionless they seem to move, but they simultaneously push tightly against your skin with every inch they pass. You adore them.\n\n");
				output("The friction, the mess, and the obscenity of it all prove too much for you. Giving a strangled noise your " + pc.cockDescript(x) + " throbs and starts to fire its load. She shoves herself into your lap, her lips wrapping tight around your base and her cheeks hollowing in as she sucks your load out. Her hunger for your spunk feels ravenous, and it's almost as though she's tugging it directly out of you. If she had sucked this hard to begin with, perhaps she would have! Still, you can't object to her need, and you moan helplessly as your " + pc.cockDescript(x) + " blasts its creamy load directly down her throat and into her belly, aching to just keep cumming. Your hips press forward, trying to insert more of your dick into those perfect black lips, almost flawlessly imagined in your mind. You want to cum, you want to keep splattering your thick spunk between those fat puckers, those immaculate dark cockpillows.  Their image dominates your mind, the thought of them curving into that wet O ripping more cum from you. Your orgasm is only enhanced by the knowledge that you can spread them into that obscene shape, helping to demonstrate every nuance of their gorgeous form.\n\n");
				output("A wet pop signals her lips slipping over your tip. \"<i>Mmm...</i>\" she purrs softly. Your hips thrust forward slightly still, your " + pc.cockDescript(x) + " tense and barely even relaxing, but your orgasm still rides out, pleasure overwhelming you. Gasping and weakly thrusting to the air, you shudder with tormented delight. Did the blowjob stop? It's hard to say. Your mind still fixates on those flawless lips, imagining their plush grip on your base. It was so good. It is so good, did it stop? You have to give them more cum, their plushness, their fullness needs to be helped.  She glides her hands up your body and rises. A soft kiss to your lips and you find your body willing to stop at last, falling back against her bed and gasping. \"<i>I appreciate it, love,</i>\" she smiles, climbing up and leaning against you, running a hand along your " + pc.hairDescript() + ". \"<i>You were delicious.</i>\"\n\n");
				output("She gently massages your head as you recover from the fellatio, groaning slightly. You look back down at your " + pc.cockDescript(x) + ", watching it drip with saliva. \"<i>I think I gave him a bit of a workout,</i>\" she teases, \"<i>It's always good to remind a dick that a good mouth can do oh so much to it.</i>\" You voice your appreciation, but can't help but ask why she wanted to blow you. \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need to eat. Still though, even if I wanted to...</i>\"\n\n");
				...
				output("After a bit of small talk, she glances out the window, and suggests you get back to your adventuring. She kisses you once more as you go, and you taste those dark curves on your lips as you return to camp.");
			}
			//[Follow-up Sex, player has penis]
			else {
				output("Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck your " + pc.cockDescript(x) + ". She removes the bottom of your [pc.gear] and kneels in front of you. Taking your " + pc.cockDescript(x) + " into her hands, she aggressively begins lapping at it with her tongue, coating it in spit. \"<i>Mmm, give me all your cum,</i>\" she purrs, giving the top of your " + pc.cockDescript(x) + " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your " + pc.cockDescript(x) + " before engulfing the sweaty meat.\n\n");
				...
				output("Like before she facefucks herself on you, treating her mouth the same way an alley whore would treat her cunt. Ravenous and depraved noises arise from your lap, the fellatrix finding intense pleasure in sucking on your " + pc.cockDescript(x) + ". You can barely focus on it however, as your world increasingly consists of the raw sensation. Her throat squeezes you possessively, tighter than a fleshlight and hotter than a forge. Her tongue contorts itself around you, more worshipper than body part. Those fat black cocksuckers cling to you as though you'd run away without them. Even without looking you can imagine them forming a succulent, seductive O, a single trail of saliva between them in the waiting cunt...\n\n");
				output("You don't speak as it continues, merely grunting and gasping in the rapture that at that moment it seems only her mouth can bring. You try to push your " + pc.cockDescript(x) + " deeper and deeper into her throat, trying to fuck as much of her face as humanly possible. Eventually your bucking hips seize and tremble as the first sticky load flings itself into her waiting maw. As before her mouth buries itself into your lap as she drinks of your spunk, swallowing everything you give her and not letting a single drop through her plump, moist lips. You cum until you can't cum anymore, and even then your orgasm persists until she delicately kisses your lips.\n\n");
				output("\"<i>As always, delicious,</i>\" she smiles, cuddling with you in the afterglow of her meal. She caresses you until you regain your strength, and then politely helps you re-dress and sends you on your way, giving you a kiss to remember her. Those black lips linger in your mind as you walk the streets of Tel'dre on your way back to camp.");
			}
			IncrementFlag("COC.DOMINIKA_SUCK_OTHER");
		}
	}
	//[If \"<i>Yes</i>\" and penis too big to suck]
	else {
		// - first time wangsuck
		if (flags["COC.DOMINIKA_SUCK_TOO_BIG"] == undefined) {
			output("A surprisingly big grin spreads across Dominika's face and she takes your hand, leading you to a side room. Within is a very comfortable looking bed, and she encourages you to sit down upon the covers. \"<i>Excellent,</i>\" she says, before grinning just a little wickedly, \"<i>Now to break you upon my knee and leave you gasping for more.</i>\" You don't have words for that one. At least she's confident.\n\n");
			output("She removes the bottom of your [pc.gear], then blinks in surprise. Curiously she leans forward, running her hand over your head, then lifting your " + pc.cockDescript(x) + " to look closer at it. Almost adorably she opens her mouth and leans forward, apparently comparing the two, before looking back up at you. \"<i>So in retrospect I probably should have noticed that you were barely keeping this contained, but uhm...</i>\" She lets out an awkward light cough, then glances back at your dick. There's an intake of breath as she figures out how precisely she wants to say whatever she's about to say. \"<i>I don't think I can fit this in my mouth...</i>\" Tilting her head in thought as she strokes slowly along you, she eventually smirks and shrugs. \"<i>Well I mean, not that I need to.</i>\"\n\n");
			output("Her dark lips press forward, wetly moving against your cumslit in a slow kiss. That first contact is electric – their ebony curves are exactly as soft and slick as you could have wished for. Her tongue teases the hole briefly as she flicks across it. \"<i>Mm, the taste is not... undesirable,</i>\" she muses, winking at you. The slippery appendage slips out beneath your head to run along your glans, slipping between your foreskin and your flesh. You can't help but give an appreciative groan as her mouth begins its work. Her devilishly black pillows glide down the underside of your head to curl around your foreskin, pulling on it slightly before gently tugging it back. They circle slowly around the loose flesh, her chin and cheeks sliding against your " + pc.cockDescript(x) + " in the process. Every last inch of foreskin finds itself gently lifted from your head, pulled away by a full, soft lip – clinging to the dark surface as it is almost adoringly. The fullness of your erection soon makes such play impossible, standing tall and proud before the tattooed acolyte.\n\n");
			output("Once more her mouth shifts, moving its attention to the curve just beneath your head. Her tongue slips and grinds along the flare of your rod. \"<i>You don't get to bathe much as an adventurer, do you?</i>\" she muses as she does so. You're not sure how to take the comment.  Her lips occasionally close against your skin, sucking and kissing briefly. \"<i>I can taste all the grime and musk on you.</i>\" She purrs briefly, letting you know that she was not insulting you – this too then, was not undesirable to her. She takes long drags of her tongue along your flesh, before moving in close and grinding her dark, perfect lips from side to side across your " + pc.cockDescript(x) + ". You can't help but watch them, entranced. The way those curving pillows of flesh tease you is incredible. More blood than ever seems to rush into your " + pc.cockDescript(0) + ", or perhaps your lust for them makes it more palpable.\n\n");
			//(if balls)
			if (pc.balls > 0) output("While her mouth performs its work, you can't help but become aware of sensation elsewhere. One hand presses to your [pc.balls], rolling in slow circles across them. The touch is slow, gentle – but at the same time firm. You get the sense she's inquiring about them, handling them like a customer examining fruit. Well, let her handle you how she wants, as long as it feels this good. Her slender fingers slip along the wrinkles as if massaging them out, while her thumb presses at the front of your sac just firmly enough to ensure you don't slip away. The touch is taunting, even more so when the delicate and barely felt slip of her fingernails crosses your sac, but she thankfully makes no attempts to harm you. You know you can trust those dark lips.\n\n");
			output("She shifts slightly, arcing her back a bit more to bring her breasts into greater visibility. Pressing forward she begins to rub the soft flesh over your shaft. Occasionally her nipple brushes across your veiny girth, sending a brief but agreeable little blush of pleasure. Your prick's sweat serves as suitable lubrication for the slow glide of her breasts, slipping against but not around your meat. Her back rocks repeatedly to grind her tits along you, in turn letting your " + pc.cockDescript(x) + " rub against her collarbone. The delicate fingers of her hand coil around your rod to rub her palm over your head, and after giving you another wet lick Dominika looks up at you.\n\n");
			output("\"<i>You'll give me a nice, big load with this big dick, right?</i>\" she purrs, licking those fat black cockpillows. They glisten teasingly in the light, and you can feel blood surging through your dick in excitement. She talks near your prick, ensuring that they brush against you as she slowly enunciates each word. The passage of her throat's warm air accompanies each syllable as well. \"<i>Give me all the cum I could ever want. Just dump all that sticky, thick load between these big, dark, perfect lips.</i>\" It's difficult not to stare at her lips as she speaks, hauntingly attractive as they are. The way they drag across your skin, the glistening pleasure they offer – you can't think of any reason not to give her what she wants.\n\n");
			output("Your hips start to rock forward involuntarily, eager to rut even if you can't. A low purr comes from the back of Dominika's throat and she places those immaculate ebony puckers at your cumslit. Once again her tongue presses up against it, this time in a lewd motion that feels almost as though she were prying it open. Grinding yourself into those abundant cocksuckers feels amazing, and there is a tinge of actual regret in your mind that your " + pc.cockDescript(x) + " is as big as it is. It takes little for the pleasure to override such emotions, however, and grunting you find yourself starting to pant like an animal as your release draws closer.\n\n");
			output("Her hands roaming over the girth of your " + pc.cockDescript(x) + " and her tits rubbing along the base only further excite you. Though her blonde hair hides them in your mind you can perfectly picture her dark lips in their lewd O, wrapped around you and waiting for the thick ropes of your dirty spunk. You find it impossible to keep it from her any longer. Pleasure racks through your body and you hump into her mouth as you fire your load, the sensation of heavy deep slurping tugging at your head and sucking the cum as it flings into her throat. You cum, and you cum, and you cum, your mind paralyzed with rapture as you deliver your cock's sole purpose. Hips heaving and body sweating you feel as though you could go forever. Your hips press forward, trying to insert more of your dick into those perfect black lips, almost flawlessly imagined in your mind. You want to cum, you want to keep splattering your thick spunk between those fat puckers, those immaculate dark cock-pillows. Their image dominates your mind, the thought of them curving into that wet O ripping more cum from you. Some frustration grips your orgasm by the knowledge that you cannot spread them further into that obscene shape and help to demonstrate every nuance of their gorgeous form, but the incredible sensation keeps your attention even with this subdued anger.\n\n");
			output("Softly her lips press against yours, and you start to relax. Glancing down your " + pc.cockDescript(x) + " has long since finished, and Dominika sits beside you smirking. She gently massages your head as you recover from the fellatio, groaning slightly. You shiver at the sensation on your over-sensitive prick. \"<i>I think I gave him a bit of a workout,</i>\" she teases, \"<i>It's always good to remind a dick that a good mouth can do oh so much to it.</i>\" You voice your appreciation, but can't help but ask why she wanted to blow you. \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need to eat. Still though, even if I wanted to...</i>\"\n\n");
			output("She takes your hand and presses it to her crotch where you feel the unyielding strength of metal. She lowers her skirt slightly and you see the beginnings of a carefully crafted chastity belt. \"<i>It's alright though,</i>\" she smiles, kissing your cheek, \"<i>I enjoyed myself plenty.</i>\" She then gives an almost wicked grin, a fake expression of innocence dancing across her eyes. \"<i>Just take an hour before you try putting that in anyone else, is my advice.</i>\"\n\n");
			output("After a bit of small talk, she glances out the window, and suggests you get back to your adventuring. She kisses you once more as you go, and you taste the ebony curves on your lips as you return to your camp.");
		}
		else {
			//[Follow-up Sex, player has Too Big penis]
			output("Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck on your " + pc.cockDescript(x) + ". She removes the bottom of your [pc.gear] and kneels in front of you. Taking your " + pc.cockDescript(x) + " into her hands, she aggressively begins lapping at it with her tongue, coating it in spit. \"<i>Mmm, give me all your cum,</i>\" she purrs, giving the top of your " + pc.cockDescript(x) + " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your " + pc.cockDescript(x) + " before messily pressing to the top in a wide O.\n\n");
			output("She pushes your legs open and forces your " + pc.cockDescript(x) + " to stand prominent, as though offering it up to her. Any attempt to hold on to her or guide her is quickly rebuffed, slapped away with her own hands. There is nothing submissive about her position. Her lips twist from side to side around your head, messily spilling warm drool down your prick. Your cumslit rubs against the roof of her mouth, against the inside of her cheek, tantalized and tormented by the wet flesh within. She gulps and sucks on your " + pc.cockDescript(x) + " even with your limited entry, pulling on the flesh in a ravenous, sensual hunger. She fucks her mouth the best she can on your tremendous girth, only causing an increasingly wet mess.\n\n");
			output("Soon her hands and her tits comes to bear against your flesh, grinding up and around your veiny and oversized " + pc.cockDescript(x) + ". They make use of the dripping spit along your shaft to slip and rub faster against your phallus, relying on soft aggressive friction to get you gasping. It succeeds, your mouth hanging open as you moan in pleasure, rocking your hips forward as though you could descend further into those darkly vibrant and beautifully plump cocksuckers, but even through your bliss you can feel them stretched to their limit. You can imagine them perfectly in your mind, in an ebony immaculate O, and the imagery is too much for you.\n\n");
			output("Your bucking hips seize and tremble as the first sticky load flings itself into her waiting maw. Her hands grip you with a possessive tightness, stroking along your " + pc.cockDescript(x) + " as though coaxing every last drop out – and indeed, you give her every last drop you can, cumming until you can't anymore. Even then the orgasmic pleasure lingers in your mind, and you can't stop rocking your hips forward in a desire to let it continue. She slips away from your prick, finally rising up to kiss you on the lips. The touch of those dark puckers relaxes you, and you come down from the pleasure with a low, happy groan.\n\n");
			output("\"<i>As always, delicious,</i>\" she smiles, cuddling with you in the afterglow of her meal. She caresses you until you regain your strength, and then politely helps you re-dress and sends you on your way, giving you a kiss to remember her. Those black lips linger in your mind as you walk the streets of Tel'Adre on your way back to camp.");
		}
		IncrementFlag("COC.DOMINIKA_SUCK_TOO_BIG");
	}
	...
	clearMenu();
	if (timesFellatrixSucked() >= 4 && flags["COC.DOMINIKA_DRAMA"] == undefined) {
		addButton(0, "Next", dominidrama);
	}
	else {
		addButton(0, "Next", function():*{ processTime(10 + rand(10)); mainGameMenu(); } );
	}
...
private function agreeWithDominika():void {
	...
	pc.cor(2);
	if (flags["COC.NUMBER_OF_TIMES_MET_SCYLLA"] > 0) {
		output("You pause for a moment, then nod. Dominika's lips curl in a grin that manages to be both sinister and playful at the same time, running a hand over your shoulder before suddenly and aggressively straddling your lap. She bends down to you, biting your lip just barely lightly enough to not draw blood. Her hand caresses down the side of your head and your neck almost possessively.  The action turns into a kiss of some small passion, the smell of your crotch still fresh on her breath as those slippery ebon pillows graze over your own inferior display. She breathes heavily over you, looking in your eyes and filling your vision with her own blue eyes.\n\n");

		output("\"<i>I knew you were strong when I saw you,</i>\" she purrs softly. Though the folds of her skirt cover the belt you can feel its steel firmness pressing into your lap. \"<i>And through you, I can recover the strength stolen from me.</i>\" Her hand runs along your " + pc.hairDescript() + " before she climbs off you, glancing out the window. \"<i>You should go though,</i>\" she says, \"<i>It's late.</i>\" There's a pause, before she says something she's never said before. \"<i>I look forward to seeing you again.</i>\"\n\n");

		output("You think about her lips on the streets of Tel'Adre.");
	}
	else {
		output("You look at her for a moment, then nod.  Dominika's lips curl in a grin that manages to be both sinister and playful at the same time, running a hand over your shoulder before suddenly and aggressively stepping forward.  She presses you against the wall and ");
		if (pc.tallness < 64) output("leans down");
		else output("pushes herself up");
		output(", biting your lip just barely lightly enough to not draw blood.  Her hand caresses down the side of your head and your neck almost possessively.  You can feel her knee pressing against your [pc.legs], grinding into your [pc.crotch].  The action turns into a kiss of some small passion, the smell of your crotch still fresh on her breath as those slippery ebon pillows graze over your own inferior display.  She breathes heavily against you, looking in your eyes and filling your vision with her own blue eyes.\n\n");

		output("\"<i>I knew you were strong when I saw you,</i>\" she purrs softly.  Though the folds of her skirt cover the belt she is close enough that you can feel the firmness of its steel pressing against you.  \"<i>And through you, I can recover the strength stolen from me.</i>\"  Her hand runs along your " + pc.hairDescript() + " before she relaxes off you, glancing out the window.  \"<i>You should go though,</i>\" she says, \"<i>It's late.</i>\"  There's a pause, before she says something she's never said before.  \"<i>I look forward to seeing you again.</i>\"\n\n");

		output("You think about her lips on the streets of Tel'adre.");
	}
	applyDamage(new TypeCollection( { tease : 25 } ), dominika, pc);
	flags["COC.DOMINIKA_AGREEMENT"] = 1;
...
private function disagreeDominika():void {
	...
	if (flags["COC.NUMBER_OF_TIMES_MET_SCYLLA"] > 0) {
		...
		output("Conflicted, you find yourself walking away from Dominika's apartment without ever thinking about her lips for the first time.");
	}
	else {
		output("That seems like a ridiculous thing to say, and you tell her so.  Her nose wrinkles slightly and she seems to hold herself a little higher.  \"<i>Hmm. I suppose I may have had the wrong idea about you,</i>\" she says after a short wait.  \"<i>You seemed... It's not important, I suppose.  These are just the idle thoughts of frustration one has in this realm.  I'm sure you've felt similar.</i>\"  She offers a half-smile, then turns back to her mirror, fixing her hair once more.  You get the sense that she's not interested in pursuing the conversation.\n\n");
		output("On the streets of Tel'adre, you wonder about what she said.  Should you tell someone about that?  You're not certain how much of it was bluster and how much was genuine malice.  There seems to be far more to the sorceress-fellatrix than you first thought, but you're not sure you want to learn the rest.  You don't want to push an issue without justification, though...\n\n");
		output("Conflicted, you find yourself walking away from Dominika's apartment without ever thinking about her lips for the first time.");
	}
...
private function dominidramaYes():void {
	...
	output("Weary, you continue on your way out of Tel'Adre.");
	flags["COC.DOMINIKA_DRAMA"] = 1;
...
private function dominidramaNo():void {
	clearOutput();
	output("You think about the woman you have laid with, about her soft form, her laughter, and most of all those deep, curving lips. There's only one action you feel you could take, and you calmly say that no, you have not heard of anything or anyone fitting the description given. \"<i>I see,</i>\" the plant woman says, though her glowing eyes seem to linger on you with an uncertain meaning. She shouldn't have any reason to disbelieve you, should she?\n\n");
	...
	output("She turns to leave down the street, then pauses and turns back to you. \"<i>Where are you from, anyway?</i>\" she asks, \"<i>I don't recognize your accent.</i>\" You mention your home. \"<i>Ingnam? Hmm. Never heard of it.</i>\" She shrugs lightly, then leaves.\n\n");
	
	output("You feel warm inside, filled with a confidence that seemed to come out of nowhere. You can imagine Dominika's dark lips in your mind smiling, opening and curving as if to say \"<i>Good work.</i>\" The thought empowers you. It feels good to protect her, you think to yourself. You stride confidently out of the city.");
	
	pc.cor(1);
	pc.lust(10);
	flags["COC.DOMINIKA_DRAMA"] = 2;
...
private function dominikaBlowjobs():void {
	...
	if (pc.hasCock()) {
		if (pc.cocks[x].cLength() <= 15) {
			...
			output("The incredible and oppressive ache that had dominated the thick stiffness of your " + pc.cockDescript(x) + " is relieved in the tight fleshy confines that restrain it.  You still burn with the need for the pleasure but it no longer seems like a darkness without end – or at least, an aid in the form of a different darkness is near.  The portal of her full lips squeezes tighter than anything you've felt in a long time, as though her mouth was locked as tightly around you as the belt around her waist.  Involuntarily, one of your thighs briefly spasms.  Being pinned in this position with a deep mouth pulling you in should be uncomfortable, but the sensation of flesh around your " + pc.cockDescript(x) + " soaks up your focus.  Dominika's lips reach your base, her mouth doing a light twist on your prick.  Your hips jerk up in shocked reflex.  Wet and thick breathing comes from between your legs before she rises.  Fingernails press painfully into your skin as she uses your helpless body for her desires.\n\n");

			output("Dominika's lips come all the way to the top of your head, tucking briefly under the bulb of your knob before she takes another deep descent.  Her ebony puckers clutch to your pole like an addict's grip on their bottle, but you sense no dependency in Dominika.  If anything, right now you need her.  You are drowning in the darkness of the barely-illuminated room and only the deep throat that swallows you can save you.  Only the thick tar of her lips can pull you under.  But if you're drowning, don't you want to...\n\n");

			output("A loud deep gulp of your " + pc.cockDescript(x) + " drowns out the thought.  She dives down the length of your shaft every time, her throat so warm and tight that the air touching your spit-covered skin is almost agonizing in the chill it gives you.  Your " + pc.cockDescript(x) + " spits pre-cum into her gut.  An incredible, strong suck of your prick soon accompanies it, as though she was hoping to pull the rest of your cum out right then and there.  She descends down into your lap, her plump fat lips squeezing around you, and then she sucks again.\n\n");

			output("You cum. You didn't realize  how strong, how good it could feel when she sucked – you couldn't, until now.  The eruption splatters into her throat, and you imagine the strands of your cum clinging and dripping down the delicious throat-cunt you're so hungry to fill.  You have to cum for her, you're so fucking horny, so eager to dump everything your balls have into her.  As she pulls off of your softening prick (the very sensation of her lips gliding off of your head fills you with a certain disappointment) and your entire body heaves with your panting, you hear her chuckle.  \"<i>Good " + pc.mf("boy", "girl") + ",</i>\" Dominika says. \"<i><b>Again.</b></i>\"\n\n");
	...
	//[Next]
	clearMenu();
	addButton(0, "Next", dominikaBlowjobs2);
}

private function dominikaBlowjobs2():void {
	showDominika(true);
	clearOutput();
	output("Groaning, you roll over, sitting up in your bedroll.  The rays of the sun hitting your face feel particularly unwelcome.  You're not sure what you drank last night, but given your hangover you must have done so.\n\n");
	output("After a lot of water, you feel a little better.  Something nags at the back of your mind, an itch you can't quite scratch but persistently remains.  You feel as though you've forgotten something important, and perhaps even essential, but cannot think of any clues as to what.  ");
	//[Agreed with Dominika]
	if (flags["COC.DOMINIKA_AGREEMENT"] == 1 || flags["COC.DOMINIKA_AGREEMENT"] == 4) output("At the same time, you get the sense that perhaps it's for the best you did so.");
	//[Disagreed/Neutral with Dominika]
	else output("It deeply bothers you, leaving a sense of anxiety behind that you don't know how to deal with. You'll have to just hope something comes along that reminds you.");
	output("\n\nEither way, it's another day.");
	processTime(timeUntil(7 * 60));
	pc.energy(20);
	flags["COC.DOMINIKA_LAST_HYPNO_SUCK_COUNT"] = timesFellatrixSucked();
	IncrementFlag("COC.DOMINIKA_TIMES_HYPNO_BJ");
	clearMenu();
	addButton(0, "Next", function():*{ processTime(10 + rand(10)); mainGameMenu(); } );
}
...
public function dominikaSpellblade():void {
	...
	if (pc.bovineScore() >= 3 && pc.faceType == GLOBAL.TYPE_BOVINE && pc.isMasculine() || !pc.isBiped()) {
		output("You greet Dominika and make small talk, but as usual she seems distracted and the conversation is strained at best.  Drumming her fingers on the table and glancing outside her attention is constantly drawn away from you, and eventually she outright cuts the conversation off.  \"<i>I need to go, I'm afraid,</i>\" she says quickly, and half-heartedly adds, \"<i>It was nice talking to you.</i>\"\n\n");

		output("She exits, leaving you at the table alone.  You shrug a little and finish your drink, before noticing that she left something behind.  It looks like a wrapped sword and, while you don't know why she'd have such a thing, you figure you might as well give it back to her.  Hell, maybe she'll actually be worth a goddamn conversation afterwards.\n\n");

		output("You take the blade and head back out into the streets.  Off in the distance you can see her walking, and it takes a while to catch up with her.  Tapping her on the shoulder, you're preparing an explanation for yourself when she interrupts you with a surprisingly harsh \"<i>What?</i>\"\n\n");

		output("Holding up the sword, you mention that she left it behind and offer it back to her.  She glances at it before telling you to keep it and turning away.  Surprised, you offer again to be sure.\n\n");

		output("\"<i>I said fucking KEEP IT!</i>\" she snaps suddenly, turning again.  \"<i>Isn't it fucking CLEAR that I don't want to talk to you right now?</i>\" She draws breath sharply from the sudden outburst, then closes her eyes, rubbing the bridge of her nose.  After a few seconds she more calmly states, \"<i>While I apologize for snapping at you I am under a great deal of stress right now and would firmly prefer not to be bothered.  Thank you and good day.</i>\"\n\n");

		output("She turns back around. You're not entirely certain, but you think you hear her speak again as she leaves.  \"<i>And I don't want any help from you.</i>\"\n\n");

		output("Well, whatever.  You unwrap the sword to look at it.  It's inscribed with strange symbols and patterns which you don't entirely recognize, but which seem to be familiar.  Something in the design suggests they are magical in nature.\n\n");

		output("You wrap it again.  A free sword is a free sword.  Or a free coin, as the case may be.");
		//(Player receives Spellblade)
	}
	else {
		output("\"<i>Ah, lovely.</i>\"  The way Dominika's eyes curve makes it clear she's smiling as you approach.  \"<i>I was hoping you'd be here today.</i>\"\n\n");
	
		output("She gestures to the bartender as you sit.  She's happy to see you and she's buying you alcohol? Today is a good day.  \"<i>Been well, I trust?</i>\" she opens casually.  \"<i>Protecting your camp and your bottom?</i>\"  You're fairly confident she's smirking at that line.  \"<i>I wanted to thank you for your company of late,</i>\" the occultist says, once your drink arrives and the small talk concludes.  \"<i>It's been refreshing to talk with someone who's been interested in some degree of intellectualism.  And of course, it helps that you're able to... supply me with my unfortunate needs.</i>\"  A light chuckle comes from behind her veil.\n\n");
