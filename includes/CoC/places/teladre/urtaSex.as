...
private function vixenAndCreamPart1(teased:Boolean = false):void {
	...
	output("\n\nIt is not long before you're both a little tipsy off the fresh beer you've been drinking and the pitcher you bought is almost completely empty. You can feel the pleasant warmth radiating from your [pc.face]. Meanwhile, your entire side is nice and toasty where Urta is pressed up against you. ");
	output("\n\nGiven the provocative pressing of her sweater puppies against your arm, you're fairly sure her sizzling temperature has nothing to do with the pitcher of beer she's been drinking. You can feel her hot, tickling breath brushing against the [pc.skinFurScales] of your neck as she snuggles suggestively close.");
