...
public function showHeckel():void {
	//spriteSelect(28);
...
public function greetHeckel():void {
	...
	if(flags["COC.MET_HECKEL"] != 1) {
		...
		output("When she draws up to you, she slows down long enough to have a conversation.  She smiles at you with a grin that manages to show every single fang, and you realize she caught you staring.  \"<i>Fresh meat, huh? I'm Heckel, the alpha dog around here.</i>\"  She extends a large paw toward you as she wipes her face.  You ignore the sweat as you shake hands and introduce yourself.\n\n");
	
		output("\"<i>So, " + pc.short + ", what can I do for you?  The person working the desk can give you a tour if that's what you need... or maybe you were looking for a training partner?  If you can keep up with me, of course.</i>\"\n\n");
		flags["COC.MET_HECKEL"] = 1;
	}
	//Brooke + Heckel 3some
...
private function heckelTraining():void {
	...
	if(pc.tone < 60) {
		output("You tell Heckel that you're looking for a training partner, and she makes no attempt to hide her gaze as she looks you up and down.  When she's finished, she shakes her head and picks up her pace on the track.  \"<i>I don't think so, " + pc.short + ".  Maybe if you spend some more time around here, you'll find your own way into the swing of things.  From what I'm seeing, there's no way you can handle what I've got.</i>\"\n\n");

		output("You open your mouth to reply, but the hyena has already started another lap.  Deciding it isn't worth it, you turn away indignantly.");
		processTime(2);
		clearMenu();
	...
	else if(!pc.hasGenitals() || pc.isTaur()) {
		output("You tell Heckel that you're looking for a training partner, but she suddenly looks off balance. She shifts from foot to foot as she looks you up and down, head cocked to the side.\n\n");

		output("\"<i>Err, look " + pc.short + ", people around here come in all shapes and sizes and use all sorts of... equipment. Maybe you should go find someone more your type to ask, because I honestly don't know what to do with yours.</i>\"\n\n");
	...
	//FOLLOWUP SECKZ
		...
		output("You know the drill as you follow Heckel into the locker room. You watch her undress before she walks into the shower room, admiring the way her toned ass moves in counterpoint to her tail. She shoots you a fang-filled grin as she disappears around the corner, and you use the opportunity to shed your own clothes.\n\n");

		output("By the time she comes back into the locker room, you're completely naked. She doesn't bother to cover herself as she towels her fur off, making the coarse hair stand on end in more than a few places. She tosses the towel aside as she passes you, her black cock already bobbing between her legs. She sits down on one of the simple wooden benches and pats the spot next to her, beckoning you over.\n\n");

		output("\"<i>I'm not gonna mince words,</i>\" she says with a snicker. \"<i>I need a good fuck and I need it right now. I promise, this is going to be as much of a workout as hitting the track.</i>\" As you sit down next to her, she runs a paw up your back and along your neck, eventually draping it over your shoulders. \"<i>Now then partner, how are you gonna take this?</i>\"\n\n");
		//ORAL or LEAVE
		processTime(10);
		clearMenu();
		addButton(0, "Oral", heckelOrallyFixated);
...
private function heckelOrallyFixated():void {
	clearOutput();
	if(flags["COC.TIMES_FUCKED_HECKEL_BLOWJOB"] == undefined) {
	...
	//Repeat
		...
		output("She grunts above you and you feel one of her paws around the back of your head, pushing you lightly with each of your bobs. Her hips begin thrusting lightly against your lips, and you're pretty sure you can feel the tip of her cock pushing against the entrance to your stomach. It isn't long before you can feel her balls against your chin, your throat distended and stiff with the length of her member.\n\n");
	
		//[<PC IS MALE OR HERM> 
		if(pc.hasCock()) output("You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you begin stroking your [pc.cock] in time with her weak thrusts. Within moments you've brought yourself to a stiffening arousal, the cold air making your exposed [pc.cock] twitch slightly.\n\n");
		//[<PC IS FEMALE>
		else if(pc.hasVagina()) output("You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you roll your [pc.clit] between your first two fingers. You let two fingers sink into your [pc.vagina], curling them upwards and moaning around the giant dog dick in your mouth.  Your fingers bring you to the edge of orgasm, but you lack the stimulation to send yourself over just yet.\n\n");
	
		output("As your bobbing head works over her dick, you feel her knot begin to form at its base. At first it's just a small bump that you make sure to rub your tongue over, but over the course of a minute it becomes the size of a plum. Before long it becomes too large for you to take into your mouth, but this also gives you some breathing space between Heckel's cock head and your stomach. The more the knot inflates however, the more your jaw and cheeks are stretched to just hold her member in your mouth. If you didn't know better, it would feel like her dick is slowly growing larger! Your fears are confirmed when, even with several inches outside of you, her cock fully extends down your gullet. It is definitely getting thicker.\n\n");
	
		output("You look up in growing alarm at Heckel, but her eyes are glazed over again. Despite her vacant stare, her hand is still forcing your head back and forth at the pace of a slow rut.  Deciding that the best way to avoid suffocation is to get her off quickly, you redouble your efforts and twist your head around her cock with each thrust, letting your tongue move in all the space it can to stimulate her as much as possible.\n\n");
		
		output("You can barely see around her knot - it has grown so large, but at least she isn't trying to make you swallow it. Even with all the things you've seen in this realm, you know that some feats of anatomy are simply not possible. The hyena certainly doesn't mind trying though, and you repeatedly find your nose and chin squashed up against the growing bulge.\n\n");
	
		//[<PC IS FEMALE>
		if(!pc.hasCock()) output("A growl rises in Heckel's throat, and you recognize the sign of her impending orgasm. It's all you can do to keep your balance as her thrusts into your throat come more frequently. Although you are barely able to breath between thrusts, your free hand feverishly works at your wet slit, plumbing your depths as your own orgasm builds. Heckel's paws grab your head and pull you deeply on to her dick as you feel it spasm, and you begin to moan as you feel her load travelling through her cock and finally spilling directly into your stomach. The warmth of her seed spreads throughout your body until it meets the warmth of your groin, and your cunt begins to spasm around your fingers as it sets you over the edge.\n\n");
		//<PC IS MALE OR HERM> 
		else output("A growl rises in Heckel's throat, and you recognize the sign of her impending orgasm. It's all you can do to keep your balance as her thrusts into your throat come more frequently. Although you are barely able to breath between thrusts, your free hand feverishly strokes your [pc.cock], your hand becoming slippery with pre as your own orgasm builds. Heckel's paws grab your head and pull you deeply on to her dick as you feel it spasm, and you begin to moan as you feel her load travelling through her cock and finally spilling directly into your stomach. The warmth of her seed spreads throughout your body until it meets the warmth of your groin, and your cock erupts in your hand as it sets your over the edge.\n\n");
...
private function heckelLovesDaAnal(loss:Boolean = false):void {
	...
	if(pc.analCapacity() <= 20 && !loss) {
		output("Heckel lets out a barking laugh when you suggest using your [pc.ass], ruffling your hair playfully. \"<i>Know your limits, " + pc.short + ", I'd tear you apart down there. I'm sure there are plenty of others in this realm who can help you out with that.</i>\"\n\n");
		processTime(5);
		clearMenu();
		addButton(0, "Next", telAdreMenu);
		return;
	...
	output("Heckel's eyes flash as her grin splits her face, and for just a moment you wonder if this might have been a bad idea. Before you can object, however, she's pushing you down onto your stomach, your arms and " + pc.legs() + " draped over either side of the wooden bench.\n\n");

	output("You half expect her to just shove herself in right there, but she thankfully holds off. Instead, you feel her rough paws grab and knead either side of your [pc.ass] as she lets out a low growl.");
	//[<IF TONE OVER 80>
	if(pc.tone >= 80) output("  \"<i>Damn " + pc.short + ", you've got one hell of an ass. I bet it's gonna feel even better than it looks.</i>\"");
	//[<IF TONE BETWEEN 60-79>
	else if(pc.tone >= 60) output("  \"<i>Mmm, not bad " + pc.short + ", not perfect, but not bad.</i>\"");
	output("\n\n");
	
	output("One hand releases your [pc.ass] and you can hear the sound of her stroking herself. You start to turn your head around to watch, but she firmly presses you back down against the bench. \"<i>Now now partner, I told you to stay there. When you're the alpha dog around here, then you can make the rules.</i>\" Deciding this treatment isn't so bad anyway, you relax and let her hand continue to knead your [pc.ass].\n\n");

	output("The sound of her stroking stops, and you bite your lower lip. You feel the bench shift beneath you as she changes position, and a moment later she pulls both of your asscheeks apart to expose your [pc.asshole]. You tense for the inevitable penetration, but instead of a hard cockhead poking at your backdoor you feel something warm and wet. Heckel is licking you!\n\n");

	output("Her large tongue feels like sandpaper as it licks up and down your anus, your spread cheeks exposing you to the world. You can feel her wet nose on your sensitive skin, and the contrast with her warm tongue makes you shiver. Her tongue pokes and prods at your [pc.asshole] before slipping painlessly in, swirling expertly around before pulling out and licking some more.\n\n");

	//[<IF PC HAS PENIS AND VAGOO> 
	if(pc.hasCock() && pc.hasVagina()) output("[pc.EachCock] is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. Your [pc.vagina] is also being ignored, and having so much pleasure with so little stimulation is driving you crazy. You hump weakly up and down, trying to draw some pleasure out of the bench beneath you while simultaneously pushing her rolling and massaging tongue closer to your aching slit, but she ignores you and only licks deeper. She buries her face in your ass entirely, her cold nose and teeth rubbing up against your sensitive skin as her tongue pushes as far inside of you as she can get it.\n\n");
	
	//[<IF PC HAS PENIS>
	else if(pc.hasCock()) output("[pc.EachCock] is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. You hump weakly at the bench in a desperate attempt to get some stimulation, and you can feel the vibrations of Heckel's laugh as she buries her snout in your ass. She doesn't stop you, but the polished wood barely gives any pleasure anyway.\n\n");

	//[<IF PC HAS VAGOO>
	else if(pc.hasVagina()) output("Your snatch starts to ache while moisture runs down your groin, and you groan at the lack of attention it's receiving. If Heckel notices, she doesn't react and keeps swirling her tongue around your hole. You push weakly backwards, hoping to make her drop her tongue down a few inches, but she instead takes this as an opportunity to bury her snout fully between your ass cheecks, her tongue slipping inside you deeper than before.\n\n");

	output("Even with only a few inches inside your ass, her tongue makes you moan almost immediately. She rolls in back and forth, then side to side, then pushes it in and out before starting the cycle over. The teasing becomes more and more unbearable until you're ready to abandon caution and begin masturbating, but just as you tense to change position she stops and pulls her tongue out suddenly.\n\n");
	//NEXT
	//Increment Anal count
	processTime(15);
	IncrementFlag("COC.TIMES_FUCKED_HECKEL_ANAL");
	clearMenu();
	addButton(0, "Next", heckelLovesAnal2);
}
...
private function heckelLovesAnal2():void {
	...
	//[<IF PC HAS PENIS AND VAGOO>
	if(pc.hasCock() && pc.hasVagina()) output("Although [pc.eachCock] is trapped beneath you, Heckel's balls slap into your cunt with every one of her quickening thrusts.  Although neither your [pc.cocksLight] or [pc.vagina] are getting much stimulation, your prostate is being milked better than it ever has. One thrust in particular makes you cry out, and Heckel laughs above you as she slams her furry thighs into yours again. \"<i>You moan like a whore, " + pc.short + ", a perfect bitch for me to ride.</i>\"\n\n");

	//[<IF PC HAS PENIS AND BALLS> 
	else if(pc.hasCock() && pc.balls > 0) output("[pc.EachCock] pulses beneath you with every thrust, her duo of fist-sized balls slapping into your [pc.balls]. You gasp in surprise as one of her thrusts rubs against your prostate, and she barks out a single laugh above you. \"<i>You moan like a whore, " + pc.short + ", a perfect bitch for me to ride.</i>\"\n\n");

	//[<IF PC HAS VAGOO>
	else if(pc.hasVagina()) output("Heckel's fist-sized balls slap against your ass and grind your snatch with every thrust, driving you crazy with the desperate need to be filled. You moan in anguish, pushing yourself towards her with every thrust, desperate to milk as much stimulation out of her as possible. She laughs above you, but rewards you with harder and faster thrusts. \"<i>You moan like a whore, " + pc.short + ", a perfect bitch for me to ride.</i>\"\n\n");
	...
	//[<IF PC IS FEMALE>
	if(!pc.hasCock()) output("  \"<i>I'm going to fuck your ass like you wish I'd fuck your cunt,</i>\"");
	//[<IF PC IS MALE OR HERM >
	else output("  \"<i>I'm going to ride your ass like you wish you could ride me,</i>\"");
	output(" she whispers into your ear. You can't help but shiver as she adjusts herself before resuming her pounding, drawing small gasps from you with every thrust.\n\n");

	output("Her thrusts become faster and shorter as she leaves more of her cock buried inside of you, jackhammering your hole with her last few inches. Something even bigger begins to press against your [pc.asshole] as you hear her breathing become faster, her tongue lolling out of her mouth. You forgot about her knot! She doesn't let up her speed as she pushes it a little further with every thrust, and you don't want to think of how big it must be by now if it grew along with her dick size. She doesn't seem deterred however, and all you can do is grunt in pain as it pushes itself further and further.\n\n");
	...
	//[<HERM PC>
	if(pc.isHerm()) output("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your vagina hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your [pc.vagina] spasms and gushes over your soaked " + pc.legs() + ", your asshole spasming around her cock just as much. Your [pc.cocksLight] soon follows, shooting your own seed up between your [pc.chest] and coating your stomach. Even as your orgasm begins to taper off, you can do little more than lie panting in a pool of your own spunk. Your legs quiver beneath hers as the warmth spreads further up your gut, leading you into a warm and hazy afterglow.\n\n");
	//[<MALE PC>
	else if(pc.hasCock()) output("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your [pc.balls] and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your [pc.balls] get tight as your trapped [pc.cockNoun] twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");
	//[<FEMALE PC>
	else if(pc.hasVagina()) output("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your [pc.vagina] hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your [pc.vagina] spasms and gushes over your soaked thighs, your asshole spasming around her cock just as much. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");

	output("As your orgasm fades, you turn your head to look at your workout partner. Heckel has completely collapsed across your back, her head leaning against your own. A distinct snore comes from her mouth, and you can't help but laugh. For all her bluster, it looks like you worked her harder than she worked you! With her knot stuck in you, it's probably going to be awhile before you can go anywhere anyway, so you lay your head down on the bench and enjoy the feeling of fullness her softly pulsing dick gives you.\n\n");
...
public function dominateHeckel():void {
	clearOutput();
	output("Smirking, you fold your arms and tell her to bend over - ");
	if(flags["COC.TIMES_DOMMED_HECKEL"] == undefined) output("there's a new top dog just waiting to claim the town bitch");
	else output("you're back for a taste of your favorite bitch");
	output(".  Heckel snorts, \"<i>Nice try, fuck-meat, but ");
	if(flags["COC.TIMES_DOMMED_HECKEL"] != undefined) output("last time was a fluke");
	else output("I'm always on top");
	output(".  If you want a squealing submissive to ride, the Wet Bitch is that way,</i>\" pointing towards the exit.  Her flaccid dog-dong twitches a little but remains defiantly soft.");
	output("\n\nYou step closer her body, admiring the shapely curve of her muscles beneath her sweat-matted fur.  Heckel's nipples perk up at your close proximity and gently come to rest against your [pc.chest] once you invade her personal space.  She doesn't take a single step back, and you suggest, \"<i>Some top dog.  Wanna bet your ass?</i>\"");
	...
	//{Lose}
	if(pc.physique() < 40) {
		output("Even with your mighty struggling, you cannot overcome the relentless hyena, and your shaking hand is forced down, eventually pressed flat into the wood.");
...
private function dominateHeckelConclusion():void {
	...
	if(pc.exhibitionism() >= 66) output("You grin and blush hotly, imagining the whole of the gym watching you fuck this hyena, their watchful eyes exciting you further.");
	else if(pc.slut() < 33) output("You blush a bit at that, uncomfortable at your sex being so public but unwilling to stop.");
	else if(pc.slut() < 66) output("You smirk a little at that while barely acknowledge the worry of being caught nagging at your consciousness.");
	else output("You grin widely at that and secretly hope that the whole gym will come in to see their 'alpha' laid low.");
	output("  Never stopping their probing motions, your fingertips dance through the hyena's sopping passageway, caressing the underswell of her virile nutsack, and occasionally brush the sensitive fur along her inner thighs.  Heckel is squirming and writhing atop the table, dominated by the mere twitches of your digits, a panting bitch in heat just begging for rough impalement on [pc.oneCock].");
	output("\n\nStepping to the side but never leaving the hyena's arousal-engorged box empty, you flop your [pc.cock " + pc.biggestCockIndex() + "] across her nose");
	if(pc.cockTotal() > 2) output(", fanning the others across her neck and forehead, burying her in penis.");
	else if(pc.cockTotal() == 2) output(", dropping your [pc.cock " + pc.smallestCockIndex() + "] alongside it over her eyes, burying her in penis.");
	else output(", draping her in hard penis.");
	output("  She whimpers as you rub your sensitive underside across her nose and pouting lips, looking up at you with what you imagine was supposed to be hatred.  It looks like lust instead.  Slowly stroking yourself while you diddle her, your manhood");
	if(pc.cockTotal() > 1) output("s throb and thicken");
	else output(" throbs and thickens");
	output(" further, too turned on to stop even if you wanted to.  You command her to open with a terse word.  She does, and you slide inside.");
	
	output("\n\nHeckel's mouth is a hot, wet cavern of fleshly delight for your [pc.cock " + pc.biggestCockIndex() + "], and an involuntary tremble of bliss travels through your swollen meat, depositing a ");
	if(pc.cumQ() < 250) output("single drop");
	else if(pc.cumQ() < 1000) output("steady drip");
	...
	output("\n\nHeckel whimpers pleadingly, jostling her hips in your direction, still leaking and dripping all over the strong table.  Gone is the woman obsessed with taking you; in her place is a whiny, sultry bitch begging to be fucked.  You let her go and flick her cock, commenting, \"<i>No need for this little puppy-prick to get anything.</i>\"  Then, without any further teasing, you mount the table and your new muscle-slut all in one motion.  The heat from her mons washes over [pc.eachCock] like the air from a salacious furnace");
	if(pc.balls > 0) output(", basting your [pc.balls] with her steaming warmth");
	else if(pc.hasVagina()) output(", basting your [pc.vagina] with her steaming warmth");
	else output(", basting your " + pc.skin() + " with her steaming warmth");
	output(".  You give her a knowing smile, " + pc.mf("man", "'woman'") + " to woman, and rock forward, sliding through her puffy labia and into her silky canal.  Those wet hyena-lips cling to every vein and rigid nook of your [pc.cock " + x + "], slurping your penis down the slick tunnel with hungry undulations.");
	output("\n\nAs soon as you finish your slow glide into that wondrous passage, you drop forward over your prize to look her in the eyes, admiring the smears of cock-cream you dripped and wiped over her muzzle.  Her pouty black lips are trembling, and inspired by the exquisite sensations migrating through your [pc.cock " + x + "], you kiss her, not as her lover but as her owner.  You ply her mouth with brutal, forceful kisses, raping her lips with your tongue, twining it around her own as you pillage her confused visage with a bruisingly rough french.  Her animal-like ears quickly begin to twitch, and her back arches, pressing her nipples into your [pc.chest] as she sensually writhes beneath you.");
	...
	output("\n\nYou pump one last time into the hole, mashing your groin into her mons with a tit-shaking thrust, and cum.  Your [pc.cock " + x + "] pulses powerfully, sending jet after jet of your orgasmic bliss deep into your conquest's crotch.  She mewls in ecstatic bliss as you fill her, shaking weakly, her orgasm enhanced by the cream filling.  Watching her eyes roll back slightly until they're half-hidden behind her lids only excites you further, and like a cat with a mouse, you gloat over your prize.");
	if(pc.cumQ() > 500) {
		output("  Your potent virility does a superb job of seeding Heckel's womb, stuffing it nice and full while streamers of white escape around your girth.");
		if(pc.cumQ() >= 1000) output("  Still, you keep blasting wad after wad of spunk inside her, and her belly rounds nicely, puffed up with virile sperm.");
		if(pc.cumQ() >= 2000) output("  Your spooge is seemingly without end, pouring out endlessly long after she's spunk-gravid and nearly immobile.  The rivers that run from her abused cunt-lips quickly turn the table into a puddle.");
		if(pc.cumQ() >= 3000) {
			output("  That puddle then drips to the floor to make an alabaster lake");
			if(pc.cumQ() >= 4000) {
				output(" at least ");
				if(pc.cumQ() < 10000) output("a foot deep");
				else if(pc.cumQ() < 15000) output("knee high by most measurements");
				else if(pc.cumQ() < 20000) output("waist high");
				else output("as high as the table");
			}
			output(".  Thank the gods for drains.");
		}
	}
	if(pc.cockTotal() > 1) {
		output("  Your other member");
		if(pc.cockTotal() > 2) output("s contribute");
		else output(" contributes");
		output(" as well, turning her hips and thighs into a wonderland of ivory-soaked fur.");
	}
	output("\n\nOnly once you have fully sated yourself upon the still-climaxing herm's vagina do you pull out.  Her gash gapes in the shape of your maleness as you exit, dribbling sperm and continuing to convulse anew, milking the phantom member she wishes were still inside her.  You plop your [pc.cock " + x + "] into her mouth, and she licks it without thought or question, cleaning the mixed love-juices from you until you shine with her glossy spit.");
	...
	//if(silly) {
		//output("  You grab a bacon shake from the shake-cart on your way out");
		//if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0) output(", then give Lottie a high five");
		//output(".  You really love bacon.");
	//}
	pc.orgasm();
	//dynStats("sen", -2);
	processTime(35);
