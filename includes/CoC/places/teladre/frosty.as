...
public function showFrosty():void {
...
public function approachFrosty():void {
	clearOutput();
	showFrosty();
	if(flags["COC.MET_FROSTY"] == undefined)
	{
		flags["COC.MET_FROSTY"] = 1;
		output("You approach the pink girl and as she sees you walking towards her, she immediately makes a beeline for you. Before you know it, the girl is right in front of you, jamming one of her fliers right in your face and speaking fast and hyperactivily to you. “<i>Hello " + pc.mf("sir", "madam") + ", would you like to come to ‘Frosty Cake’s Cupcake stand’? I’m Frosty- Nice to meet you- I recently opened a sweets-stand and can’t wait to have loyal customers such as you coming to my stand every day and buying all kinds of super delicious cupcakes!”</i> You have to take a step back to process everything she just blurted out; you also take the flyer from her just so she stops pushing it against your face. “<i>So do you wanna come to my stand, do ya, do ya, do ya!?</i>” You answer her with an uncertain “<i>yes</i>”, still wondering what she just said.");
		...
		output("\n\n“<i>Well, " + pc.mf("sir", "madam") + ", I was thinking of a new business plan last night. You could... be a... beta tester for it. All you have to do is sign these agreement papers.</i>”");
	...
	else
	{
		...
		output("You go out to Frosty’s stand; she’s there manning it with a huge smile on her face. “<i>Hello there customer, how may I help you?</i>” You greet her with your own smile and hello and take a look at her menu:\n");
		output("1. Cupcake x 1 = 15gems\n");
		output("2. Cupcake x 5 = 60gems\n");
		output("3. Cupcakes x 10 = 110gems\n");
		output("4. Cupcakes x 20 = 200gems\n");
...
{
	clearMenu();
	if (pc.credits >= 15) addButton(0, "x1", cupcakeBuy, 1);
	if (pc.credits >= 60) addButton(1, "x5", cupcakeBuy, 5);
	if (pc.credits >= 110) addButton(2, "x10", cupcakeBuy, 10);
	if (pc.credits >= 200) addButton(3, "x20", cupcakeBuy, 20);
	if (flags["COC.SIGNED_FROSTYS_CONTRACT"] == undefined) addButton(4, "Contract", getAFuckingFuckContractFromFucks);
	else if (!pc.hasGenitals()) addDisabledButton(4, "Specials", "Specials", "This scene requires you to have genitals.");
	else addButton(4, "Specials", frostysLimitedSpecialMenu);
...
public function frostySpecialsMenu(free:Boolean = false):void 
{
	...
	if (free || frostyPoints() >= 5) addButton(0, "Hand", frostysHandsAreColdHolyShitWhyDontYouWarmTHoseMitsUp);
	else addDisabledButton(0, "Hand", "Hand", "You don't have enough points for hand service.");
	
	if (free || frostyPoints() >= 15) addButton(1, "Mouth", useFrostysMouth);
	else addDisabledButton(0, "Mouth", "Mouth", "You don't have enough points for mouth service.");
	
	if (free || frostyPoints() >= 1) addButton(2, "EatHerOut", cunnilingateFrosty);
...
{
	clearOutput();
	output("You make your purchase and swiftly devour the results. They're surprisingly delicious!");
	//15
	if(arg == 1) pc.credits -= 150;
	//60
	if(arg == 5) pc.credits -= 600;
	//110
	if(arg == 10) pc.credits -= 1100;
	//200
	if(arg == 20) pc.credits -= 2000;
	frostyPoints(arg);
	processTime(2 * arg);
	clearMenu();
...
{
	clearOutput();
	output("You follow Frosty to her booth. She goes behind the counter and spins the menu with her fingertip and stops it with the palm of her hand. She goes back to her business while you look over the menu.  The lettering and style of it has changed into something more appealing and seductive.");
...
public function noIDontWantAFreebieDiseaseYouSlut():void {
	clearOutput();
	output("You’re too busy right now, so you deny the free service. “<i>Okeydokey, see you around, [pc.name]!</i>” Frosty does a twirl on one foot and runs back to her stand. Such a nice girl.");
	clearMenu();
...
public function noContractForMeSloot():void {
	clearOutput();
	output("Something about signing a contract doesn’t seem right to you, especially one for cupcakes. You shake your head no; she looks a bit sad about being rejected but quickly perks back up.");
...
{
	clearOutput();
	output("Frosty zooms around the counter, appearing next to you like a pink blur “<i>OH! You changed your mind!?</i>” she asks excitedly with her hands held up to her face like she’s praying.");
	//[Yes [No]
	//[Yes] 
...
{
	clearOutput();
	output("Frosty lets out a discouraged “<i>Oh</i>” and slowly walks back to her side of the counter.");
...
{
	clearOutput();
	output("Frosty spins the menu with a fingertip and stops it with the palm of her hand. She goes back to her business while you look over the menu.  The lettering and style of it has changed into something more appealing and seductive:\n\n1. Hand – 5 points\n2. Mouth - 15 points\nSPECIAL: Eat Me Out - 1 point\n\n<b>Current points: " + frostyPoints() + "</b>");
	frostySpecialsMenu();
}

private function frostyPoints(arg:int = 0):int {
	if(arg == 0) return Flag("COC.FROSTY_POINTS");
	//If any change, add it in.
	Flag("COC.FROSTY_POINTS", arg, true);
	//Make sure it aint negative
	if(Flag("COC.FROSTY_POINTS") < 0) Flag("COC.FROSTY_POINTS", 0);
	return Flag("COC.FROSTY_POINTS");
}
...
public function frostysHandsAreColdHolyShitWhyDontYouWarmTHoseMitsUp():void
{
	...
	if(pc.hasCock() && !pc.hasVagina())
	{
		...
		output("\n\n“<i>Are you about to give me your cream, Cocky?</i>” she’s talking directly to your [pc.cock " + pc.biggestCockIndex()+ "] now. “<i>I want to lick the cream off my face, come on. Give it to me, please?</i>” She rubs your cock against her face, pushing it against her cheek and sliding it against her lips, making you feel their soft heat on the tip of your cock, but only just for a moment. She continues rubbing and pressing your [pc.cock " + pc.biggestCockIndex()+ "] against her other cheek.");
	...
	{
		output("“<i>Okay, one dig-dug comin' right up.</i>” she giggles at her own name for a fingering. She ducks under the table and pulls up a big, fancy cushioned chair that looks like it belongs to a noble and also shouldn’t be able to fit in the tiny space under her booth. She throws the chair right next to her stand and it lands perfectly, hardly making a sound. In one moment Frosty just disappears and reappears on the chair, sitting on its arm and waving her hand over to the seat, gesturing for you to sit. You follow her gesture and take a seat in the comfy chair; just sitting there makes you feel like the ruler of a land. Placing your arms on the armrests, you feel like a boss.");
		output("\n\nFrosty has moved from the armrest and is now pulling at the bottom half of your [pc.gear]. With one quick hard tug, she exposes your [pc.butt] and [pc.vagina] to the busy city street; a few people stop to gawk at the both of you. She places her thumbs on both sides of your cunt and stretches the lips wide and hard.");
		output("\n\nFrosty takes a peek inside you, wondering how far she can see inside, then hovers her mouth over your fuck-hole and yells “<i>Hellllllllllllllo!!!</i>” like she was expecting the sound of her voice to echo back from your cunt. But the vibrations of her voice do ring through your [pc.clit], causing your [pc.vagina] to get a little moist.");
	...
	{
		output("“<i>Okay, one stroke-and-poke comin’ right up</i>” she snickers at her own name for using her hand to pleasure a herm. She ducks under the table and pulls up a big, fancy, cushioned chair that looks like it belongs to a noble and also shouldn’t be able to fit in the tiny space under her booth.");
