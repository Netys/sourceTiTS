...
public function showJasun():void {
	//spriteSelect(33);
	userInterface.showName("\nJASUN");
}

public function get jasun():PregnancyPlaceholder
{
	var pp:PregnancyPlaceholder = new PregnancyPlaceholder();
	if (!pp.hasCock()) pp.createCock();
	pp.cocks[0].cLengthRaw = 19;
	return pp;
}
...
private function meetJasun():void {
	...
	showJasun();
	if(flags["COC.JASUN_MET"] == undefined) {
		flags["COC.JASUN_MET"] = 1;
		output("As your eyes survey the room, you see a very thick figure step out from one of the changing stalls.  He is at least six feet tall from your guesstimate and has a massive barreled chest, the kind that could no doubt bench press anything the creature's own weight.  His shoulder span must be at least ");
		if(silly) output("six");
		else output("three");
		output(" feet given the thickness of his muscles and how they flex passively with every tiny movement of his toned and highly desirable body.  Now that you've used the word creature to describe him, though, you find yourself drawn to the oddities that you find on this man's figure.  He has gray skin that has a sheen over it much like you'd imagine an underwater creature would have to facilitate aquatic travel.  His short and coarse silver hair is pulled back into a tiny ponytail, presumably to keep it out of the way.  A finned tail with a hook on the top fin extends from the back of his pelvis and swishes around, knocking back and forth the towel that covers his butt.  From behind, you find the swish and teasing of his chiseled ass hypnotizing... intoxicating, even...\n\n");

		output("Before long, you blink a couple of times and break through your prior distraction.  You can see in the mirror before the man that he has been watching your revelry of his form.  A grin plays across the man's features and within it you find several rows of razor-sharp teeth, forcing you to gulp instinctively as you think of what sort of damage those could do to your tender flesh.  ");
	
		//IF MALE
		if(!pc.hasVagina()) {
			output("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning back to the mirror.\n\n");
			output("You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.");
			processTime(8);
			clearMenu();
		...
		//IF FEMALE
			...
			output("\"<i>Look at that, it's like you were ready for me the whole time!</i>\" He motions with one of his clawed fingers at your attire. You shamelessly pose in a proud manner and it causes him to laugh heartily. He seems unperturbed or even turned on by the fact that your swimsuit barely covers anything at all, almost like he's totally used to seeing people wear this kind of thing. You wonder what world he could possibly be from to end up the way he is. \"<i>Come, come with me. I have something to show you.</i>\" He walks up to you and pushes by you with his humongous frame. As he does, he grabs your left wrist with his right arm and all but drags you from the changing room to show you whatever he's talking about.\n\n");
			//[Continue]
			processTime(11);
			clearMenu();
			addButton(0, "Next", meetJasun2);
			return;
		}
	}
	//Met Jasun but not boned!
	else if(flags["COC.JASUN_MET"] == 1 && flags["COC.JASUN_SEXED"] == 0) {
		if(flags["COC.JASUN_NAME_KNOWN"] == undefined) {
			output("While you look around the changing room, one of the gym's other patron asks you if you're looking for Jasun.  Seeing your confusion, they describe the hunky shark guy you met before.  You nod and smile, happy to have learned his name.\n\n", false);
			flags["COC.JASUN_NAME_KNOWN"] = 1;
		}
		//If you're a dude.
		if(!pc.hasVagina() || pc.hasVagina() && pc.isMasculine()) {
			output("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it.  He glances your way and smirks.\n\n");
			output("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning to walk away.\n\n");
			output("You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.");
			processTime(8);
			clearMenu();
			addButton(0, "Next", TelAdreGymDesc);
		...
		if(pc.tone < 75 || !pc.inSwimwear(true)) {
			output("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it. As he turns to greet you, though, you notice that his smirk suddenly turns around to a sense of shock. He's noticed that you're not quite the same as you were before, and you know it. He pauses a moment before turning back toward the mirror and addressing you without eye contact.\n\n");
			
			output("\"<i>" + pc.short + ", you know, I still don't think you're quite ready to swim with me. That's fine, and it's entirely up to you, but I think today I should probably swim alone. You can come and visit me anytime, of course, maybe when you're ");
			if(pc.tone < 75) output("fit enough");
			else if(!pc.inSwimwear(true)) output("properly attired");
			else output("a little more compatible with me");
			output(", we can go swim.</i>\" He hesitates for a moment at the mirror, and then walks past you quickly without making eye contact. Feeling dejected and suddenly very alone, you ignore the sensation caused by his skin brushing against yours and walk back to the gym's entrance. Maybe you can work yourself back into Jasun's graces with time.\n\n");
			//(-15 Lust, back to gym entrance)
			pc.lust( -15);
			processTime(10);
			clearMenu();
		...
		output("Jasun comes out of his stall and smiles when he sees you, already beginning to strain against the skimpy fabric of his bottom.  He asks, \"<i>Would you like to come swimming with me?</i>\" though his tone indicates that swimming may involve more than a few laps.");
		clearMenu();
		addButton(0, "Yes", meetJasun2);
		addButton(1, "No", turnAwayFromAdj);
		return;
	}
	//Repeat
	else {
		...
		if(!pc.hasVagina() || pc.hasVagina() && pc.isMasculine()) {
			output("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it.  He glances your way and smirks.\n\n");
			output("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning to walk away.\n\n");
			output("You doubt he'd have the nerve to murder someone here, but it's clear that so long as you lack a vagina Jasun will have no interest in you.  What a waste.");
			processTime(8);
			clearMenu();
			addButton(0, "Next", TelAdreGymDesc);
			return;
