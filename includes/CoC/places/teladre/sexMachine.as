...
public function get sexMachine():PregnancyPlaceholder
{
...
private function useTheSexMachine():void {
	...
	if(pc.hasCock() && ! pc.hasVagina()) {
		if(IncrementFlag("COC.TIMES_USED_SEX_MACHINE_AS_MALE") == 1) {
			...
			output("It doesn't take long for the phallus to slip past your anal ring, filling your anus with firm strokes while you let out muffled moans.");
			pc.buttChange(sexMachine.cockVolume(), true, true, false);
			...
			output("The phallus in your anus begins to rub firmly against your prostate, as if it was locating it and locking onto it. Within moments you cry out in orgasmic pleasure, ");
			if(pc.balls > 0) output("your [pc.balls] pulling up tightly ");
			else output("prostate pulsing madly ");
			output("as you pump your thick seed into the machine's waiting tube.\n\n");

			output("You are surprised when the machine doesn't pump your own seed into your mouth and anus, instead slowly letting you back down. A platform lifts up in front of the machine, with a small metallic mini-keg. Once you're released and the keg is presented, the machine \"dings\", as if it had finished, leaving you exhausted and utterly violated.\n\n");

			output("Within moments, the goblin comes out of the back room - the small redheaded woman looks surprised to see you. Covered head to toe in thick grease and dirty clothes, she fits every last stereotype of an engineer.\n\n");

			output("\"<i>What are you doing to my baby?!</i>\" she cries out, until she notices the keg sitting in front of her.  \"<i>Wait, it works? It works!</i>\" she cheers with glee, quickly rushing over and snatching up the keg of your seed. Within moments she's gone back through her locked door, leaving you alone with the machine, whose screen goes blank after noting that it had \"saved your measurements\". Probably to rape you more efficiently next time...\n\n");
		}
		//[Male repeat scene]
		else {
			output("You get a sly smirk on your face. If you're going to get a full body workout, you need to work out -every- muscle in your body, and there's only one machine that can do that.\n\n");

			output("Walking down the back halls of the gym, it doesn't take you long to find the back room with the odd machine once more, looking much as it did prior. The room is silent and empty, the machine sitting with its screen turned off until once again, you sit on the padded bench, and the screen flickers to life. It displays your measurements as if it can somehow tell who you are, and asks you in a very polite manner to place your limbs into the safety straps.\n\n");

			output("You eagerly place your legs into the straps, and buckle your waist down. Placing your arms into the cuffs, the machine whirs to life, revealing its newest additions. It seems there's been improvements since your last visit! The machine raises a onahole to your slowly stiffening [pc.cock], already removing your shorts as it works your arms and legs to a tiring stiffness. The false vaginal opening seems to glisten in the light with some form of self lubrication, and you feel a familiar pressure against your [pc.asshole]. A second phallus lowers to your lips, and once more you're shocked and gagged with the dildos, the onahole quickly going to work on your stiff cock.\n\n");

			output("Within moments you're rock hard, being roughly fucked by the wet sex toy. You can feel the machine rippling the length of the slick tunnel, massaging your [pc.cock] and focusing on your sensitive [pc.cockHead], causing every nerve ending to light up in pleasure.  As you slowly leak pre-cum, the phallus is slipped once more into your anus, almost instantly pressing against your prostate to stroke and milk it as if it were a prehensile finger, not a metal toy in your ass.");
			pc.buttChange(sexMachine.cockVolume(), true, true, false);
			output("\n\n");

			output("You're brought to the edge of climax repeatedly, groaning as you grow tender and swollen, being denied your release multiple times by the machine. You willingly begin to buck against the wet vagina-like opening, attempting to force the machine to let you climax, but you're only met with resistance as it pulls on your arms and legs to restrain you.\n\n");

			output("After another half hour of tormented pleasure, the machine releases your swollen prostate, allowing your torrent of cum to flow violently into the tube inserted into your urethra. It sucks you dry, then slowly lowers you once again with a ding. You see the keg of what you assume to be your semen, once again raised up. The goblin quickly runs out, wearing a white lab coat and goggles.  She takes the keg without so much as a word to you.\n\n");

			output("As you prepare to leave, you swear you spotted a funnel in her back pocket...");
		}
	}
	//[If you decide to mess with the machine, female:]
	else if (pc.hasVagina() && !pc.hasCock()) {
		if(IncrementFlag("COC.TIMES_USED_SEX_MACHINE_AS_FEMALE") == 1) {
			output("You gently sit on the padded bench, curious as to what this machine might actually accomplish, noting the various odds and ends that seem more devious in nature than exercise inclined. The screen before you quickly flickers to life, welcoming you and asking you to kindly place your " + pc.feet() + " in the appropriate safety straps and place your arms in the secure cuffs. You wonder briefly if this is a good idea, but work your way into the tight fitting straps anyways.\n\n");
	
			output("Within moments, the machine lifts you up, pulling your arms out and apart, away from your sore aching body.  After such a workout you can do little to fight the strong pull of the mechanical assailant. It whirs to life, stating that it is beginning \"Phase 1: Preconditioning\".\n\n");
	
			output("You feel the machine begin to tug at your clothes with various mechanical clamps.  It pulls your clothing free in moments, revealing your [pc.fullChest], [pc.vagina], and your [pc.ass] to the cool room's air. You blush furiously, and it doesn't take the machine but a couple of moments to place a metallic, phallic-shaped device against your labia and anus, the cold metal eliciting a shocked gasp from you, allowing it to slip another cock into your mouth. The tip of the metal cock tastes salty, leaking a fluid slowly from the tip.  You blush with arousal: the machine is force feeding you cum!\n\n");
	
			output("Continuing its molestations, the machine attaches a small sucker hose to your [pc.clit], quickly suctioning it erect.  The device follows suit with your [pc.nipples].  You begin to moan, unable to hold back the pleasure shooting through your body from the suctioning tubes. You almost don't notice the cum leaking from both phallic devices between your legs, lubing you further until they're both starting to penetrate you at the same time, stuffing you full of cock from nearly every angle.");
			pc.cuntChange(0, sexMachine.cockVolume(), true, true, false);
			pc.buttChange(sexMachine.cockVolume(), true, true, false);
			output("\n\n");
	
			output("You gasp in pleasure, unable to move, fight, or even touch yourself as the machine begins to fuck you with its metallic cocks. The screen flashes, showing 'phase one is completed', and that it has begun phase two, 'implantation'. You don't have time to question the machine's intentions as it begins to fuck you harder and faster, your juices and arousal only helping the machine to continue.");
			if(pc.biggestTitSize() >= 2) output("  It slips a fourth cock between your [pc.chest], using two arms to press them together and fuck your tits as well, splashing a burst of mysterious cum on your face with every thrust.");
			output("\n\n");
	
			output("It doesn't take long until the cock in your mouth cums, spraying a thicker, heavier load of the heavenly seed down your throat and into your stomach. You gasp, swallowing without a choice, as your eyes roll back in your head, the machine ramming its cock into your g-spot, pushing you almost instantly to orgasm. You moan out loud, the cock popping out of your mouth now that its finished delivering its load. Your rippling vaginal walls milk the fake dick in your cunt, as it and the prick in your ass begin to cum heavily.  Every hole is quickly filled with mysterious jizz, stuffing you completely.\n\n");
	
			output("Finally the machine slows down, beginning to lower you back onto the padded bench with ");
			if(pc.biggestTitSize() >= 2) output("your breasts covered in cum and ");
			output("jizz leaking from every hole on your body. You groan, sore and stiff from the brutal workout but happy with afterglow. The screen before you appears to be saving data on your measurements, as well as physical stress levels. The final number flies past too fast for you to read, but the label sends a chill up your spine: \"Pregnancy percentage chance\".\n\n");
	
			output("It isn't long until the goblin comes into the room gasping. \"<i>You used my baby? You... wait, it worked? It worked! Tell me, how was it?  Wait no, don't tell me, it was wonderful of course!</i>\" the red-headed goblin beams.  She's covered from head to toe in grease, wearing dirty clothing that has various tools sticking out of every pocket; a stereotypical engineer. \"<i>The machine is made to milk studly men dry and use their cum to impregnate goblin females.  It automates the process!  But if you want to use it too, feel free, sexy.</i>\"  She winks at you lewdly. \"<i>But who knows what kind of cum will knock you up!</i>\"\n\n");
	
			output("She turns, walking back into the locked backroom, leaving you stunned and speechless.");
		}
		//[Female repeat scene]
		else {
			output("You grin as you walk down the halls, wiping sweat from your forehead from your recent workout. Tired, but not exhausted, you decide to have a wind down session with your favorite machine in the building. Walking down the back halls, it doesn't take you long to find the quiet back room with the mysterious goblin machine in it. You quickly slip inside, letting the steel door close behind you with a soft metallic click.\n\n");

			output("As you sit on the bench, the screen once more flares to life, quickly scrolling various body information about you past, not limited to vaginal depth, optimal ovulation periods, bust size... attempting to read it all is dizzying! You rub your forehead, sighing softly as you buckle yourself in.  Then you slip your arms and legs into the restraints of the machine, and once again it lifts you up in the air and strips your [pc.gear] off.\n\n");

			output("The cool air makes your nipples stand out, and you notice a pleasant surprise: the cocks slipping between your ass-cheeks and thighs are made of a soft, but firm, latex.  They warm as they leak cum on your [pc.asshole] and labia. You blush, willingly opening your mouth for the cock in front of you.  Sucking it in to taste the heady seed, you close your eyes, enjoying the ride as your labia softly part, wet and ready for the intruding member.\n\n");

			output("You moan lustfully as the members slip into your [pc.vagina] and [pc.asshole], filling you deeply.");
			pc.cuntChange(0, sexMachine.cockVolume(), true, true, false);
			pc.buttChange(sexMachine.cockVolume(), true, true, false);
			output("  They begin to stroke slowly");
			if(pc.biggestTitSize() >= 2) output(", and it doesn't take long for the machine to slip a cock between your breasts as well, starting to tit fuck you as it rotates you in your restraints to optimize your position");
			else output(" while the machine rotates you in place to optimized your positioning.");
			output(".\n\n");
			
			output("You moan with your legs lifted high above your head, leaving you surprised as to how flexible you truly are; the positioning of your legs forces your ass and vagina to clamp down on the members, making you feel every ridge and nub as they piston in and out of your wet fuck holes. Once more, the cock in your mouth cums first, pumping globs of hot semen down your throat, filling your stomach while you begin to climax, panting and gasping for air even as you swallow all you can. The latex pricks fucking your other holes bounce you as your girlcum runs down your thighs, and shortly after they cum deep inside you, pumping you full of their mysterious seed.\n\n");

			output("You pant as you are let down onto the padded bench, rubbing your swollen stomach while cum leaks out of both of your holes. You smile from the afterglow of your climax, truly exhausted, and <b>really</b> needing that shower now.\n\n");
		}
	}
	//[Sexless]
	else if (!pc.hasGenitals()) {
		if(IncrementFlag("COC.TIMES_USED_SEX_MACHINE_AS_EUNUCH") == 1) {
			output("You sit down on the padded bench and look around at the odd weight-lifting machine nearby. Various parts look less than pleasant, and less than exercise orientated on further inspection.  It makes you question the uses of this machine. The screen before you flashes to life, politely asking you to place your arms and legs in the cuffs and buckle yourself in.\n\n");

			output("You raise an eyebrow, wondering what you're getting yourself into as you buckle yourself to the machine, hoping this isn't a mistake. It doesn't take long for you to realize it is. The machine lifts you up, stripping your [pc.gear] off of you and spreading your arms and legs. First, a round device that appears to be made to hold a penis slips up, rubbing against your flat pelvis. It tries for a few moments, lifting up two other smaller devices made for smaller dicks before it gives up, the screen reading \"error\". Shortly afterward, a cock-like metallic device is lifted up to your groin, rubbing around as it leaks lubrication, searching for an entrance until once again the screen reads \"error\".\n\n");

			output("It whirs for a moment, confused. It seems to ponder matters for a second before simply lifting you up into a sitting position. It doesn't take but a moment for you to feel a firm steel tip press against your anus, the machine bouncing you slowly in your restraints on the mechanical cock, each bounce smearing more and more cum on your [pc.asshole], lubing you up for your eventual penetration.\n\n");

			output("You gasp with each bounce, your ass finally lubed enough that each gentle jostle forces you to sink another half-inch down on the thick phallic member. With a groan you finally bottom out, your anus stretched around the thick member.  ");
			pc.buttChange(sexMachine.cockVolume(), true, false, true);
			output("The machine forces you forwards, onto your hands and knees, the thick cock beginning to slip in and out of your ass, pounding away with fervor to the sound of your exhausted moans. Each thrust seems to get closer and closer to a pleasurable spot, as if homing in on it slowly.\n\n");

			output("It doesn't take long for every thrust of the thick metal cock to ram that pleasant spot, pushing you closer and closer to your climax. You close your eyes as they roll back in your head, moaning loudly as you orgasm, the cock erupting inside of you, filling your rectum with thick spurts of cum.\n\n");

			output("Slowly, the machine pulls out of your asshole, releasing the straps and leaving you unceremoniously on the padded bench, facedown with your gaped anus hanging the air, leaking cum.\n\n");

			output("After you collect yourself and your gear, you quietly slip out of the room, the machine quiet and inactive now. However, you can't help but feel like you were being watched...");
		}
		//[Sexless Repeat]
		else {
			output("You walk down the halls after your brisk workout, once more headed for that quiet back room with that wonderful piece of exercise equipment. You smile as you slip in the door, looking around a moment to make sure you're alone in the room.\n\n");

			output("You casually strip yourself naked, saving the machine the effort, and sit on the padded bench. It whirrs to life, blinking a few statistics on the screen, including what seems to be measurements of your rectum and anus. Why would it need those?\n\n");

			output("You shrug it off, slipping, as directed, into the various straps and buckles to secure yourself to the machine, and once more it lifts you into the air. You feel a firm pressure against your [pc.asshole] once again, teasing you with a surprise: you feel a flexible latex head probing your asscheeks, leaking cum all over them!\n\n");

			output("You turn your head, look back, and gasp. You expected to see a latex cock molesting your backdoor, but instead see a latex tentacle brushing cum against your anus. What is this machine planning to do?!\n\n");

			output("It doesn't take long for your [pc.asshole] to be slathered in cum, the machine pressing on your muscular ring with the tip of its tentacle cock, starting to fill your ass with its prehensile member. Inch after inch slips inside of you, each humming ring of the cock stroking your anus as it fills your ass, vibrating deep inside of you.");
			pc.buttChange(sexMachine.cockVolume(), true, false, true);
			output("  You moan, closing your eyes and enjoying the pleasure, only to have a second tentacled cock thrust into your mouth, and down your throat. It doesn't take long for them both to begin thrusting, vibrating in both your holes.\n\n");
