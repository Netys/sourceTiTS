...
private function urtaPutsHerDickInPCsWithDicks(truth:Boolean):void {
	...
	if (player2.analCapacity() > pc.cockVolume() * 1.2 && !player2.analVirgin) output("  Thankfully, [player2.heShe]'s nice and stretched from all the butt-fucking [player2.heShe]'s had to take, and you easily pop inside.  It feels so good that your flare grows wider, pulling you deeper into that welcoming, tight anal heat.");
