...
public function fenPutsHisShittyFetishInYoSphinx(submit:Boolean = true):void {
	...
	//Medium capacity! 40+!
		...
		output("\n\nElectrically charged balls the size of large melons plop against your [butt] as she bottoms out.  \"<i>Mmmm, I knew you'd be a good " + pc.mf("boy","girl") + ".</i>\" Sanura purrs, patting you on the head.");
	}
	//Lowish Capacity
	else {
	...
	if(pc.cockTotal() > 0) output("  When she crosses the lump that is your well used prostate, you lose control and shudder with a nice, long cum of your own, your arms giving out and dumping you face-down on the ground while you spurt milky whiteness onto your chest, chin, and then the ground.");
	...
	if(pc.cockTotal() > 0) output(" and dragging you through your fresh, milky puddle");
